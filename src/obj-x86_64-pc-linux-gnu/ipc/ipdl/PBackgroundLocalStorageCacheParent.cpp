...
MOZ_IMPLICIT PBackgroundLocalStorageCacheParent::PBackgroundLocalStorageCacheParent() :
    mozilla::ipc::IProtocol(PBackgroundLocalStorageCacheMsgStart, mozilla::ipc::ParentSide)
{
...
auto PBackgroundLocalStorageCacheParent::AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const -> void
{
    uint32_t total = 0;
        ...
        const nsString& newValue) -> bool
{
    ...
    WriteIPDLParam(msg__, this, cachePrincipalInfo);
    // Sentinel = 'cachePrincipalInfo'
    (msg__)->WriteSentinel(1130104611);
    ...
    case PBackgroundLocalStorageCache::Msg_Notify__ID:
        {
            ...
            if ((!((this)->RecvNotify(std::move(documentURI), std::move(key), std::move(oldValue), std::move(newValue))))) {
                mozilla::ipc::ProtocolErrorBreakpoint("Handler returned error code!");
                // Error handled in mozilla::ipc::IPCResult
                return MsgProcessingError;
            }
...
auto PBackgroundLocalStorageCacheParent::ClearSubtree() -> void
{
}
