...
MOZ_IMPLICIT PPluginSurfaceChild::PPluginSurfaceChild() :
    mozilla::ipc::IProtocol(PPluginSurfaceMsgStart, mozilla::ipc::ChildSide)
{
...
auto PPluginSurfaceChild::AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const -> void
{
    uint32_t total = 0;
...
auto PPluginSurfaceChild::DeallocManagee(
        int32_t aProtocolId,
        IProtocol* aListener) -> void
{
    FatalError("unreached");
...
auto PPluginSurfaceChild::ClearSubtree() -> void
{
}
