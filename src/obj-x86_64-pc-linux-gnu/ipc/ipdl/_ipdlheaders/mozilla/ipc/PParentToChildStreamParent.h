...
#ifndef PParentToChildStreamParent_h
#define PParentToChildStreamParent_h
...
public:
    MOZ_IMPLICIT PParentToChildStreamParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::ipc::PParentToChildStreamParent*>
{
    typedef mozilla::ipc::PParentToChildStreamParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PParentToChildStreamParent_h
