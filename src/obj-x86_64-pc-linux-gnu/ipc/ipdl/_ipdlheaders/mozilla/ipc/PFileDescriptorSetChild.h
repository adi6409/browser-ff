...
#ifndef PFileDescriptorSetChild_h
#define PFileDescriptorSetChild_h
...
public:
    MOZ_IMPLICIT PFileDescriptorSetChild();
...
public:
    ...
    static bool
    Send__delete__(PFileDescriptorSetChild* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::ipc::PFileDescriptorSetChild*>
{
    typedef mozilla::ipc::PFileDescriptorSetChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PFileDescriptorSetChild_h
