...
#ifndef PChildToParentStreamChild_h
#define PChildToParentStreamChild_h
...
protected:
    ...
    RecvStartReading() = 0;
    virtual mozilla::ipc::IPCResult
    RecvRequestClose(const nsresult& aRv) = 0;
    virtual mozilla::ipc::IPCResult
    Recv__delete__();
public:
...
public:
    MOZ_IMPLICIT PChildToParentStreamChild();
...
public:
    ...
    bool
    SendBuffer(const ByteBuffer& aBuffer);

    bool
    SendClose(const nsresult& aRv);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::ipc::PChildToParentStreamChild*>
{
    typedef mozilla::ipc::PChildToParentStreamChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PChildToParentStreamChild_h
