...
#ifndef PChildToParentStreamParent_h
#define PChildToParentStreamParent_h
...
public:
    MOZ_IMPLICIT PChildToParentStreamParent();
...
public:
    ...
    Send__delete__(PChildToParentStreamParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::ipc::PChildToParentStreamParent*>
{
    typedef mozilla::ipc::PChildToParentStreamParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PChildToParentStreamParent_h
