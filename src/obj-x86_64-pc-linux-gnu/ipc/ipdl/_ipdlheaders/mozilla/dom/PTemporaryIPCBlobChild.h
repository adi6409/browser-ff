...
#ifndef PTemporaryIPCBlobChild_h
#define PTemporaryIPCBlobChild_h
...
public:
    MOZ_IMPLICIT PTemporaryIPCBlobChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PTemporaryIPCBlobChild*>
{
    typedef mozilla::dom::PTemporaryIPCBlobChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PTemporaryIPCBlobChild_h
