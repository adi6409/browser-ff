...
#ifndef PMediaTransportChild_h
#define PMediaTransportChild_h
...
protected:
    ...
    typedef mozilla::dom::NotReallyMovableButLetsPretendItIsRTCStatsCollection NotReallyMovableButLetsPretendItIsRTCStatsCollection;
    typedef net::NrIceStunAddrArray NrIceStunAddrArray;
    ...
    typedef mozilla::dom::RTCIceServer RTCIceServer;
    typedef mozilla::dom::RTCIceTransportPolicy RTCIceTransportPolicy;
    ...
    typedef mozilla::net::WebrtcProxyConfig WebrtcProxyConfig;
...
public:
    typedef MozPromise<WebrtcGlobalLog, ResponseRejectReason, true> GetIceLogPromise;
    typedef MozPromise<NotReallyMovableButLetsPretendItIsRTCStatsCollection, ResponseRejectReason, true> GetIceStatsPromise;
...
public:
    MOZ_IMPLICIT PMediaTransportChild();
...
public:
    ...
    static bool
    Send__delete__(PMediaTransportChild* actor);
    ...
    RefPtr<GetIceLogPromise>
    SendGetIceLog(const nsCString& pattern);
    ...
    bool
    SendSetProxyConfig(const WebrtcProxyConfig& proxyConfig);
    ...
    SendStartIceGathering(
            ...
            const NrIceStunAddrArray& stunAddrs);
    ...
    bool
    SendRemoveTransportsExcept(const StringVector& transportIds);
    ...
    bool
    SendUpdateNetworkState(const bool& online);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PMediaTransportChild*>
{
    typedef mozilla::dom::PMediaTransportChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PMediaTransportChild_h
