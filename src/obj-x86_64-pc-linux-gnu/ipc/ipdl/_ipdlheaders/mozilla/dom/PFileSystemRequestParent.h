...
#ifndef PFileSystemRequestParent_h
#define PFileSystemRequestParent_h
...
public:
    MOZ_IMPLICIT PFileSystemRequestParent();
...
public:
    ...
    Send__delete__(
            ...
            const FileSystemResponseValue& response);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PFileSystemRequestParent*>
{
    typedef mozilla::dom::PFileSystemRequestParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PFileSystemRequestParent_h
