...
#ifndef PBackgroundSDBRequestChild_h
#define PBackgroundSDBRequestChild_h
...
protected:
    ...
    Recv__delete__(const SDBRequestResponse& response) = 0;
public:
...
public:
    MOZ_IMPLICIT PBackgroundSDBRequestChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PBackgroundSDBRequestChild*>
{
    typedef mozilla::dom::PBackgroundSDBRequestChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundSDBRequestChild_h
