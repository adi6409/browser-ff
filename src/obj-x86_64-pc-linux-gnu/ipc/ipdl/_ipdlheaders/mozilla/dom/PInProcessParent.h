...
#ifndef PInProcessParent_h
#define PInProcessParent_h
...
public:
    MOZ_IMPLICIT PInProcessParent();

    virtual ~PInProcessParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PInProcessParent*>
{
    typedef mozilla::dom::PInProcessParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PInProcessParent_h
