...
#ifndef PFetchEventOpChild_h
#define PFetchEventOpChild_h
...
public:
    MOZ_IMPLICIT PFetchEventOpChild();

    virtual ~PFetchEventOpChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PFetchEventOpChild*>
{
    typedef mozilla::dom::PFetchEventOpChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PFetchEventOpChild_h
