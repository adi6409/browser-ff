...
#ifndef PClientManagerOpParent_h
#define PClientManagerOpParent_h
...
public:
    MOZ_IMPLICIT PClientManagerOpParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PClientManagerOpParent*>
{
    typedef mozilla::dom::PClientManagerOpParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PClientManagerOpParent_h
