...
#ifndef PQuotaUsageRequestParent_h
#define PQuotaUsageRequestParent_h
...
public:
    MOZ_IMPLICIT PQuotaUsageRequestParent();
...
public:
    ...
    Send__delete__(
            ...
            const UsageRequestResponse& response);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::quota::PQuotaUsageRequestParent*>
{
    typedef mozilla::dom::quota::PQuotaUsageRequestParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PQuotaUsageRequestParent_h
