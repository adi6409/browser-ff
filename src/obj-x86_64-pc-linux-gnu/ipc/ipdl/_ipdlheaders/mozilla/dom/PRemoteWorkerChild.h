...
#ifndef PRemoteWorkerChild_h
#define PRemoteWorkerChild_h
...
public:
    typedef MozPromise<bool, ResponseRejectReason, true> SetServiceWorkerSkipWaitingFlagPromise;
    typedef std::function<void(const ServiceWorkerOpResult&)> ExecServiceWorkerOpResolver;
...
public:
    MOZ_IMPLICIT PRemoteWorkerChild();
...
public:
    ...
    void
    ManagedPFetchEventOpProxyChild(nsTArray<PFetchEventOpProxyChild*>& aArr) const;
    const ManagedContainer<PFetchEventOpProxyChild>&
    ManagedPFetchEventOpProxyChild() const;

    void
    AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const override;

    ManagedEndpoint<PFetchEventOpProxyParent>
    OpenPFetchEventOpProxyEndpoint(PFetchEventOpProxyChild* aActor);
    bool
    ...
    bool
    SendCreated(const bool& aStatus);

    bool
    SendError(const ErrorValue& aValue);
    ...
    RefPtr<SetServiceWorkerSkipWaitingFlagPromise>
    SendSetServiceWorkerSkipWaitingFlag();
...
private:
    ...
    ManagedContainer<PFetchEventOpProxyChild> mManagedPFetchEventOpProxyChild;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PRemoteWorkerChild*>
{
    typedef mozilla::dom::PRemoteWorkerChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PRemoteWorkerChild_h
