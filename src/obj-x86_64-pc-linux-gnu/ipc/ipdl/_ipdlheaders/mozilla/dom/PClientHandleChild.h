...
#ifndef PClientHandleChild_h
#define PClientHandleChild_h
...
private:
    ...
    friend class mozilla::dom::PClientHandleOpChild;
protected:
    ...
    typedef mozilla::dom::PClientHandleOpChild PClientHandleOpChild;
    typedef mozilla::dom::PClientHandleOpParent PClientHandleOpParent;
...
protected:
    ...
    RecvExecutionReady(const IPCClientInfo& aClientInfo) = 0;
    virtual mozilla::ipc::IPCResult
    Recv__delete__();
    virtual PClientHandleOpChild*
    AllocPClientHandleOpChild(const ClientOpConstructorArgs& aArgs) = 0;
    virtual bool
    DeallocPClientHandleOpChild(PClientHandleOpChild* aActor) = 0;
public:
...
public:
    MOZ_IMPLICIT PClientHandleChild();
...
public:
    ...
    void
    ManagedPClientHandleOpChild(nsTArray<PClientHandleOpChild*>& aArr) const;
    const ManagedContainer<PClientHandleOpChild>&
    ManagedPClientHandleOpChild() const;

    void
    AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const override;

    ManagedEndpoint<PClientHandleOpParent>
    OpenPClientHandleOpEndpoint(PClientHandleOpChild* aActor);
    bool
    BindPClientHandleOpEndpoint(
    ...
    SendPClientHandleOpConstructor(const ClientOpConstructorArgs& aArgs);
...
private:
    ...
    ManagedContainer<PClientHandleOpChild> mManagedPClientHandleOpChild;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PClientHandleChild*>
{
    typedef mozilla::dom::PClientHandleChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PClientHandleChild_h
