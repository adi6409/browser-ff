...
#ifndef PSharedWorkerChild_h
#define PSharedWorkerChild_h
...
public:
    MOZ_IMPLICIT PSharedWorkerChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PSharedWorkerChild*>
{
    typedef mozilla::dom::PSharedWorkerChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PSharedWorkerChild_h
