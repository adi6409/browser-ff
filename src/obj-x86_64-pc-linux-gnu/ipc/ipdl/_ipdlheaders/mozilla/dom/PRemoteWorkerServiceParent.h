...
#ifndef PRemoteWorkerServiceParent_h
#define PRemoteWorkerServiceParent_h
...
public:
    MOZ_IMPLICIT PRemoteWorkerServiceParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PRemoteWorkerServiceParent*>
{
    typedef mozilla::dom::PRemoteWorkerServiceParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PRemoteWorkerServiceParent_h
