...
#ifndef PFileCreatorParent_h
#define PFileCreatorParent_h
...
public:
    MOZ_IMPLICIT PFileCreatorParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PFileCreatorParent*>
{
    typedef mozilla::dom::PFileCreatorParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PFileCreatorParent_h
