...
#ifndef PBackgroundLSSnapshotParent_h
#define PBackgroundLSSnapshotParent_h
...
protected:
    ...
    RecvDeleteMe() = 0;
    virtual mozilla::ipc::IPCResult
    RecvCheckpoint(nsTArray<LSWriteInfo>&& writeInfos) = 0;
    virtual mozilla::ipc::IPCResult
    RecvCheckpointAndNotify(nsTArray<LSWriteAndNotifyInfo>&& writeAndNotifyInfos) = 0;
    virtual mozilla::ipc::IPCResult
    RecvFinish() = 0;
    virtual mozilla::ipc::IPCResult
    RecvLoaded() = 0;
    ...
    RecvLoadValueAndMoreItems(
            const nsString& key,
            LSValue* value,
            nsTArray<LSItemInfo>* itemInfos) = 0;
    virtual mozilla::ipc::IPCResult
    RecvLoadKeys(nsTArray<nsString>* keys) = 0;
    virtual mozilla::ipc::IPCResult
...
public:
    MOZ_IMPLICIT PBackgroundLSSnapshotParent();
...
public:
    ...
    Send__delete__(PBackgroundLSSnapshotParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PBackgroundLSSnapshotParent*>
{
    typedef mozilla::dom::PBackgroundLSSnapshotParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundLSSnapshotParent_h
