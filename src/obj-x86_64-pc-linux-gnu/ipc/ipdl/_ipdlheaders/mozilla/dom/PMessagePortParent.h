...
#ifndef PMessagePortParent_h
#define PMessagePortParent_h
...
public:
    MOZ_IMPLICIT PMessagePortParent();
...
public:
    ...
    [[nodiscard]] bool
    SendEntangled(const nsTArray<MessageData>& messages);

    [[nodiscard]] bool
    SendReceiveData(const nsTArray<MessageData>& messages);

    [[nodiscard]] bool
    SendStopSendingDataConfirmed();

    [[nodiscard]] static bool
    Send__delete__(PMessagePortParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PMessagePortParent*>
{
    typedef mozilla::dom::PMessagePortParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PMessagePortParent_h
