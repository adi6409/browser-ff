...
#ifndef PVsyncParent_h
#define PVsyncParent_h
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PVsyncParent*>
{
    typedef mozilla::dom::PVsyncParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
