...
#ifndef PClientHandleParent_h
#define PClientHandleParent_h
...
private:
    ...
    friend class mozilla::dom::PClientHandleOpParent;
protected:
...
protected:
    ...
    virtual PClientHandleOpParent*
    AllocPClientHandleOpParent(const ClientOpConstructorArgs& aArgs) = 0;
    virtual bool
    DeallocPClientHandleOpParent(PClientHandleOpParent* aActor) = 0;
public:
...
public:
    MOZ_IMPLICIT PClientHandleParent();
...
public:
    ...
    void
    ManagedPClientHandleOpParent(nsTArray<PClientHandleOpParent*>& aArr) const;
    const ManagedContainer<PClientHandleOpParent>&
    ManagedPClientHandleOpParent() const;

    void
    AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const override;

    ManagedEndpoint<PClientHandleOpChild>
    OpenPClientHandleOpEndpoint(PClientHandleOpParent* aActor);
    bool
    ...
    [[nodiscard]] bool
    SendExecutionReady(const IPCClientInfo& aClientInfo);

    [[nodiscard]] static bool
    Send__delete__(PClientHandleParent* actor);
...
private:
    ...
    ManagedContainer<PClientHandleOpParent> mManagedPClientHandleOpParent;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PClientHandleParent*>
{
    typedef mozilla::dom::PClientHandleParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PClientHandleParent_h
