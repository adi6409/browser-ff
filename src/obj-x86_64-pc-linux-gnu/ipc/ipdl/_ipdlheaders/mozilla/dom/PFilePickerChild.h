...
#ifndef PFilePickerChild_h
#define PFilePickerChild_h
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PFilePickerChild*>
{
    typedef mozilla::dom::PFilePickerChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PFilePickerChild_h
