...
#ifndef PBroadcastChannelChild_h
#define PBroadcastChannelChild_h
...
protected:
    ...
    RecvNotify(const MessageData& message) = 0;
    virtual mozilla::ipc::IPCResult
    RecvRefMessageDelivered(
            const nsID& messageID,
            const uint32_t& actorsOnSamePid) = 0;
    virtual mozilla::ipc::IPCResult
    Recv__delete__();
public:
...
public:
    MOZ_IMPLICIT PBroadcastChannelChild();
...
public:
    ...
    bool
    SendPostMessage(const MessageData& message);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PBroadcastChannelChild*>
{
    typedef mozilla::dom::PBroadcastChannelChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBroadcastChannelChild_h
