...
#ifndef PServiceWorkerParent_h
#define PServiceWorkerParent_h
...
protected:
    ...
    RecvPostMessage(
            ...
            const ClientInfoAndState& aSource) = 0;
public:
...
public:
    MOZ_IMPLICIT PServiceWorkerParent();
...
public:
    ...
    Send__delete__(PServiceWorkerParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PServiceWorkerParent*>
{
    typedef mozilla::dom::PServiceWorkerParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PServiceWorkerParent_h
