...
#ifndef PFetchEventOpProxyParent_h
#define PFetchEventOpProxyParent_h
...
public:
    MOZ_IMPLICIT PFetchEventOpProxyParent();

    virtual ~PFetchEventOpProxyParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PFetchEventOpProxyParent*>
{
    typedef mozilla::dom::PFetchEventOpProxyParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PFetchEventOpProxyParent_h
