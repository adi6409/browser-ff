...
#ifndef PClientSourceOpChild_h
#define PClientSourceOpChild_h
...
public:
    MOZ_IMPLICIT PClientSourceOpChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PClientSourceOpChild*>
{
    typedef mozilla::dom::PClientSourceOpChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PClientSourceOpChild_h
