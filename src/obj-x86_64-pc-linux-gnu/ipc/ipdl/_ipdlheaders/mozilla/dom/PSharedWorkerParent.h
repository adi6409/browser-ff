...
#ifndef PSharedWorkerParent_h
#define PSharedWorkerParent_h
...
public:
    MOZ_IMPLICIT PSharedWorkerParent();
...
public:
    ...
    [[nodiscard]] bool
    SendError(const ErrorValue& value);

    [[nodiscard]] bool
    SendTerminate();

    [[nodiscard]] static bool
    Send__delete__(PSharedWorkerParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PSharedWorkerParent*>
{
    typedef mozilla::dom::PSharedWorkerParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PSharedWorkerParent_h
