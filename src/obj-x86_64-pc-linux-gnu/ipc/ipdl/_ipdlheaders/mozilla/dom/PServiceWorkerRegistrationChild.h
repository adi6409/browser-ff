...
#ifndef PServiceWorkerRegistrationChild_h
#define PServiceWorkerRegistrationChild_h
...
public:
    typedef MozPromise<Tuple<bool, CopyableErrorResult>, ResponseRejectReason, true> UnregisterPromise;
    typedef MozPromise<IPCServiceWorkerRegistrationDescriptorOrCopyableErrorResult, ResponseRejectReason, true> UpdatePromise;

protected:
    virtual mozilla::ipc::IPCResult
    Recv__delete__();
    virtual mozilla::ipc::IPCResult
    RecvUpdateState(const IPCServiceWorkerRegistrationDescriptor& aDescriptor) = 0;
    virtual mozilla::ipc::IPCResult
    RecvFireUpdateFound() = 0;
public:
...
public:
    MOZ_IMPLICIT PServiceWorkerRegistrationChild();
...
public:
    ...
    RefPtr<UpdatePromise>
    SendUpdate(const nsCString& aNewestWorkerScriptUrl);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PServiceWorkerRegistrationChild*>
{
    typedef mozilla::dom::PServiceWorkerRegistrationChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PServiceWorkerRegistrationChild_h
