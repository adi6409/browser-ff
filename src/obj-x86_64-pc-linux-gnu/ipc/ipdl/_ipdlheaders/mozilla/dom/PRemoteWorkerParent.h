...
#ifndef PRemoteWorkerParent_h
#define PRemoteWorkerParent_h
...
protected:
    ...
    typedef mozilla::dom::IPCFetchEventRespondWithResult IPCFetchEventRespondWithResult;
    ...
    typedef mozilla::dom::RemoteWorkerOp RemoteWorkerOp;
    ...
    typedef mozilla::dom::ServiceWorkerOpArgs ServiceWorkerOpArgs;
    typedef mozilla::dom::ServiceWorkerOpResult ServiceWorkerOpResult;
    ...
    typedef mozilla::dom::PFetchEventOpProxyParent PFetchEventOpProxyParent;
    typedef mozilla::dom::PFetchEventOpProxyChild PFetchEventOpProxyChild;

public:
    typedef std::function<void(const bool&)> SetServiceWorkerSkipWaitingFlagResolver;
    typedef MozPromise<ServiceWorkerOpResult, ResponseRejectReason, true> ExecServiceWorkerOpPromise;
...
public:
    MOZ_IMPLICIT PRemoteWorkerParent();
...
public:
    ...
    void
    ManagedPFetchEventOpProxyParent(nsTArray<PFetchEventOpProxyParent*>& aArr) const;
    const ManagedContainer<PFetchEventOpProxyParent>&
    ManagedPFetchEventOpProxyParent() const;

    void
    AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const override;

    ManagedEndpoint<PFetchEventOpProxyChild>
    OpenPFetchEventOpProxyEndpoint(PFetchEventOpProxyParent* aActor);
    bool
    BindPFetchEventOpProxyEndpoint(
            ManagedEndpoint<PFetchEventOpProxyParent> aEndpoint,
            PFetchEventOpProxyParent* aActor);

    [[nodiscard]] PFetchEventOpProxyParent*
    SendPFetchEventOpProxyConstructor(const ServiceWorkerFetchEventOpArgs& aArgs);
    ...
    Send__delete__(PRemoteWorkerParent* actor);

    [[nodiscard]] bool
    SendExecOp(const RemoteWorkerOp& op);
    ...
    [[nodiscard]] RefPtr<ExecServiceWorkerOpPromise>
    SendExecServiceWorkerOp(const ServiceWorkerOpArgs& aArgs);
...
private:
    ...
    ManagedContainer<PFetchEventOpProxyParent> mManagedPFetchEventOpProxyParent;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PRemoteWorkerParent*>
{
    typedef mozilla::dom::PRemoteWorkerParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PRemoteWorkerParent_h
