...
#ifndef PMIDIManagerChild_h
#define PMIDIManagerChild_h
...
public:
    MOZ_IMPLICIT PMIDIManagerChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PMIDIManagerChild*>
{
    typedef mozilla::dom::PMIDIManagerChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PMIDIManagerChild_h
