...
#ifndef PTemporaryIPCBlobParent_h
#define PTemporaryIPCBlobParent_h
...
protected:
    ...
    typedef mozilla::dom::IPCBlobOrError IPCBlobOrError;
...
public:
    MOZ_IMPLICIT PTemporaryIPCBlobParent();
...
public:
    ...
    [[nodiscard]] bool
    SendFileDesc(const FileDescriptor& aFD);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PTemporaryIPCBlobParent*>
{
    typedef mozilla::dom::PTemporaryIPCBlobParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PTemporaryIPCBlobParent_h
