...
#ifndef PRemoteWorkerControllerChild_h
#define PRemoteWorkerControllerChild_h
...
protected:
    ...
    typedef mozilla::dom::PFetchEventOpChild PFetchEventOpChild;
    typedef mozilla::dom::PFetchEventOpParent PFetchEventOpParent;
...
public:
    MOZ_IMPLICIT PRemoteWorkerControllerChild();
...
public:
    ...
    void
    ManagedPFetchEventOpChild(nsTArray<PFetchEventOpChild*>& aArr) const;
    const ManagedContainer<PFetchEventOpChild>&
    ManagedPFetchEventOpChild() const;

    void
    AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const override;

    ManagedEndpoint<PFetchEventOpParent>
    OpenPFetchEventOpEndpoint(PFetchEventOpChild* aActor);
    bool
    BindPFetchEventOpEndpoint(
            ManagedEndpoint<PFetchEventOpChild> aEndpoint,
            PFetchEventOpChild* aActor);

    PFetchEventOpChild*
    SendPFetchEventOpConstructor(const ServiceWorkerFetchEventOpArgs& aArgs);
    ...
    static bool
    Send__delete__(PRemoteWorkerControllerChild* actor);
    ...
    RefPtr<ExecServiceWorkerOpPromise>
...
private:
    ...
    ManagedContainer<PFetchEventOpChild> mManagedPFetchEventOpChild;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PRemoteWorkerControllerChild*>
{
    typedef mozilla::dom::PRemoteWorkerControllerChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PRemoteWorkerControllerChild_h
