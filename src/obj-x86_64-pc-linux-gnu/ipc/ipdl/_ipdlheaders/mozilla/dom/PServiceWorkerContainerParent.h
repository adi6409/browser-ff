...
#ifndef PServiceWorkerContainerParent_h
#define PServiceWorkerContainerParent_h
...
public:
    typedef std::function<void(const IPCServiceWorkerRegistrationDescriptorOrCopyableErrorResult&)> RegisterResolver;
    typedef std::function<void(const IPCServiceWorkerRegistrationDescriptorOrCopyableErrorResult&)> GetRegistrationResolver;
    typedef std::function<void(const IPCServiceWorkerRegistrationDescriptorListOrCopyableErrorResult&)> GetRegistrationsResolver;
    typedef std::function<void(const IPCServiceWorkerRegistrationDescriptorOrCopyableErrorResult&)> GetReadyResolver;
...
protected:
    ...
    RecvRegister(
            ...
            RegisterResolver&& aResolve) = 0;
    virtual mozilla::ipc::IPCResult
    RecvGetRegistration(
            const IPCClientInfo& aClientInfo,
            const nsCString& aURL,
            GetRegistrationResolver&& aResolve) = 0;
    virtual mozilla::ipc::IPCResult
    RecvGetRegistrations(
            const IPCClientInfo& aClientInfo,
            GetRegistrationsResolver&& aResolve) = 0;
    virtual mozilla::ipc::IPCResult
    RecvGetReady(
            const IPCClientInfo& aClientInfo,
            GetReadyResolver&& aResolve) = 0;
public:
...
public:
    MOZ_IMPLICIT PServiceWorkerContainerParent();
...
public:
    ...
    Send__delete__(PServiceWorkerContainerParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PServiceWorkerContainerParent*>
{
    typedef mozilla::dom::PServiceWorkerContainerParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PServiceWorkerContainerParent_h
