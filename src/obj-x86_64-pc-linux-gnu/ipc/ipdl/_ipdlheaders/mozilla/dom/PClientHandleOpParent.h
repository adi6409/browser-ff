...
#ifndef PClientHandleOpParent_h
#define PClientHandleOpParent_h
...
public:
    MOZ_IMPLICIT PClientHandleOpParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PClientHandleOpParent*>
{
    typedef mozilla::dom::PClientHandleOpParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PClientHandleOpParent_h
