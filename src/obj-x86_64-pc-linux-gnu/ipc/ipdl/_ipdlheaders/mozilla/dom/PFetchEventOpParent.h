...
#ifndef PFetchEventOpParent_h
#define PFetchEventOpParent_h
...
public:
    MOZ_IMPLICIT PFetchEventOpParent();

    virtual ~PFetchEventOpParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PFetchEventOpParent*>
{
    typedef mozilla::dom::PFetchEventOpParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PFetchEventOpParent_h
