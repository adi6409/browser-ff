...
#ifndef PFetchEventOpProxyChild_h
#define PFetchEventOpProxyChild_h
...
public:
    MOZ_IMPLICIT PFetchEventOpProxyChild();

    virtual ~PFetchEventOpProxyChild();
...
public:
    ...
    bool
    SendRespondWith(const IPCFetchEventRespondWithResult& aResult);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PFetchEventOpProxyChild*>
{
    typedef mozilla::dom::PFetchEventOpProxyChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PFetchEventOpProxyChild_h
