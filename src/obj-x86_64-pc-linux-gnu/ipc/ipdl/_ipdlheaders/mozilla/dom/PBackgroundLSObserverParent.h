...
#ifndef PBackgroundLSObserverParent_h
#define PBackgroundLSObserverParent_h

#include "mozilla/dom/PBackgroundLSObserver.h"
#ifdef DEBUG
#include "prenv.h"
#endif  // DEBUG
...
public:
    MOZ_IMPLICIT PBackgroundLSObserverParent();
...
public:
    ...
    Send__delete__(PBackgroundLSObserverParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PBackgroundLSObserverParent*>
{
    typedef mozilla::dom::PBackgroundLSObserverParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundLSObserverParent_h
