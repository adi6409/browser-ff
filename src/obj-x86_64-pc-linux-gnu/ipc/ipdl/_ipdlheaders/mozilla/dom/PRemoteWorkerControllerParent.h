...
#ifndef PRemoteWorkerControllerParent_h
#define PRemoteWorkerControllerParent_h
...
public:
    MOZ_IMPLICIT PRemoteWorkerControllerParent();
...
public:
    ...
    void
    ManagedPFetchEventOpParent(nsTArray<PFetchEventOpParent*>& aArr) const;
    const ManagedContainer<PFetchEventOpParent>&
    ManagedPFetchEventOpParent() const;

    void
    AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const override;

    ManagedEndpoint<PFetchEventOpChild>
    OpenPFetchEventOpEndpoint(PFetchEventOpParent* aActor);
    bool
    ...
    [[nodiscard]] bool
    SendErrorReceived(const ErrorValue& aError);
    ...
    [[nodiscard]] RefPtr<SetServiceWorkerSkipWaitingFlagPromise>
    SendSetServiceWorkerSkipWaitingFlag();
...
private:
    ...
    ManagedContainer<PFetchEventOpParent> mManagedPFetchEventOpParent;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PRemoteWorkerControllerParent*>
{
    typedef mozilla::dom::PRemoteWorkerControllerParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PRemoteWorkerControllerParent_h
