...
#ifndef PClientNavigateOpChild_h
#define PClientNavigateOpChild_h
...
public:
    MOZ_IMPLICIT PClientNavigateOpChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PClientNavigateOpChild*>
{
    typedef mozilla::dom::PClientNavigateOpChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PClientNavigateOpChild_h
