...
#ifndef PClientHandleOpChild_h
#define PClientHandleOpChild_h

#include "mozilla/dom/PClientHandleOp.h"
#ifdef DEBUG
#include "prenv.h"
#endif  // DEBUG
...
public:
    MOZ_IMPLICIT PClientHandleOpChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PClientHandleOpChild*>
{
    typedef mozilla::dom::PClientHandleOpChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PClientHandleOpChild_h
