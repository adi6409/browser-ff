...
#ifndef PServiceWorkerChild_h
#define PServiceWorkerChild_h
...
public:
    MOZ_IMPLICIT PServiceWorkerChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PServiceWorkerChild*>
{
    typedef mozilla::dom::PServiceWorkerChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PServiceWorkerChild_h
