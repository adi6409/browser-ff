...
#ifndef PClientNavigateOpParent_h
#define PClientNavigateOpParent_h

#include "mozilla/dom/PClientNavigateOp.h"
#ifdef DEBUG
#include "prenv.h"
#endif  // DEBUG
...
public:
    MOZ_IMPLICIT PClientNavigateOpParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PClientNavigateOpParent*>
{
    typedef mozilla::dom::PClientNavigateOpParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PClientNavigateOpParent_h
