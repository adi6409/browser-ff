...
#ifndef PGamepadTestChannelParent_h
#define PGamepadTestChannelParent_h
...
public:
    MOZ_IMPLICIT PGamepadTestChannelParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PGamepadTestChannelParent*>
{
    typedef mozilla::dom::PGamepadTestChannelParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PGamepadTestChannelParent_h
