...
#ifndef PClientManagerChild_h
#define PClientManagerChild_h
...
private:
    ...
    friend class mozilla::dom::PClientManagerOpChild;
    friend class mozilla::ipc::PBackgroundChild;
    friend class mozilla::dom::PClientHandleChild;
    friend class mozilla::dom::PClientNavigateOpChild;
protected:
    ...
    typedef mozilla::dom::PClientHandleChild PClientHandleChild;
    typedef mozilla::dom::PClientHandleParent PClientHandleParent;
    typedef mozilla::dom::PClientManagerOpChild PClientManagerOpChild;
    typedef mozilla::dom::PClientManagerOpParent PClientManagerOpParent;
    typedef mozilla::dom::PClientNavigateOpChild PClientNavigateOpChild;
    typedef mozilla::dom::PClientNavigateOpParent PClientNavigateOpParent;
...
protected:
    ...
    virtual mozilla::ipc::IPCResult
    Recv__delete__();
    virtual PClientHandleChild*
    AllocPClientHandleChild(const IPCClientInfo& aClientInfo) = 0;
    virtual PClientManagerOpChild*
    AllocPClientManagerOpChild(const ClientOpConstructorArgs& aArgs) = 0;
    virtual PClientSourceChild*
    AllocPClientSourceChild(const ClientSourceConstructorArgs& aArgs) = 0;
    virtual PClientNavigateOpChild*
    AllocPClientNavigateOpChild(const ClientNavigateOpConstructorArgs& aArgs) = 0;
    virtual bool
    DeallocPClientHandleChild(PClientHandleChild* aActor) = 0;
    virtual bool
    DeallocPClientManagerOpChild(PClientManagerOpChild* aActor) = 0;
    virtual bool
    DeallocPClientNavigateOpChild(PClientNavigateOpChild* aActor) = 0;
    virtual bool
    DeallocPClientSourceChild(PClientSourceChild* aActor) = 0;
public:
...
public:
    MOZ_IMPLICIT PClientManagerChild();
...
public:
    ...
    void
    ManagedPClientHandleChild(nsTArray<PClientHandleChild*>& aArr) const;
    const ManagedContainer<PClientHandleChild>&
    ManagedPClientHandleChild() const;

    void
    ManagedPClientManagerOpChild(nsTArray<PClientManagerOpChild*>& aArr) const;
    const ManagedContainer<PClientManagerOpChild>&
    ManagedPClientManagerOpChild() const;

    void
    ManagedPClientNavigateOpChild(nsTArray<PClientNavigateOpChild*>& aArr) const;
    const ManagedContainer<PClientNavigateOpChild>&
    ManagedPClientNavigateOpChild() const;

    void
    ManagedPClientSourceChild(nsTArray<PClientSourceChild*>& aArr) const;
    const ManagedContainer<PClientSourceChild>&
    ManagedPClientSourceChild() const;

    void
    AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const override;

    ManagedEndpoint<PClientHandleParent>
    OpenPClientHandleEndpoint(PClientHandleChild* aActor);
    bool
    BindPClientHandleEndpoint(
            ManagedEndpoint<PClientHandleChild> aEndpoint,
            PClientHandleChild* aActor);

    ManagedEndpoint<PClientManagerOpParent>
    OpenPClientManagerOpEndpoint(PClientManagerOpChild* aActor);
    bool
    BindPClientManagerOpEndpoint(
            ManagedEndpoint<PClientManagerOpChild> aEndpoint,
            PClientManagerOpChild* aActor);

    ManagedEndpoint<PClientNavigateOpParent>
    OpenPClientNavigateOpEndpoint(PClientNavigateOpChild* aActor);
    bool
    BindPClientNavigateOpEndpoint(
            ManagedEndpoint<PClientNavigateOpChild> aEndpoint,
            PClientNavigateOpChild* aActor);

    ManagedEndpoint<PClientSourceParent>
    OpenPClientSourceEndpoint(PClientSourceChild* aActor);
    bool
    BindPClientSourceEndpoint(
            ManagedEndpoint<PClientSourceChild> aEndpoint,
            PClientSourceChild* aActor);

    bool
    SendTeardown();

    PClientHandleChild*
    SendPClientHandleConstructor(const IPCClientInfo& aClientInfo);
    ...
    SendPClientManagerOpConstructor(const ClientOpConstructorArgs& aArgs);
    ...
    PClientSourceChild*
    SendPClientSourceConstructor(const ClientSourceConstructorArgs& aArgs);
...
private:
    ...
    ManagedContainer<PClientHandleChild> mManagedPClientHandleChild;
    ManagedContainer<PClientManagerOpChild> mManagedPClientManagerOpChild;
    ManagedContainer<PClientNavigateOpChild> mManagedPClientNavigateOpChild;
    ManagedContainer<PClientSourceChild> mManagedPClientSourceChild;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PClientManagerChild*>
{
    typedef mozilla::dom::PClientManagerChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PClientManagerChild_h
