...
#ifndef PBroadcastChannelParent_h
#define PBroadcastChannelParent_h
...
protected:
    ...
    RecvPostMessage(const MessageData& message) = 0;
    virtual mozilla::ipc::IPCResult
    RecvClose() = 0;
public:
...
public:
    MOZ_IMPLICIT PBroadcastChannelParent();
...
public:
    ...
    [[nodiscard]] bool
    SendNotify(const MessageData& message);

    [[nodiscard]] bool
    SendRefMessageDelivered(
            const nsID& messageID,
            const uint32_t& actorsOnSamePid);

    [[nodiscard]] static bool
    Send__delete__(PBroadcastChannelParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PBroadcastChannelParent*>
{
    typedef mozilla::dom::PBroadcastChannelParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBroadcastChannelParent_h
