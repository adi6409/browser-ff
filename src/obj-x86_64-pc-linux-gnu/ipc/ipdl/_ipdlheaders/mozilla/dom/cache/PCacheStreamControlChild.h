...
#ifndef PCacheStreamControlChild_h
#define PCacheStreamControlChild_h
...
public:
    typedef MozPromise<mozilla::Maybe<IPCStream>, ResponseRejectReason, true> OpenStreamPromise;
...
public:
    MOZ_IMPLICIT PCacheStreamControlChild();
...
public:
    ...
    RefPtr<OpenStreamPromise>
    SendOpenStream(const nsID& aStreamId);

    bool
    SendNoteClosed(const nsID& aStreamId);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::cache::PCacheStreamControlChild*>
{
    typedef mozilla::dom::cache::PCacheStreamControlChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PCacheStreamControlChild_h
