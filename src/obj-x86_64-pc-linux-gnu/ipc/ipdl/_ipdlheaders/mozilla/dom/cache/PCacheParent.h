...
#ifndef PCacheParent_h
#define PCacheParent_h
...
public:
    ...
    ManagedEndpoint<PCacheOpChild>
    OpenPCacheOpEndpoint(PCacheOpParent* aActor);
    bool
    BindPCacheOpEndpoint(
            ManagedEndpoint<PCacheOpParent> aEndpoint,
            PCacheOpParent* aActor);

    [[nodiscard]] static bool
    Send__delete__(PCacheParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::cache::PCacheParent*>
{
    typedef mozilla::dom::cache::PCacheParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
