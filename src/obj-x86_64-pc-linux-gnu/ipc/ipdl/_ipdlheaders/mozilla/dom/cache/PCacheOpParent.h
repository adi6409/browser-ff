...
#ifndef PCacheOpParent_h
#define PCacheOpParent_h
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::cache::PCacheOpParent*>
{
    typedef mozilla::dom::cache::PCacheOpParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
