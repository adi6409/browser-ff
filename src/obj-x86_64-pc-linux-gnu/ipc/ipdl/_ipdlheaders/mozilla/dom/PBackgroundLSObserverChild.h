...
#ifndef PBackgroundLSObserverChild_h
#define PBackgroundLSObserverChild_h
...
public:
    MOZ_IMPLICIT PBackgroundLSObserverChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PBackgroundLSObserverChild*>
{
    typedef mozilla::dom::PBackgroundLSObserverChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundLSObserverChild_h
