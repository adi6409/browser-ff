...
#ifndef PPaymentRequestChild_h
#define PPaymentRequestChild_h
...
public:
    MOZ_IMPLICIT PPaymentRequestChild();
...
public:
    ...
    static bool
    Send__delete__(PPaymentRequestChild* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PPaymentRequestChild*>
{
    typedef mozilla::dom::PPaymentRequestChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PPaymentRequestChild_h
