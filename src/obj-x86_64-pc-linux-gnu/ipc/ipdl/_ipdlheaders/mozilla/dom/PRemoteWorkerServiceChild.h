...
#ifndef PRemoteWorkerServiceChild_h
#define PRemoteWorkerServiceChild_h
...
public:
    MOZ_IMPLICIT PRemoteWorkerServiceChild();
...
public:
    ...
    static bool
    Send__delete__(PRemoteWorkerServiceChild* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PRemoteWorkerServiceChild*>
{
    typedef mozilla::dom::PRemoteWorkerServiceChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PRemoteWorkerServiceChild_h
