...
#ifndef PClientManagerOpChild_h
#define PClientManagerOpChild_h
...
public:
    MOZ_IMPLICIT PClientManagerOpChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::PClientManagerOpChild*>
{
    typedef mozilla::dom::PClientManagerOpChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PClientManagerOpChild_h
