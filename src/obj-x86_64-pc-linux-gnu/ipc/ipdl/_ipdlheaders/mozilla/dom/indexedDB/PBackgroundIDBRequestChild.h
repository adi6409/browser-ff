...
#ifndef PBackgroundIDBRequestChild_h
#define PBackgroundIDBRequestChild_h
...
public:
    MOZ_IMPLICIT PBackgroundIDBRequestChild();
...
public:
    ...
    bool
    SendContinue(const PreprocessResponse& response);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::indexedDB::PBackgroundIDBRequestChild*>
{
    typedef mozilla::dom::indexedDB::PBackgroundIDBRequestChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundIDBRequestChild_h
