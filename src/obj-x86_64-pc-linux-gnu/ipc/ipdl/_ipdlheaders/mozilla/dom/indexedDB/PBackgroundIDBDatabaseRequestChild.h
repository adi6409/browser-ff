...
#ifndef PBackgroundIDBDatabaseRequestChild_h
#define PBackgroundIDBDatabaseRequestChild_h
...
public:
    MOZ_IMPLICIT PBackgroundIDBDatabaseRequestChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::indexedDB::PBackgroundIDBDatabaseRequestChild*>
{
    typedef mozilla::dom::indexedDB::PBackgroundIDBDatabaseRequestChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundIDBDatabaseRequestChild_h
