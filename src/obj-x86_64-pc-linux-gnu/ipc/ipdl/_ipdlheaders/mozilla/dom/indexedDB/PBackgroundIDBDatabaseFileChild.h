...
#ifndef PBackgroundIDBDatabaseFileChild_h
#define PBackgroundIDBDatabaseFileChild_h
...
public:
    MOZ_IMPLICIT PBackgroundIDBDatabaseFileChild();
...
public:
    ...
    static bool
    Send__delete__(PBackgroundIDBDatabaseFileChild* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::indexedDB::PBackgroundIDBDatabaseFileChild*>
{
    typedef mozilla::dom::indexedDB::PBackgroundIDBDatabaseFileChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundIDBDatabaseFileChild_h
