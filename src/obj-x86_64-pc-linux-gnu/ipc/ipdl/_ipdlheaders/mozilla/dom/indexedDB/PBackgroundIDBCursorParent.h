...
#ifndef PBackgroundIDBCursorParent_h
#define PBackgroundIDBCursorParent_h
...
protected:
    ...
    typedef mozilla::dom::indexedDB::CursorRequestParams CursorRequestParams;
    typedef mozilla::dom::indexedDB::CursorResponse CursorResponse;
...
protected:
    ...
    RecvContinue(
            ...
            const Key& currentObjectStoreKey) = 0;
public:
...
public:
    MOZ_IMPLICIT PBackgroundIDBCursorParent();
...
public:
    ...
    Send__delete__(PBackgroundIDBCursorParent* actor);

    [[nodiscard]] bool
    SendResponse(const CursorResponse& response);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::indexedDB::PBackgroundIDBCursorParent*>
{
    typedef mozilla::dom::indexedDB::PBackgroundIDBCursorParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundIDBCursorParent_h
