...
#ifndef PBackgroundIDBFactoryChild_h
#define PBackgroundIDBFactoryChild_h
...
public:
    MOZ_IMPLICIT PBackgroundIDBFactoryChild();
...
public:
    ...
    void
    ManagedPBackgroundIDBDatabaseChild(nsTArray<PBackgroundIDBDatabaseChild*>& aArr) const;
    const ManagedContainer<PBackgroundIDBDatabaseChild>&
    ManagedPBackgroundIDBDatabaseChild() const;

    void
    ManagedPBackgroundIDBFactoryRequestChild(nsTArray<PBackgroundIDBFactoryRequestChild*>& aArr) const;
    const ManagedContainer<PBackgroundIDBFactoryRequestChild>&
    ManagedPBackgroundIDBFactoryRequestChild() const;

    void
    AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const override;

    ManagedEndpoint<PBackgroundIDBDatabaseParent>
    OpenPBackgroundIDBDatabaseEndpoint(PBackgroundIDBDatabaseChild* aActor);
    bool
    ...
    ManagedEndpoint<PBackgroundIDBFactoryRequestParent>
    OpenPBackgroundIDBFactoryRequestEndpoint(PBackgroundIDBFactoryRequestChild* aActor);
    bool
    ...
    SendPBackgroundIDBFactoryRequestConstructor(const FactoryRequestParams& params);
...
private:
    ...
    ManagedContainer<PBackgroundIDBDatabaseChild> mManagedPBackgroundIDBDatabaseChild;
    ManagedContainer<PBackgroundIDBFactoryRequestChild> mManagedPBackgroundIDBFactoryRequestChild;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::indexedDB::PBackgroundIDBFactoryChild*>
{
    typedef mozilla::dom::indexedDB::PBackgroundIDBFactoryChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundIDBFactoryChild_h
