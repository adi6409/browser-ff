...
#ifndef PBackgroundIDBTransactionParent_h
#define PBackgroundIDBTransactionParent_h
...
public:
    MOZ_IMPLICIT PBackgroundIDBTransactionParent();
...
public:
    ...
    Send__delete__(PBackgroundIDBTransactionParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::indexedDB::PBackgroundIDBTransactionParent*>
{
    typedef mozilla::dom::indexedDB::PBackgroundIDBTransactionParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundIDBTransactionParent_h
