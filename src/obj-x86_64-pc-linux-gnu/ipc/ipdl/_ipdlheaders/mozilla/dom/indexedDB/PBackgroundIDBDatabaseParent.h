...
protected:
    ...
    AllocPBackgroundIDBDatabaseRequestParent(const DatabaseRequestParams& params) = 0;
    ...
    AllocPBackgroundMutableFileParent(
            const nsString& name,
            const nsString& type) = 0;
    virtual bool
    DeallocPBackgroundIDBDatabaseFileParent(PBackgroundIDBDatabaseFileParent* aActor) = 0;
    virtual bool
    DeallocPBackgroundIDBDatabaseRequestParent(PBackgroundIDBDatabaseRequestParent* aActor) = 0;
    virtual bool
    DeallocPBackgroundMutableFileParent(PBackgroundMutableFileParent* aActor) = 0;
public:
...
public:
    ...
    void
    ManagedPBackgroundIDBDatabaseRequestParent(nsTArray<PBackgroundIDBDatabaseRequestParent*>& aArr) const;
    const ManagedContainer<PBackgroundIDBDatabaseRequestParent>&
    ManagedPBackgroundIDBDatabaseRequestParent() const;
    ...
    void
    ManagedPBackgroundMutableFileParent(nsTArray<PBackgroundMutableFileParent*>& aArr) const;
    const ManagedContainer<PBackgroundMutableFileParent>&
    ManagedPBackgroundMutableFileParent() const;
    ...
    ManagedEndpoint<PBackgroundIDBDatabaseRequestChild>
    OpenPBackgroundIDBDatabaseRequestEndpoint(PBackgroundIDBDatabaseRequestParent* aActor);
    bool
    ...
    ManagedEndpoint<PBackgroundMutableFileChild>
    OpenPBackgroundMutableFileEndpoint(PBackgroundMutableFileParent* aActor);
    bool
    ...
    [[nodiscard]] PBackgroundMutableFileParent*
...
private:
    ...
    ManagedContainer<PBackgroundIDBDatabaseRequestParent> mManagedPBackgroundIDBDatabaseRequestParent;
    ...
    ManagedContainer<PBackgroundMutableFileParent> mManagedPBackgroundMutableFileParent;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::indexedDB::PBackgroundIDBDatabaseParent*>
{
