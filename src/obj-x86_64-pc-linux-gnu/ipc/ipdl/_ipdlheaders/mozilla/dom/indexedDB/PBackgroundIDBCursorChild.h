...
#ifndef PBackgroundIDBCursorChild_h
#define PBackgroundIDBCursorChild_h
...
public:
    MOZ_IMPLICIT PBackgroundIDBCursorChild();
...
public:
    ...
    SendContinue(
            ...
            const Key& currentObjectStoreKey);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::dom::indexedDB::PBackgroundIDBCursorChild*>
{
    typedef mozilla::dom::indexedDB::PBackgroundIDBCursorChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundIDBCursorChild_h
