...
#ifndef PVideoBridgeParent_h
#define PVideoBridgeParent_h
...
public:
    MOZ_IMPLICIT PVideoBridgeParent();

    virtual ~PVideoBridgeParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::layers::PVideoBridgeParent*>
{
    typedef mozilla::layers::PVideoBridgeParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PVideoBridgeParent_h
