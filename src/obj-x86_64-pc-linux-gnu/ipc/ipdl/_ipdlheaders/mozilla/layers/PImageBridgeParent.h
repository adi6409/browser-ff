...
{
private:
    friend class mozilla::media::PMediaSystemResourceManagerParent;
...
protected:
    ...
    virtual mozilla::ipc::IPCResult
    RecvPMediaSystemResourceManagerConstructor(PMediaSystemResourceManagerParent* actor);
    void
    ProcessingError(
            Result aCode,
...
public:
    MOZ_IMPLICIT PImageBridgeParent();
...
public:
    ...
    void
    ManagedPMediaSystemResourceManagerParent(nsTArray<PMediaSystemResourceManagerParent*>& aArr) const;
    const ManagedContainer<PMediaSystemResourceManagerParent>&
    ManagedPMediaSystemResourceManagerParent() const;
    ...
    ManagedEndpoint<PMediaSystemResourceManagerChild>
    OpenPMediaSystemResourceManagerEndpoint(PMediaSystemResourceManagerParent* aActor);
    bool
    ...
    [[nodiscard]] bool
    SendDidComposite(const nsTArray<ImageCompositeNotification>& aNotifications);
...
private:
    ...
    ManagedContainer<PMediaSystemResourceManagerParent> mManagedPMediaSystemResourceManagerParent;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::layers::PImageBridgeParent*>
{
    typedef mozilla::layers::PImageBridgeParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
