...
#ifndef PLayerTransactionChild_h
#define PLayerTransactionChild_h
...
public:
    MOZ_IMPLICIT PLayerTransactionChild();
...
public:
    ...
    bool
    SendUpdate(const TransactionInfo& txn);

    bool
    SendPaintTime(
            const TransactionId& id,
            const TimeDuration& paintTime);

    bool
    SendSetLayersObserverEpoch(const LayersObserverEpoch& aChildEpoch);
    ...
    bool
    SendReleaseLayer(const LayerHandle& layer);
    ...
    bool
    SendGetTextureFactoryIdentifier(TextureFactoryIdentifier* aIdentifier);

    bool
    SendRecordPaintTimes(const PaintTiming& timing);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::layers::PLayerTransactionChild*>
{
    typedef mozilla::layers::PLayerTransactionChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PLayerTransactionChild_h
