...
#ifndef PCompositorManagerParent_h
#define PCompositorManagerParent_h
...
public:
    typedef std::function<void(const SharedSurfacesMemoryReport&)> ReportSharedSurfacesMemoryResolver;
    typedef std::function<void(const MemoryReport&)> ReportMemoryResolver;

protected:
    virtual mozilla::ipc::IPCResult
    RecvPCompositorBridgeConstructor(
...
public:
    MOZ_IMPLICIT PCompositorManagerParent();

    virtual ~PCompositorManagerParent();

public:
    void
    ManagedPCompositorBridgeParent(nsTArray<PCompositorBridgeParent*>& aArr) const;
    const ManagedContainer<PCompositorBridgeParent>&
    ManagedPCompositorBridgeParent() const;

    void
    AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const override;

    ManagedEndpoint<PCompositorBridgeChild>
    OpenPCompositorBridgeEndpoint(PCompositorBridgeParent* aActor);
    bool
    ...
    [[nodiscard]] bool
    SendNotifyWebRenderError(const WebRenderError& error);
...
private:
    ...
    ManagedContainer<PCompositorBridgeParent> mManagedPCompositorBridgeParent;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::layers::PCompositorManagerParent*>
{
    typedef mozilla::layers::PCompositorManagerParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PCompositorManagerParent_h
