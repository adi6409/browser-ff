...
{
private:
    friend class mozilla::media::PMediaSystemResourceManagerChild;
...
protected:
    ...
    typedef mozilla::media::PMediaSystemResourceManagerChild PMediaSystemResourceManagerChild;
    typedef mozilla::media::PMediaSystemResourceManagerParent PMediaSystemResourceManagerParent;
...
public:
    MOZ_IMPLICIT PImageBridgeChild();
...
public:
    ...
    void
    ManagedPMediaSystemResourceManagerChild(nsTArray<PMediaSystemResourceManagerChild*>& aArr) const;
    const ManagedContainer<PMediaSystemResourceManagerChild>&
    ManagedPMediaSystemResourceManagerChild() const;
    ...
    ManagedEndpoint<PMediaSystemResourceManagerParent>
    OpenPMediaSystemResourceManagerEndpoint(PMediaSystemResourceManagerChild* aActor);
    bool
    BindPMediaSystemResourceManagerEndpoint(
    ...
    PMediaSystemResourceManagerChild*
    SendPMediaSystemResourceManagerConstructor(PMediaSystemResourceManagerChild* actor);
    ...
    bool
    SendReleaseCompositable(const CompositableHandle& aHandle);
    ...
    bool
    SendUpdateAsyncPluginSurface(const SurfaceDescriptorPlugin& aSD);
...
private:
    ...
    ManagedContainer<PMediaSystemResourceManagerChild> mManagedPMediaSystemResourceManagerChild;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::layers::PImageBridgeChild*>
{
    typedef mozilla::layers::PImageBridgeChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
