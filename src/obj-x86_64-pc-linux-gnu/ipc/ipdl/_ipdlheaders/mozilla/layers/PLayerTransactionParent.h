...
#ifndef PLayerTransactionParent_h
#define PLayerTransactionParent_h
...
public:
    MOZ_IMPLICIT PLayerTransactionParent();
...
public:
    ...
    Send__delete__(PLayerTransactionParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::layers::PLayerTransactionParent*>
{
    typedef mozilla::layers::PLayerTransactionParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PLayerTransactionParent_h
