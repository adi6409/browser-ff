...
public:
    ...
    ManagedEndpoint<PWebBrowserPersistResourcesParent>
    OpenPWebBrowserPersistResourcesEndpoint(PWebBrowserPersistResourcesChild* aActor);
    bool
    ...
    ManagedEndpoint<PWebBrowserPersistSerializeParent>
    OpenPWebBrowserPersistSerializeEndpoint(PWebBrowserPersistSerializeChild* aActor);
    bool
    ...
    SendAttributes(
            ...
            const mozilla::Maybe<IPCStream>& stream);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::PWebBrowserPersistDocumentChild*>
{
    typedef mozilla::PWebBrowserPersistDocumentChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
