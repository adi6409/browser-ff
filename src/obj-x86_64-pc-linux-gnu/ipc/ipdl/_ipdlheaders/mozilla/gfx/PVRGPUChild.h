...
#ifndef PVRGPUChild_h
#define PVRGPUChild_h
...
public:
    ...
    bool
    SendPuppetSubmit(const nsTArray<uint64_t>& aBuffer);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::gfx::PVRGPUChild*>
{
    typedef mozilla::gfx::PVRGPUChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
