...
#ifndef PVRManagerChild_h
#define PVRManagerChild_h
...
{
private:
    friend class mozilla::gfx::PVRLayerChild;
protected:
...
public:
    MOZ_IMPLICIT PVRManagerChild();

    virtual ~PVRManagerChild();

public:
    void
    ManagedPVRLayerChild(nsTArray<PVRLayerChild*>& aArr) const;
    const ManagedContainer<PVRLayerChild>&
    ManagedPVRLayerChild() const;

    void
    AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const override;

    ManagedEndpoint<PVRLayerParent>
    OpenPVRLayerEndpoint(PVRLayerChild* aActor);
    bool
    BindPVRLayerEndpoint(
            ManagedEndpoint<PVRLayerChild> aEndpoint,
            PVRLayerChild* aActor);
    ...
    bool
    SendSetHaveEventListener(const bool& aHaveEventListener);
    ...
    bool
    SendStopVibrateHaptic(const GamepadHandle& aGamepadHandle);

    bool
    SendStartVRNavigation(const uint32_t& aDeviceID);
    ...
    bool
    SendRunPuppet(const nsTArray<uint64_t>& buffer);
...
private:
    ...
    ManagedContainer<PVRLayerChild> mManagedPVRLayerChild;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::gfx::PVRManagerChild*>
{
    typedef mozilla::gfx::PVRManagerChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PVRManagerChild_h
