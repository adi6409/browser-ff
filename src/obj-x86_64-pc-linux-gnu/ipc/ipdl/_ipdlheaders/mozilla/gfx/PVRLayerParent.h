...
#ifndef PVRLayerParent_h
#define PVRLayerParent_h
...
{
private:
    friend class mozilla::gfx::PVRManagerParent;
protected:
...
public:
    MOZ_IMPLICIT PVRLayerParent();

    virtual ~PVRLayerParent();
...
public:
    ...
    Send__delete__(PVRLayerParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::gfx::PVRLayerParent*>
{
    typedef mozilla::gfx::PVRLayerParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
