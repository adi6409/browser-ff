...
#ifndef PVRGPUParent_h
#define PVRGPUParent_h
...
public:
    MOZ_IMPLICIT PVRGPUParent();

    virtual ~PVRGPUParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::gfx::PVRGPUParent*>
{
    typedef mozilla::gfx::PVRGPUParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
