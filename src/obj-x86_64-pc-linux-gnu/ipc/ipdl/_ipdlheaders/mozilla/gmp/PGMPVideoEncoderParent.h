...
#ifndef PGMPVideoEncoderParent_h
#define PGMPVideoEncoderParent_h
...
protected:
    ...
    RecvEncoded(
            ...
            nsTArray<uint8_t>&& aCodecSpecificInfo) = 0;
    virtual mozilla::ipc::IPCResult
    RecvError(const GMPErr& aErr) = 0;
    virtual mozilla::ipc::IPCResult
    RecvShutdown() = 0;
    virtual mozilla::ipc::IPCResult
    RecvParentShmemForPool(Shmem&& aFrameBuffer) = 0;
    virtual mozilla::ipc::IPCResult
    AnswerNeedShmem(
...
public:
    MOZ_IMPLICIT PGMPVideoEncoderParent();
...
public:
    ...
    [[nodiscard]] bool
    SendSetPeriodicKeyFrames(const bool& aEnable);

    [[nodiscard]] bool
    SendEncodingComplete();

    [[nodiscard]] bool
    SendChildShmemForPool(Shmem&& aEncodedBuffer);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::gmp::PGMPVideoEncoderParent*>
{
    typedef mozilla::gmp::PGMPVideoEncoderParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PGMPVideoEncoderParent_h
