...
#ifndef PGMPServiceParent_h
#define PGMPServiceParent_h
...
public:
    MOZ_IMPLICIT PGMPServiceParent();

    virtual ~PGMPServiceParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::gmp::PGMPServiceParent*>
{
    typedef mozilla::gmp::PGMPServiceParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PGMPServiceParent_h
