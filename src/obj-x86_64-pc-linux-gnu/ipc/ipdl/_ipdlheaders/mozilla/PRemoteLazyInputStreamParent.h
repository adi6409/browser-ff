...
#ifndef PRemoteLazyInputStreamParent_h
#define PRemoteLazyInputStreamParent_h
...
public:
    MOZ_IMPLICIT PRemoteLazyInputStreamParent();

    virtual ~PRemoteLazyInputStreamParent();
...
public:
    ...
    [[nodiscard]] bool
    SendStreamReady(const mozilla::Maybe<IPCStream>& aStream);

    [[nodiscard]] bool
    SendLengthReady(const int64_t& aLength);

    [[nodiscard]] static bool
    Send__delete__(PRemoteLazyInputStreamParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::PRemoteLazyInputStreamParent*>
{
    typedef mozilla::PRemoteLazyInputStreamParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PRemoteLazyInputStreamParent_h
