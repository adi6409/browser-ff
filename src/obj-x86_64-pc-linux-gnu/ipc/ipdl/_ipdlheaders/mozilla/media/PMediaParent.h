...
public:
    typedef std::function<void(const nsCString&)> GetPrincipalKeyResolver;
...
protected:
    ...
    RecvGetPrincipalKey(
            ...
            const bool& aPersist,
            GetPrincipalKeyResolver&& aResolve) = 0;
    virtual mozilla::ipc::IPCResult
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::media::PMediaParent*>
{
    typedef mozilla::media::PMediaParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
