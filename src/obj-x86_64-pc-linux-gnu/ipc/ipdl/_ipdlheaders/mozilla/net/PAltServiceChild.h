...
#ifndef PAltServiceChild_h
#define PAltServiceChild_h
...
public:
    MOZ_IMPLICIT PAltServiceChild();

    virtual ~PAltServiceChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PAltServiceChild*>
{
    typedef mozilla::net::PAltServiceChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PAltServiceChild_h
