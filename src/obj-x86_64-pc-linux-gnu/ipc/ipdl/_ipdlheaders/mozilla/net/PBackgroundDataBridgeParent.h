...
#ifndef PBackgroundDataBridgeParent_h
#define PBackgroundDataBridgeParent_h
...
public:
    MOZ_IMPLICIT PBackgroundDataBridgeParent();

    virtual ~PBackgroundDataBridgeParent();
...
public:
    ...
    Send__delete__(PBackgroundDataBridgeParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PBackgroundDataBridgeParent*>
{
    typedef mozilla::net::PBackgroundDataBridgeParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundDataBridgeParent_h
