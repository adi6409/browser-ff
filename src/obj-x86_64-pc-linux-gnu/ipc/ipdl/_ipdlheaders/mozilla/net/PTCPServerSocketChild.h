...
#ifndef PTCPServerSocketChild_h
#define PTCPServerSocketChild_h
...
public:
    MOZ_IMPLICIT PTCPServerSocketChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PTCPServerSocketChild*>
{
    typedef mozilla::net::PTCPServerSocketChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PTCPServerSocketChild_h
