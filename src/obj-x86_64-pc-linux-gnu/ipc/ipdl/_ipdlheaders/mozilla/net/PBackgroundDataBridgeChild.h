...
#ifndef PBackgroundDataBridgeChild_h
#define PBackgroundDataBridgeChild_h
...
public:
    MOZ_IMPLICIT PBackgroundDataBridgeChild();

    virtual ~PBackgroundDataBridgeChild();
...
public:
    ...
    static bool
    Send__delete__(PBackgroundDataBridgeChild* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PBackgroundDataBridgeChild*>
{
    typedef mozilla::net::PBackgroundDataBridgeChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PBackgroundDataBridgeChild_h
