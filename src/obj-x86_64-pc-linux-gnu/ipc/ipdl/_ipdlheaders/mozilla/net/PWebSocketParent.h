...
public:
    ...
    [[nodiscard]] bool
    SendOnStop(const nsresult& aStatusCode);
    ...
    [[nodiscard]] bool
    SendOnAcknowledge(const uint32_t& aSize);
    ...
    Send__delete__(PWebSocketParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PWebSocketParent*>
{
    typedef mozilla::net::PWebSocketParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
