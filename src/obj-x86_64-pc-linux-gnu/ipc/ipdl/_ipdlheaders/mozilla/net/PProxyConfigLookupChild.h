...
#ifndef PProxyConfigLookupChild_h
#define PProxyConfigLookupChild_h
...
public:
    MOZ_IMPLICIT PProxyConfigLookupChild();

    virtual ~PProxyConfigLookupChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PProxyConfigLookupChild*>
{
    typedef mozilla::net::PProxyConfigLookupChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PProxyConfigLookupChild_h
