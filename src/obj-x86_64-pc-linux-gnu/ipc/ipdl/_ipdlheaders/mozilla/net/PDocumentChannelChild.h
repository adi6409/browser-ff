...
#ifndef PDocumentChannelChild_h
#define PDocumentChannelChild_h
...
public:
    typedef std::function<void(const nsresult&)> RedirectToRealChannelResolver;
    typedef std::function<void(const MaybeDiscardedBrowsingContext&)> UpgradeObjectLoadResolver;
...
public:
    MOZ_IMPLICIT PDocumentChannelChild();

    virtual ~PDocumentChannelChild();
...
public:
    ...
    static bool
    Send__delete__(PDocumentChannelChild* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PDocumentChannelChild*>
{
    typedef mozilla::net::PDocumentChannelChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PDocumentChannelChild_h
