...
#ifndef PHttpConnectionMgrChild_h
#define PHttpConnectionMgrChild_h
...
public:
    MOZ_IMPLICIT PHttpConnectionMgrChild();

    virtual ~PHttpConnectionMgrChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PHttpConnectionMgrChild*>
{
    typedef mozilla::net::PHttpConnectionMgrChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PHttpConnectionMgrChild_h
