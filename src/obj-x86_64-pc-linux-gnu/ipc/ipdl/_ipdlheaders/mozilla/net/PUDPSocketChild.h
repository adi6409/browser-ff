...
#ifndef PUDPSocketChild_h
#define PUDPSocketChild_h
...
public:
    ...
    bool
    SendConnect(const UDPAddressInfo& addressInfo);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PUDPSocketChild*>
{
    typedef mozilla::net::PUDPSocketChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PUDPSocketChild_h
