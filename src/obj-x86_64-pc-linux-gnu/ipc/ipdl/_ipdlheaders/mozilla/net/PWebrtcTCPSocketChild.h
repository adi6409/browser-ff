...
#ifndef PWebrtcTCPSocketChild_h
#define PWebrtcTCPSocketChild_h
...
protected:
    ...
    RecvOnClose(const nsresult& aReason) = 0;
    virtual mozilla::ipc::IPCResult
    RecvOnConnected(const nsCString& aProxyType) = 0;
    virtual mozilla::ipc::IPCResult
    RecvOnRead(nsTArray<uint8_t>&& aReadData) = 0;
    virtual mozilla::ipc::IPCResult
    Recv__delete__();
public:
...
public:
    MOZ_IMPLICIT PWebrtcTCPSocketChild();

    virtual ~PWebrtcTCPSocketChild();
...
public:
    ...
    SendAsyncOpen(
            ...
            const bool& aUseTls,
            const mozilla::Maybe<WebrtcProxyConfig>& aProxyConfig);

    bool
    SendWrite(const nsTArray<uint8_t>& aWriteData);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PWebrtcTCPSocketChild*>
{
    typedef mozilla::net::PWebrtcTCPSocketChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PWebrtcTCPSocketChild_h
