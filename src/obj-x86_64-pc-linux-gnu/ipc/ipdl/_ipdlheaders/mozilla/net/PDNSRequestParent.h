...
public:
    MOZ_IMPLICIT PDNSRequestParent();

    virtual ~PDNSRequestParent();
...
public:
    ...
    Send__delete__(PDNSRequestParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PDNSRequestParent*>
{
    typedef mozilla::net::PDNSRequestParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
