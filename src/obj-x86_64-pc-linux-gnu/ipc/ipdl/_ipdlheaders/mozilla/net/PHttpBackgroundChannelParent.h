...
#ifndef PHttpBackgroundChannelParent_h
#define PHttpBackgroundChannelParent_h
...
public:
    MOZ_IMPLICIT PHttpBackgroundChannelParent();
...
public:
    ...
    [[nodiscard]] bool
    SendOnConsoleReport(const nsTArray<ConsoleReportCollected>& consoleReport);
    ...
    [[nodiscard]] bool
    SendOnStatus(const nsresult& status);

    [[nodiscard]] bool
    SendOnAfterLastPart(const nsresult& aStatus);
    ...
    [[nodiscard]] bool
    SendNotifyFlashPluginStateChanged(const FlashPluginState& aState);

    [[nodiscard]] bool
    SendSetClassifierMatchedInfo(const ClassifierInfo& info);

    [[nodiscard]] bool
    SendSetClassifierMatchedTrackingInfo(const ClassifierInfo& info);

    [[nodiscard]] bool
    SendAttachStreamFilter(Endpoint<mozilla::extensions::PStreamFilterParent>&& aEndpoint);

    [[nodiscard]] static bool
    Send__delete__(PHttpBackgroundChannelParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PHttpBackgroundChannelParent*>
{
    typedef mozilla::net::PHttpBackgroundChannelParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PHttpBackgroundChannelParent_h
