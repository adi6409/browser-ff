...
#ifndef PAltSvcTransactionChild_h
#define PAltSvcTransactionChild_h
...
public:
    MOZ_IMPLICIT PAltSvcTransactionChild();

    virtual ~PAltSvcTransactionChild();
...
public:
    ...
    bool
    SendOnTransactionClose(const bool& aValidateResult);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PAltSvcTransactionChild*>
{
    typedef mozilla::net::PAltSvcTransactionChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PAltSvcTransactionChild_h
