...
#ifndef PDocumentChannelParent_h
#define PDocumentChannelParent_h
...
public:
    typedef MozPromise<nsresult, ResponseRejectReason, true> RedirectToRealChannelPromise;
    typedef MozPromise<MaybeDiscardedBrowsingContext, ResponseRejectReason, true> UpgradeObjectLoadPromise;
...
public:
    MOZ_IMPLICIT PDocumentChannelParent();

    virtual ~PDocumentChannelParent();
...
public:
    ...
    [[nodiscard]] RefPtr<RedirectToRealChannelPromise>
    SendRedirectToRealChannel(
            const RedirectToRealChannelArgs& args,
            nsTArray<Endpoint<mozilla::extensions::PStreamFilterParent>>&& aEndpoint);
    ...
    [[nodiscard]] RefPtr<UpgradeObjectLoadPromise>
    SendUpgradeObjectLoad();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PDocumentChannelParent*>
{
    typedef mozilla::net::PDocumentChannelParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PDocumentChannelParent_h
