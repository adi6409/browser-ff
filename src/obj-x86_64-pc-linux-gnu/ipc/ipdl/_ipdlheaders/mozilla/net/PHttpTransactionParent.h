...
#ifndef PHttpTransactionParent_h
#define PHttpTransactionParent_h
...
public:
    MOZ_IMPLICIT PHttpTransactionParent();

    virtual ~PHttpTransactionParent();
...
public:
    ...
    Send__delete__(PHttpTransactionParent* actor);
    ...
    [[nodiscard]] bool
    SendCancelPump(const nsresult& status);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PHttpTransactionParent*>
{
    typedef mozilla::net::PHttpTransactionParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PHttpTransactionParent_h
