...
public:
    MOZ_IMPLICIT PCookieServiceChild();
...
public:
    ...
    SendSetCookies(
            ...
            nsIURI* host,
            const bool& fromHttp,
            const nsTArray<CookieStruct>& cookies);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PCookieServiceChild*>
{
    typedef mozilla::net::PCookieServiceChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
