...
#ifndef PSocketProcessBridgeChild_h
#define PSocketProcessBridgeChild_h
...
public:
    MOZ_IMPLICIT PSocketProcessBridgeChild();

    virtual ~PSocketProcessBridgeChild();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PSocketProcessBridgeChild*>
{
    typedef mozilla::net::PSocketProcessBridgeChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PSocketProcessBridgeChild_h
