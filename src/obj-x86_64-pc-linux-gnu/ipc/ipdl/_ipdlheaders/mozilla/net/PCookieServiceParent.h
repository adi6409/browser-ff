...
public:
    MOZ_IMPLICIT PCookieServiceParent();
...
public:
    ...
    SendRemoveBatchDeletedCookies(
            const nsTArray<CookieStruct>& cookiesList,
            const nsTArray<OriginAttributes>& attrsList);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PCookieServiceParent*>
{
    typedef mozilla::net::PCookieServiceParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
