...
#ifndef PGIOChannelChild_h
#define PGIOChannelChild_h
...
protected:
    ...
    virtual mozilla::ipc::IPCResult
    RecvOnStopRequest(const nsresult& channelStatus) = 0;
    virtual mozilla::ipc::IPCResult
...
public:
    MOZ_IMPLICIT PGIOChannelChild();

    virtual ~PGIOChannelChild();
...
public:
    ...
    static bool
    Send__delete__(PGIOChannelChild* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PGIOChannelChild*>
{
    typedef mozilla::net::PGIOChannelChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PGIOChannelChild_h
