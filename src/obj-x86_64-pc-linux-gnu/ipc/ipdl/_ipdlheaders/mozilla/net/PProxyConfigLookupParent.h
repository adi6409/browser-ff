...
#ifndef PProxyConfigLookupParent_h
#define PProxyConfigLookupParent_h
...
public:
    MOZ_IMPLICIT PProxyConfigLookupParent();

    virtual ~PProxyConfigLookupParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PProxyConfigLookupParent*>
{
    typedef mozilla::net::PProxyConfigLookupParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PProxyConfigLookupParent_h
