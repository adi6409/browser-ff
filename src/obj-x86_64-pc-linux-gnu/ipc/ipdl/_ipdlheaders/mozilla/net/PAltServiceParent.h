...
#ifndef PAltServiceParent_h
#define PAltServiceParent_h
...
public:
    MOZ_IMPLICIT PAltServiceParent();

    virtual ~PAltServiceParent();
...
public:
    ...
    Send__delete__(PAltServiceParent* actor);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PAltServiceParent*>
{
    typedef mozilla::net::PAltServiceParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PAltServiceParent_h
