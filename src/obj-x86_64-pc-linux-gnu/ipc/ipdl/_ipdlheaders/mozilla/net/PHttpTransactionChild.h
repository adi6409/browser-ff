...
#ifndef PHttpTransactionChild_h
#define PHttpTransactionChild_h
...
protected:
    ...
    typedef mozilla::net::H2PushedStreamArg H2PushedStreamArg;
    ...
    typedef mozilla::net::NetworkAddressArg NetworkAddressArg;
    ...
    typedef mozilla::net::nsHttpRequestHead nsHttpRequestHead;
...
public:
    MOZ_IMPLICIT PHttpTransactionChild();

    virtual ~PHttpTransactionChild();
...
public:
    ...
    SendOnTransportStatus(
            ...
            const mozilla::Maybe<NetworkAddressArg>& networkAddressArg);
    ...
    bool
    SendOnInitFailed(const nsresult& status);

    bool
    SendOnH2PushStream(
            const uint32_t& pushedStreamId,
            const nsCString& resourceUrl,
            const nsCString& requestString);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PHttpTransactionChild*>
{
    typedef mozilla::net::PHttpTransactionChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PHttpTransactionChild_h
