...
#ifndef PGIOChannelParent_h
#define PGIOChannelParent_h

#include "mozilla/net/PGIOChannel.h"
#ifdef DEBUG
#include "prenv.h"
#endif  // DEBUG
...
public:
    MOZ_IMPLICIT PGIOChannelParent();

    virtual ~PGIOChannelParent();
...
public:
    ...
    [[nodiscard]] bool
    SendOnStopRequest(const nsresult& channelStatus);

    [[nodiscard]] bool
    SendFailedAsyncOpen(const nsresult& statusCode);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PGIOChannelParent*>
{
    typedef mozilla::net::PGIOChannelParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PGIOChannelParent_h
