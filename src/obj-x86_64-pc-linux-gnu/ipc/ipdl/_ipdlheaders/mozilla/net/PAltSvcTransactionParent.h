...
#ifndef PAltSvcTransactionParent_h
#define PAltSvcTransactionParent_h
...
public:
    MOZ_IMPLICIT PAltSvcTransactionParent();

    virtual ~PAltSvcTransactionParent();
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PAltSvcTransactionParent*>
{
    typedef mozilla::net::PAltSvcTransactionParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PAltSvcTransactionParent_h
