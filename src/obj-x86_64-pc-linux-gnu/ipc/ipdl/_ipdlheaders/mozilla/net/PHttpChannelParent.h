...
protected:
    ...
    RecvSetClassOfService(const uint32_t& cos) = 0;
    virtual mozilla::ipc::IPCResult
    RecvSuspend() = 0;
    virtual mozilla::ipc::IPCResult
    RecvResume() = 0;
    ...
    RecvCancel(
            ...
            const uint32_t& requestBlockingReason) = 0;
    virtual mozilla::ipc::IPCResult
    RecvRedirect2Verify(
            ...
            const bool& chooseAppcache) = 0;
    virtual mozilla::ipc::IPCResult
    RecvDocumentChannelCleanup(const bool& clearCacheEntry) = 0;
    virtual mozilla::ipc::IPCResult
    ...
    RecvRemoveCorsPreflightCacheEntry(
            ...
            const OriginAttributes& originAttributes) = 0;
    virtual mozilla::ipc::IPCResult
    RecvDeletingChannel() = 0;
    virtual mozilla::ipc::IPCResult
    RecvOpenOriginalCacheInputStream() = 0;
    virtual mozilla::ipc::IPCResult
    RecvOpenAltDataCacheInputStream(const nsCString& aType) = 0;
    virtual mozilla::ipc::IPCResult
    RecvBytesRead(const int32_t& count) = 0;
    virtual mozilla::ipc::IPCResult
    Recv__delete__();
    virtual mozilla::ipc::IPCResult
    RecvSetPriority(const int16_t& priority) = 0;
public:
...
public:
    MOZ_IMPLICIT PHttpChannelParent();
...
public:
    ...
    [[nodiscard]] bool
    SendFailedAsyncOpen(const nsresult& status);
    ...
    [[nodiscard]] bool
    SendOriginalCacheInputStreamAvailable(const mozilla::Maybe<IPCStream>& stream);

    [[nodiscard]] bool
    SendAltDataCacheInputStreamAvailable(const mozilla::Maybe<IPCStream>& stream);

    [[nodiscard]] bool
    SendSetPriority(const int16_t& priority);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PHttpChannelParent*>
{
    typedef mozilla::net::PHttpChannelParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
