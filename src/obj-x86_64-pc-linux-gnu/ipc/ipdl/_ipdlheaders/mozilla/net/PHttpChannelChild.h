...
protected:
    ...
    RecvLogMimeTypeMismatch(
            ...
            const bool& warning,
            const nsString& url,
            const nsString& contentType) = 0;
    virtual mozilla::ipc::IPCResult
    RecvOriginalCacheInputStreamAvailable(const mozilla::Maybe<IPCStream>& stream) = 0;
    virtual mozilla::ipc::IPCResult
    RecvAltDataCacheInputStreamAvailable(const mozilla::Maybe<IPCStream>& stream) = 0;
    virtual mozilla::ipc::IPCResult
...
public:
    MOZ_IMPLICIT PHttpChannelChild();
...
public:
    ...
    bool
    SendSetClassOfService(const uint32_t& cos);
    ...
    SendRedirect2Verify(
            ...
            const bool& chooseAppcache);

    bool
    SendDocumentChannelCleanup(const bool& clearCacheEntry);
    ...
    bool
    SendOpenAltDataCacheInputStream(const nsCString& aType);

    bool
    SendBytesRead(const int32_t& count);
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::net::PHttpChannelChild*>
{
    typedef mozilla::net::PHttpChannelChild* paramType;
    static void
    Write(
            IPC::Message* aMsg,
