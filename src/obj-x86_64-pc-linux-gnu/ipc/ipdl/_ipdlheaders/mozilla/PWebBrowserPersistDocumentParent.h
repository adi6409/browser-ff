...
#ifndef PWebBrowserPersistDocumentParent_h
#define PWebBrowserPersistDocumentParent_h
...
{
private:
    friend class mozilla::PWebBrowserPersistSerializeParent;
    friend class mozilla::PWebBrowserPersistResourcesParent;
...
public:
    MOZ_IMPLICIT PWebBrowserPersistDocumentParent();
...
public:
    ...
    void
    ManagedPWebBrowserPersistResourcesParent(nsTArray<PWebBrowserPersistResourcesParent*>& aArr) const;
    const ManagedContainer<PWebBrowserPersistResourcesParent>&
    ManagedPWebBrowserPersistResourcesParent() const;

    void
    ManagedPWebBrowserPersistSerializeParent(nsTArray<PWebBrowserPersistSerializeParent*>& aArr) const;
    const ManagedContainer<PWebBrowserPersistSerializeParent>&
    ManagedPWebBrowserPersistSerializeParent() const;

    void
    AllManagedActors(nsTArray<RefPtr<mozilla::ipc::ActorLifecycleProxy>>& arr__) const override;

    ManagedEndpoint<PWebBrowserPersistResourcesChild>
    OpenPWebBrowserPersistResourcesEndpoint(PWebBrowserPersistResourcesParent* aActor);
    bool
    BindPWebBrowserPersistResourcesEndpoint(
            ManagedEndpoint<PWebBrowserPersistResourcesParent> aEndpoint,
            PWebBrowserPersistResourcesParent* aActor);

    ManagedEndpoint<PWebBrowserPersistSerializeChild>
    OpenPWebBrowserPersistSerializeEndpoint(PWebBrowserPersistSerializeParent* aActor);
    bool
    BindPWebBrowserPersistSerializeEndpoint(
            ManagedEndpoint<PWebBrowserPersistSerializeParent> aEndpoint,
            PWebBrowserPersistSerializeParent* aActor);

    [[nodiscard]] bool
    SendSetPersistFlags(const uint32_t& aNewFlags);

    [[nodiscard]] PWebBrowserPersistResourcesParent*
    SendPWebBrowserPersistResourcesConstructor();

    [[nodiscard]] PWebBrowserPersistResourcesParent*
    SendPWebBrowserPersistResourcesConstructor(PWebBrowserPersistResourcesParent* actor);

    [[nodiscard]] PWebBrowserPersistSerializeParent*
    ...
    Send__delete__(PWebBrowserPersistDocumentParent* actor);
...
private:
    ...
    ManagedContainer<PWebBrowserPersistResourcesParent> mManagedPWebBrowserPersistResourcesParent;
    ManagedContainer<PWebBrowserPersistSerializeParent> mManagedPWebBrowserPersistSerializeParent;
};
...
namespace ipc {
template<>
struct IPDLParamTraits <mozilla::PWebBrowserPersistDocumentParent*>
{
    typedef mozilla::PWebBrowserPersistDocumentParent* paramType;
    static void
    Write(
            IPC::Message* aMsg,
...
#endif // ifndef PWebBrowserPersistDocumentParent_h
