...
bool
SpeechSynthesisEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<uint32_t, eDefault>(cx, temp.ref(), "'charIndex' member of SpeechSynthesisEventInit", &mCharIndex)) {
      return false;
    }
  } else {
    mCharIndex = 0U;
  ...
  if (!(!isNull && !temp->isUndefined()) || temp.ref().isNullOrUndefined()) {
    mCharLength.SetNull();
  } else if (!ValueToPrimitive<uint32_t, eDefault>(cx, temp.ref(), "'charLength' member of SpeechSynthesisEventInit", &mCharLength.SetValue())) {
    return false;
  }
  mIsAnyMemberPresent = true;
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<float, eDefault>(cx, temp.ref(), "'elapsedTime' member of SpeechSynthesisEventInit", &mElapsedTime)) {
      return false;
    } else if (!mozilla::IsFinite(mElapsedTime)) {
      cx.ThrowErrorMessage<MSG_NOT_FINITE>("'elapsedTime' member of SpeechSynthesisEventInit");
      return false;
    }
  } else {
    mElapsedTime = 0.0F;
  ...
  if (!isNull && !temp->isUndefined()) {
    if (temp.ref().isObject()) {
      static_assert(IsRefcounted<mozilla::dom::SpeechSynthesisUtterance>::value, "We can only store refcounted classes.");
      {
        ...
        nsresult rv = UnwrapObject<prototypes::id::SpeechSynthesisUtterance, mozilla::dom::SpeechSynthesisUtterance>(temp.ptr(), mUtterance, cx);
        if (NS_FAILED(rv)) {
          cx.ThrowErrorMessage<MSG_DOES_NOT_IMPLEMENT_INTERFACE>("'utterance' member of SpeechSynthesisEventInit", "SpeechSynthesisUtterance");
          return false;
        }
      }
    } else {
      cx.ThrowErrorMessage<MSG_NOT_OBJECT>("'utterance' member of SpeechSynthesisEventInit");
      return false;
    }
    mIsAnyMemberPresent = true;
  } else if (cx) {
    ...
    return cx.ThrowErrorMessage<MSG_MISSING_REQUIRED_DICTIONARY_MEMBER>("'utterance' member of SpeechSynthesisEventInit");
  }
  return true;
}

bool
SpeechSynthesisEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
get_utterance(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechSynthesisEvent", "utterance", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SpeechSynthesisEvent*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::SpeechSynthesisUtterance>(MOZ_KnownLive(self)->Utterance()));
...
MOZ_CAN_RUN_SCRIPT static bool
get_charIndex(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechSynthesisEvent", "charIndex", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SpeechSynthesisEvent*>(void_self);
  uint32_t result(MOZ_KnownLive(self)->CharIndex());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
get_charLength(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechSynthesisEvent", "charLength", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SpeechSynthesisEvent*>(void_self);
  Nullable<uint32_t> result(MOZ_KnownLive(self)->GetCharLength());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (result.IsNull()) {
    args.rval().setNull();
    return true;
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechSynthesisEvent", "elapsedTime", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechSynthesisEvent", "name", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechSynthesisEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("utterance", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &utterance_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("charIndex", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &charIndex_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("charLength", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &charLength_getterinfo, nullptr, nullptr),
  ...
  JS_STRING_SYM_PS(toStringTag, "SpeechSynthesisEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "SpeechSynthesisEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechSynthesisEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "SpeechSynthesisEvent constructor", 2)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::SpeechSynthesisEvent>(mozilla::dom::SpeechSynthesisEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::SpeechSynthesisEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::SpeechSynthesisEvent>,
