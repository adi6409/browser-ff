...
namespace MouseScrollEvent_Binding {
...
get_axis(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "MouseScrollEvent", "axis", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::MouseScrollEvent*>(void_self);
  int32_t result(MOZ_KnownLive(self)->Axis());
...
static const JSJitInfo axis_getterinfo = {
  { get_axis },
  { prototypes::id::MouseScrollEvent },
  { PrototypeTraits<prototypes::id::MouseScrollEvent>::Depth },
  JSJitInfo::Getter,
...
MOZ_CAN_RUN_SCRIPT static bool
initMouseScrollEvent(JSContext* cx_, JS::Handle<JSObject*> obj, void* void_self, const JSJitMethodCallArgs& args)
{
  BindingCallContext cx(cx_, "MouseScrollEvent.initMouseScrollEvent");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "MouseScrollEvent", "initMouseScrollEvent", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::MouseScrollEvent*>(void_self);
  if (!args.requireAtLeast(cx, "MouseScrollEvent.initMouseScrollEvent", 1)) {
    return false;
  }
  ...
  if (args.hasDefined(15)) {
    if (!ValueToPrimitive<int32_t, eDefault>(cx, args[15], "Argument 16", &arg15)) {
      return false;
    }
  } else {
    arg15 = 0;
  ...
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->InitMouseScrollEvent(NonNullHelper(Constify(arg0)), arg1, arg2, MOZ_KnownLive(Constify(arg3)), arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, MOZ_KnownLive(Constify(arg14)), arg15))>, "Should be returning void here");
  MOZ_KnownLive(self)->InitMouseScrollEvent(NonNullHelper(Constify(arg0)), arg1, arg2, MOZ_KnownLive(Constify(arg3)), arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, MOZ_KnownLive(Constify(arg14)), arg15);
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  args.rval().setUndefined();
  return true;
}

static const JSJitInfo initMouseScrollEvent_methodinfo = {
  { (JSJitGetterOp)initMouseScrollEvent },
  { prototypes::id::MouseScrollEvent },
  { PrototypeTraits<prototypes::id::MouseScrollEvent>::Depth },
  JSJitInfo::Method,
  JSJitInfo::AliasEverything, /* aliasSet.  Not relevant for setters. */
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "MouseScrollEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  mozilla::dom::MouseScrollEvent* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::MouseScrollEvent>(obj);
...
_finalize(JSFreeOp* fop, JSObject* obj)
{
  ...
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::dom::MouseScrollEvent>(self);
  }
}
...
static const JSFunctionSpec sMethods_specs[] = {
  JS_FNSPEC("initMouseScrollEvent", (GenericMethod<NormalThisPolicy, ThrowExceptions>), reinterpret_cast<const JSJitInfo*>(&initMouseScrollEvent_methodinfo), 1, JSPROP_ENUMERATE, nullptr),
  JS_FS_END
};
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "MouseScrollEvent", JSPROP_READONLY),
  JS_PS_END
};
...
static const ConstantSpec sConstants_specs[] = {
  { "HORIZONTAL_AXIS", JS::Int32Value(1) },
  { "VERTICAL_AXIS", JS::Int32Value(2) },
  { 0, JS::UndefinedValue() }
};
...
static const DOMJSClass sClass = {
  ...
  { prototypes::id::Event, prototypes::id::UIEvent, prototypes::id::MouseEvent, prototypes::id::MouseScrollEvent, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  std::is_base_of_v<nsISupports, mozilla::dom::MouseScrollEvent>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::dom::MouseScrollEvent>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::dom::MouseScrollEvent>::Get(),
  nullptr,
  _getWrapperCache
};
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::MouseScrollEvent>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::dom::MouseScrollEvent*>(aObject) ==
             reinterpret_cast<mozilla::dom::MouseScrollEvent*>(aObject),
             "Multiple inheritance for mozilla::dom::MouseScrollEvent is broken.");
  ...
  BindingJSObjectCreator<mozilla::dom::MouseScrollEvent> creator(aCx);
...
const NativePropertyHooks sNativePropertyHooks[] = { {
  ...
  prototypes::id::MouseScrollEvent,
  constructors::id::MouseScrollEvent,
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::MouseScrollEvent);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::MouseScrollEvent);
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              ...
                              nullptr,
                              "MouseScrollEvent", aDefineOnGlobal,
                              nullptr,
                              false,
                              nullptr,
                              false);
