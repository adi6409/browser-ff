...
static const JSPropertySpec sAttributes_specs[] = {
  JS_STRING_SYM_PS(toStringTag, "SVGFEFuncGElement", JSPROP_READONLY),
  JS_PS_END
};
...
Wrap(JSContext* aCx, mozilla::dom::SVGFEFuncGElement* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector)
{
  ...
  MOZ_ASSERT(static_cast<mozilla::dom::SVGFEFuncGElement*>(aObject) ==
             reinterpret_cast<mozilla::dom::SVGFEFuncGElement*>(aObject),
             "Multiple inheritance for mozilla::dom::SVGFEFuncGElement is broken.");
