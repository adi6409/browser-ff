...
get_maxChannelCount(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "AudioDestinationNode", "maxChannelCount", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::AudioDestinationNode*>(void_self);
  uint32_t result(MOZ_KnownLive(self)->MaxChannelCount());
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("maxChannelCount", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &maxChannelCount_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "AudioDestinationNode", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::AudioDestinationNode>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::AudioDestinationNode>,
