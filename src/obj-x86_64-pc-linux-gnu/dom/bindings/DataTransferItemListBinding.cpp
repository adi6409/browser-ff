...
get_length(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "DataTransferItemList", "length", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::DataTransferItemList*>(void_self);
...
{
  BindingCallContext cx(cx_, "DataTransferItemList.add");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "DataTransferItemList", "add", DOM, cx,
  ...
  switch (argcount) {
    case 1: {
      ...
      if (args[0].isObject()) {
        {
          ...
          nsresult rv = UnwrapObject<prototypes::id::File, mozilla::dom::File>(args[0], arg0, cx);
          if (NS_FAILED(rv)) {
            cx.ThrowErrorMessage<MSG_DOES_NOT_IMPLEMENT_INTERFACE>("Argument 1", "File");
            return false;
          }
        }
      } else {
      ...
      auto result(StrongOrRawPtr<mozilla::dom::DataTransferItem>(MOZ_KnownLive(self)->Add(MOZ_KnownLive(NonNullHelper(arg0)), MOZ_KnownLive(NonNullHelper(subjectPrincipal)), rv)));
      if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "DataTransferItemList.add"))) {
        return false;
      }
      MOZ_ASSERT(!JS_IsExceptionPending(cx));
      if (!result) {
    ...
    case 2: {
      ...
      auto result(StrongOrRawPtr<mozilla::dom::DataTransferItem>(MOZ_KnownLive(self)->Add(NonNullHelper(Constify(arg0)), NonNullHelper(Constify(arg1)), MOZ_KnownLive(NonNullHelper(subjectPrincipal)), rv)));
      if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "DataTransferItemList.add"))) {
        return false;
      }
      MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "DataTransferItemList", "remove", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::DataTransferItemList*>(void_self);
  if (!args.requireAtLeast(cx, "DataTransferItemList.remove", 1)) {
    return false;
  }
  uint32_t arg0;
  ...
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->Remove(arg0, MOZ_KnownLive(NonNullHelper(subjectPrincipal)), rv))>, "Should be returning void here");
  MOZ_KnownLive(self)->Remove(arg0, MOZ_KnownLive(NonNullHelper(subjectPrincipal)), rv);
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "DataTransferItemList.remove"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "DataTransferItemList", "clear", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "DataTransferItemList.clear"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  args.rval().setUndefined();
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "DataTransferItemList", JSPROP_READONLY),
  JS_PS_END
};
...
static_assert(std::is_base_of_v<nsISupports, mozilla::dom::DataTransferItemList>,
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (IsArrayIndex(index)) {
    ...
    bool found = false;
    auto result(StrongOrRawPtr<mozilla::dom::DataTransferItem>(MOZ_KnownLive(self)->IndexedGetter(index, found)));
    MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::DataTransferItemList>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::DataTransferItemList>,
