...
namespace ChromeNodeList_Binding {
...
{
  BindingCallContext cx(cx_, "ChromeNodeList.append");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ChromeNodeList", "append", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::ChromeNodeList*>(void_self);
  if (!args.requireAtLeast(cx, "ChromeNodeList.append", 1)) {
    return false;
  }
  ...
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->Append(MOZ_KnownLive(NonNullHelper(arg0)), rv))>, "Should be returning void here");
  MOZ_KnownLive(self)->Append(MOZ_KnownLive(NonNullHelper(arg0)), rv);
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "ChromeNodeList.append"))) {
    return false;
  }
...
static const JSJitInfo append_methodinfo = {
  ...
  { prototypes::id::ChromeNodeList },
  { PrototypeTraits<prototypes::id::ChromeNodeList>::Depth },
  JSJitInfo::Method,
...
{
  BindingCallContext cx(cx_, "ChromeNodeList.remove");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ChromeNodeList", "remove", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::ChromeNodeList*>(void_self);
  if (!args.requireAtLeast(cx, "ChromeNodeList.remove", 1)) {
    return false;
  }
  NonNull<nsINode> arg0;
  if (args[0].isObject()) {
  ...
  FastErrorResult rv;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->Remove(MOZ_KnownLive(NonNullHelper(arg0)), rv))>, "Should be returning void here");
  MOZ_KnownLive(self)->Remove(MOZ_KnownLive(NonNullHelper(arg0)), rv);
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "ChromeNodeList.remove"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  args.rval().setUndefined();
...
static const JSPropertySpec sAttributes_specs[] = {
  JS_STRING_SYM_PS(toStringTag, "ChromeNodeList", JSPROP_READONLY),
  JS_PS_END
};
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ChromeNodeList", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
  JS::Rooted<JSObject*> obj(cx, &args.callee());
  if (!args.isConstructing()) {
    return ThrowConstructorWithoutNew(cx, "ChromeNodeList");
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::ChromeNodeList>(mozilla::dom::ChromeNodeList::Constructor(global)));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static_assert(std::is_base_of_v<nsISupports, mozilla::dom::ChromeNodeList>,
...
MOZ_ALWAYS_INLINE mozilla::dom::ChromeNodeList*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<mozilla::dom::ChromeNodeList*>(js::GetProxyReservedSlot(obj, DOM_OBJECT_SLOT).toPrivate());
}
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (IsArrayIndex(index)) {
    mozilla::dom::ChromeNodeList* self = UnwrapProxy(proxy);
    bool found = false;
...
{
  mozilla::dom::ChromeNodeList* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::ChromeNodeList>(proxy);
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::dom::ChromeNodeList>(self);
  }
}
...
{
  mozilla::dom::ChromeNodeList* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::ChromeNodeList>(obj);
  if (self) {
...
static const DOMJSClass sClass = {
  PROXY_CLASS_DEF("ChromeNodeList",
                  JSCLASS_IS_DOMJSCLASS | JSCLASS_HAS_RESERVED_SLOTS(1)),
  { prototypes::id::NodeList, prototypes::id::ChromeNodeList, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  std::is_base_of_v<nsISupports, mozilla::dom::ChromeNodeList>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::dom::ChromeNodeList>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::dom::ChromeNodeList>::Get(),
  nullptr,
  nullptr
};
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::ChromeNodeList>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::dom::ChromeNodeList*>(aObject) ==
             reinterpret_cast<mozilla::dom::ChromeNodeList*>(aObject),
             "Multiple inheritance for mozilla::dom::ChromeNodeList is broken.");
  ...
  BindingJSObjectCreator<mozilla::dom::ChromeNodeList> creator(aCx);
...
const NativePropertyHooks sNativePropertyHooks[] = { {
  ...
  prototypes::id::ChromeNodeList,
  constructors::id::ChromeNodeList,
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::ChromeNodeList);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::ChromeNodeList);
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              ...
                              nullptr,
                              "ChromeNodeList", aDefineOnGlobal,
                              nullptr,
                              false,
                              nullptr,
                              false);
