...
get_text(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLTitleElement", "text", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::HTMLTitleElement*>(void_self);
  FastErrorResult rv;
  DOMString result;
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "HTMLTitleElement.text getter"))) {
    return false;
  }
...
set_text(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitSetterCallArgs args)
{
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "HTMLTitleElement.text setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "HTMLTitleElement", JSPROP_READONLY),
  JS_PS_END
};
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLTitleElement", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::HTMLTitleElement>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::HTMLTitleElement>,
