...
static const JSPropertySpec sAttributes_specs[] = {
  JS_STRING_SYM_PS(toStringTag, "GleanCategory", JSPROP_READONLY),
  JS_PS_END
};
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (callNamedGetter) {
    ...
    if (!isSymbol) {
      ...
      bool found = false;
      auto result(StrongOrRawPtr<nsISupports>(MOZ_KnownLive(self)->NamedGetter(NonNullHelper(Constify(identifier)), found)));
...
Wrap(JSContext* aCx, mozilla::glean::Category* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector)
{
  ...
  MOZ_ASSERT(static_cast<mozilla::glean::Category*>(aObject) ==
             reinterpret_cast<mozilla::glean::Category*>(aObject),
             "Multiple inheritance for mozilla::glean::Category is broken.");
...
// We deliberately use brace-elision to make Visual Studio produce better initalization code.
static const JSPropertySpec sAttributes_specs[] = {
  JS_STRING_SYM_PS(toStringTag, "GleanImpl", JSPROP_READONLY),
  JS_PS_END
};
...
Wrap(JSContext* aCx, mozilla::glean::Glean* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector)
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::glean::Glean>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::glean::Glean*>(aObject) ==
             reinterpret_cast<mozilla::glean::Glean*>(aObject),
             "Multiple inheritance for mozilla::glean::Glean is broken.");
  MOZ_ASSERT(ToSupportsIsCorrect(aObject));
  MOZ_ASSERT_IF(aGivenProto, js::IsObjectInContextCompartment(aGivenProto, aCx));
  MOZ_ASSERT(!aCache->GetWrapper(),
             "You should probably not be using Wrap() directly; use "
...
// We deliberately use brace-elision to make Visual Studio produce better initalization code.
static const JSPropertySpec sAttributes_specs[] = {
  JS_STRING_SYM_PS(toStringTag, "GleanLabeled", JSPROP_READONLY),
  JS_PS_END
};
...
Wrap(JSContext* aCx, mozilla::glean::GleanLabeled* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector)
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::glean::GleanLabeled>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::glean::GleanLabeled*>(aObject) ==
             reinterpret_cast<mozilla::glean::GleanLabeled*>(aObject),
             "Multiple inheritance for mozilla::glean::GleanLabeled is broken.");
  MOZ_ASSERT(ToSupportsIsCorrect(aObject));
  MOZ_ASSERT_IF(aGivenProto, js::IsObjectInContextCompartment(aGivenProto, aCx));
  MOZ_ASSERT(!aCache->GetWrapper(),
             "You should probably not be using Wrap() directly; use "
