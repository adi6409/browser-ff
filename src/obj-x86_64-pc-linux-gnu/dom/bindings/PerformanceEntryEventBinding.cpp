...
bool
PerformanceEntryEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<double, eDefault>(cx, temp.ref(), "'duration' member of PerformanceEntryEventInit", &mDuration)) {
      return false;
    } else if (!mozilla::IsFinite(mDuration)) {
      cx.ThrowErrorMessage<MSG_NOT_FINITE>("'duration' member of PerformanceEntryEventInit");
      return false;
    }
  } else {
    mDuration = 0.0;
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<double, eDefault>(cx, temp.ref(), "'epoch' member of PerformanceEntryEventInit", &mEpoch)) {
      return false;
    } else if (!mozilla::IsFinite(mEpoch)) {
      cx.ThrowErrorMessage<MSG_NOT_FINITE>("'epoch' member of PerformanceEntryEventInit");
      return false;
    }
  } else {
    mEpoch = 0.0;
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<double, eDefault>(cx, temp.ref(), "'startTime' member of PerformanceEntryEventInit", &mStartTime)) {
      return false;
    } else if (!mozilla::IsFinite(mStartTime)) {
      cx.ThrowErrorMessage<MSG_NOT_FINITE>("'startTime' member of PerformanceEntryEventInit");
      return false;
    }
  } else {
    mStartTime = 0.0;
...
bool
PerformanceEntryEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
bool
PerformanceEntryEventInit::operator==(const PerformanceEntryEventInit& aOther) const
{
...
get_name(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PerformanceEntryEvent", "name", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::PerformanceEntryEvent*>(void_self);
  DOMString result;
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PerformanceEntryEvent", "entryType", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PerformanceEntryEvent", "startTime", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PerformanceEntryEvent", "duration", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
MOZ_CAN_RUN_SCRIPT static bool
get_epoch(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PerformanceEntryEvent", "epoch", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::PerformanceEntryEvent*>(void_self);
  double result(MOZ_KnownLive(self)->Epoch());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  args.rval().set(JS_NumberValue(double(result)));
  return true;
}
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PerformanceEntryEvent", "origin", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PerformanceEntryEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JSPropertySpec::nativeAccessors("epoch", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &epoch_getterinfo, nullptr, nullptr),
  ...
  JS_STRING_SYM_PS(toStringTag, "PerformanceEntryEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "PerformanceEntryEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PerformanceEntryEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "PerformanceEntryEvent constructor", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::PerformanceEntryEvent>(mozilla::dom::PerformanceEntryEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::PerformanceEntryEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::PerformanceEntryEvent>,
