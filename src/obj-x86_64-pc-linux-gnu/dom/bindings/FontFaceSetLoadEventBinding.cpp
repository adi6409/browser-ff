...
bool
FontFaceSetLoadEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  if (!isNull && !temp->isUndefined()) {
    if (temp.ref().isObject()) {
      ...
      if (!iter.valueIsIterable()) {
        cx.ThrowErrorMessage<MSG_NOT_SEQUENCE>("'fontfaces' member of FontFaceSetLoadEventInit");
        return false;
      }
      ...
      while (true) {
        ...
        if (temp.isObject()) {
          static_assert(IsRefcounted<mozilla::dom::FontFace>::value, "We can only store refcounted classes.");
          {
            ...
            nsresult rv = UnwrapObject<prototypes::id::FontFace, mozilla::dom::FontFace>(&temp, slot, cx);
            if (NS_FAILED(rv)) {
              cx.ThrowErrorMessage<MSG_DOES_NOT_IMPLEMENT_INTERFACE>("Element of 'fontfaces' member of FontFaceSetLoadEventInit", "FontFace");
              return false;
            }
          }
        } else {
          cx.ThrowErrorMessage<MSG_NOT_OBJECT>("Element of 'fontfaces' member of FontFaceSetLoadEventInit");
          return false;
        }
      }
    } else {
    ...
    /* mFontfaces array is already empty; nothing to do */
  }
...
bool
FontFaceSetLoadEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
get_fontfaces(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "FontFaceSetLoadEvent", "fontfaces", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::FontFaceSetLoadEvent*>(void_self);
  ...
  nsTArray<StrongPtrForMember<mozilla::dom::FontFace>> result;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->GetFontfaces(result))>, "Should be returning void here");
  MOZ_KnownLive(self)->GetFontfaces(result);
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "FontFaceSetLoadEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("fontfaces", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &fontfaces_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "FontFaceSetLoadEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "FontFaceSetLoadEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "FontFaceSetLoadEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "FontFaceSetLoadEvent constructor", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::FontFaceSetLoadEvent>(mozilla::dom::FontFaceSetLoadEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::FontFaceSetLoadEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::FontFaceSetLoadEvent>,
