...
get_length(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PluginArray", "length", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<nsPluginArray*>(void_self);
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PluginArray", "item", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<nsPluginArray*>(void_self);
  if (!args.requireAtLeast(cx, "PluginArray.item", 1)) {
    return false;
  }
  uint32_t arg0;
  ...
  auto result(StrongOrRawPtr<nsPluginElement>(MOZ_KnownLive(self)->Item(arg0, nsContentUtils::IsSystemCaller(cx) ? CallerType::System : CallerType::NonSystem)));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!result) {
    args.rval().setNull();
    return true;
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PluginArray", "namedItem", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<nsPluginArray*>(void_self);
  if (!args.requireAtLeast(cx, "PluginArray.namedItem", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<nsPluginElement>(MOZ_KnownLive(self)->NamedItem(NonNullHelper(Constify(arg0)), nsContentUtils::IsSystemCaller(cx) ? CallerType::System : CallerType::NonSystem)));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!result) {
    args.rval().setNull();
    return true;
...
MOZ_CAN_RUN_SCRIPT static bool
refresh(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, const JSJitMethodCallArgs& args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PluginArray", "refresh", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->Refresh(arg0))>, "Should be returning void here");
  MOZ_KnownLive(self)->Refresh(arg0);
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "PluginArray", JSPROP_READONLY),
  JS_PS_END
};
...
static_assert(std::is_base_of_v<nsISupports, nsPluginArray>,
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (IsArrayIndex(index)) {
    ...
    bool found = false;
    auto result(StrongOrRawPtr<nsPluginElement>(MOZ_KnownLive(self)->IndexedGetter(index, found, nsContentUtils::IsSystemCaller(cx) ? CallerType::System : CallerType::NonSystem)));
    MOZ_ASSERT(!JS_IsExceptionPending(cx));
  ...
  if (callNamedGetter) {
    ...
    if (!isSymbol) {
      nsPluginArray* self = UnwrapProxy(proxy);
      bool found = false;
      auto result(StrongOrRawPtr<nsPluginElement>(MOZ_KnownLive(self)->NamedGetter(NonNullHelper(Constify(name)), found, nsContentUtils::IsSystemCaller(cx) ? CallerType::System : CallerType::NonSystem)));
      MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, nsPluginArray>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, nsPluginArray>,
