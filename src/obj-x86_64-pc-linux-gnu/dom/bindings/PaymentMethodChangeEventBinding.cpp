...
bool
PaymentMethodChangeEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
#pragma clang diagnostic ignored "-Wunreachable-code-return"
      ...
      if ((passedToJSImpl) && !CallerSubsumes(temp.ref())) {
        cx.ThrowErrorMessage<MSG_PERMISSION_DENIED_TO_PASS_ARG>("'methodDetails' member of PaymentMethodChangeEventInit");
        return false;
      }
#ifdef __clang__
#pragma clang diagnostic pop
      ...
      cx.ThrowErrorMessage<MSG_NOT_OBJECT>("'methodDetails' member of PaymentMethodChangeEventInit");
      return false;
    }
  } else {
    mMethodDetails = nullptr;
...
bool
PaymentMethodChangeEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
get_methodName(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PaymentMethodChangeEvent", "methodName", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::PaymentMethodChangeEvent*>(void_self);
  DOMString result;
...
MOZ_CAN_RUN_SCRIPT static bool
get_methodDetails(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PaymentMethodChangeEvent", "methodDetails", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->GetMethodDetails(cx, &result))>, "Should be returning void here");
  MOZ_KnownLive(self)->GetMethodDetails(cx, &result);
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (result) {
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PaymentMethodChangeEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JSPropertySpec::nativeAccessors("methodDetails", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &methodDetails_getterinfo, nullptr, nullptr),
  JS_PS_END,
  JS_STRING_SYM_PS(toStringTag, "PaymentMethodChangeEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "PaymentMethodChangeEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PaymentMethodChangeEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "PaymentMethodChangeEvent constructor", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::PaymentMethodChangeEvent>(mozilla::dom::PaymentMethodChangeEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::PaymentMethodChangeEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::PaymentMethodChangeEvent>,
