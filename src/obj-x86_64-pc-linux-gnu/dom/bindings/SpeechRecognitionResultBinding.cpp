...
#include "mozilla/dom/SpeechRecognitionResult.h"
...
namespace SpeechRecognitionResult_Binding {

MOZ_CAN_RUN_SCRIPT static bool
get_length(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechRecognitionResult", "length", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SpeechRecognitionResult*>(void_self);
...
static const JSJitInfo length_getterinfo = {
  { get_length },
  { prototypes::id::SpeechRecognitionResult },
  { PrototypeTraits<prototypes::id::SpeechRecognitionResult>::Depth },
  JSJitInfo::Getter,
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechRecognitionResult", "item", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SpeechRecognitionResult*>(void_self);
  if (!args.requireAtLeast(cx, "SpeechRecognitionResult.item", 1)) {
    return false;
  }
  uint32_t arg0;
  ...
  auto result(StrongOrRawPtr<mozilla::dom::SpeechRecognitionAlternative>(MOZ_KnownLive(self)->Item(arg0)));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
get_isFinal(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechRecognitionResult", "isFinal", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SpeechRecognitionResult*>(void_self);
  bool result(MOZ_KnownLive(self)->IsFinal());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  args.rval().setBoolean(result);
  return true;
}

static const JSJitInfo isFinal_getterinfo = {
  { get_isFinal },
  { prototypes::id::SpeechRecognitionResult },
  { PrototypeTraits<prototypes::id::SpeechRecognitionResult>::Depth },
  JSJitInfo::Getter,
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JSPropertySpec::nativeAccessors("isFinal", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &isFinal_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "SpeechRecognitionResult", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMIfaceAndProtoJSClass sPrototypeClass = {
  {
    "SpeechRecognitionResultPrototype",
...
static_assert(std::is_base_of_v<nsISupports, mozilla::dom::SpeechRecognitionResult>,
...
MOZ_ALWAYS_INLINE mozilla::dom::SpeechRecognitionResult*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<mozilla::dom::SpeechRecognitionResult*>(js::GetProxyReservedSlot(obj, DOM_OBJECT_SLOT).toPrivate());
}
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (IsArrayIndex(index)) {
    mozilla::dom::SpeechRecognitionResult* self = UnwrapProxy(proxy);
    bool found = false;
    auto result(StrongOrRawPtr<mozilla::dom::SpeechRecognitionAlternative>(MOZ_KnownLive(self)->IndexedGetter(index, found)));
    MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  mozilla::dom::SpeechRecognitionResult* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::SpeechRecognitionResult>(proxy);
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::dom::SpeechRecognitionResult>(self);
  }
}
...
{
  mozilla::dom::SpeechRecognitionResult* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::SpeechRecognitionResult>(obj);
  if (self) {
...
static const DOMJSClass sClass = {
  PROXY_CLASS_DEF("SpeechRecognitionResult",
                  JSCLASS_IS_DOMJSCLASS | JSCLASS_HAS_RESERVED_SLOTS(1)),
  { prototypes::id::SpeechRecognitionResult, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  std::is_base_of_v<nsISupports, mozilla::dom::SpeechRecognitionResult>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::dom::SpeechRecognitionResult>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::dom::SpeechRecognitionResult>::Get(),
  nullptr,
  nullptr
};
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::SpeechRecognitionResult>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::dom::SpeechRecognitionResult*>(aObject) ==
             reinterpret_cast<mozilla::dom::SpeechRecognitionResult*>(aObject),
             "Multiple inheritance for mozilla::dom::SpeechRecognitionResult is broken.");
  ...
  BindingJSObjectCreator<mozilla::dom::SpeechRecognitionResult> creator(aCx);
...
const NativePropertyHooks sNativePropertyHooks[] = { {
  ...
  prototypes::id::SpeechRecognitionResult,
  constructors::id::SpeechRecognitionResult,
  nullptr,
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::SpeechRecognitionResult);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::SpeechRecognitionResult);
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              ...
                              nullptr,
                              "SpeechRecognitionResult", aDefineOnGlobal,
                              nullptr,
                              false,
                              nullptr,
                              false);
