...
namespace MimeTypeArray_Binding {

MOZ_CAN_RUN_SCRIPT static bool
get_length(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "MimeTypeArray", "length", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<nsMimeTypeArray*>(void_self);
  uint32_t result(MOZ_KnownLive(self)->Length(nsContentUtils::IsSystemCaller(cx) ? CallerType::System : CallerType::NonSystem));
...
static const JSJitInfo length_getterinfo = {
  { get_length },
  { prototypes::id::MimeTypeArray },
  { PrototypeTraits<prototypes::id::MimeTypeArray>::Depth },
  JSJitInfo::Getter,
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "MimeTypeArray", "item", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<nsMimeTypeArray*>(void_self);
  if (!args.requireAtLeast(cx, "MimeTypeArray.item", 1)) {
    return false;
  }
  uint32_t arg0;
  ...
  auto result(StrongOrRawPtr<nsMimeType>(MOZ_KnownLive(self)->Item(arg0, nsContentUtils::IsSystemCaller(cx) ? CallerType::System : CallerType::NonSystem)));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!result) {
    args.rval().setNull();
    return true;
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "MimeTypeArray", "namedItem", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<nsMimeTypeArray*>(void_self);
  if (!args.requireAtLeast(cx, "MimeTypeArray.namedItem", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<nsMimeType>(MOZ_KnownLive(self)->NamedItem(NonNullHelper(Constify(arg0)), nsContentUtils::IsSystemCaller(cx) ? CallerType::System : CallerType::NonSystem)));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!result) {
    args.rval().setNull();
    return true;
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "MimeTypeArray", JSPROP_READONLY),
  JS_PS_END
};
...
static_assert(std::is_base_of_v<nsISupports, nsMimeTypeArray>,
...
MOZ_ALWAYS_INLINE nsMimeTypeArray*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<nsMimeTypeArray*>(js::GetProxyReservedSlot(obj, DOM_OBJECT_SLOT).toPrivate());
}
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (IsArrayIndex(index)) {
    nsMimeTypeArray* self = UnwrapProxy(proxy);
    bool found = false;
    auto result(StrongOrRawPtr<nsMimeType>(MOZ_KnownLive(self)->IndexedGetter(index, found, nsContentUtils::IsSystemCaller(cx) ? CallerType::System : CallerType::NonSystem)));
    MOZ_ASSERT(!JS_IsExceptionPending(cx));
  ...
  if (callNamedGetter) {
    ...
    if (!isSymbol) {
      nsMimeTypeArray* self = UnwrapProxy(proxy);
      bool found = false;
      auto result(StrongOrRawPtr<nsMimeType>(MOZ_KnownLive(self)->NamedGetter(NonNullHelper(Constify(name)), found, nsContentUtils::IsSystemCaller(cx) ? CallerType::System : CallerType::NonSystem)));
      MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  nsMimeTypeArray* self = UnwrapPossiblyNotInitializedDOMObject<nsMimeTypeArray>(proxy);
  if (self) {
    ...
    AddForDeferredFinalization<nsMimeTypeArray>(self);
  }
}
...
{
  nsMimeTypeArray* self = UnwrapPossiblyNotInitializedDOMObject<nsMimeTypeArray>(obj);
  if (self) {
...
static const DOMJSClass sClass = {
  PROXY_CLASS_DEF("MimeTypeArray",
                  JSCLASS_IS_DOMJSCLASS | JSCLASS_HAS_RESERVED_SLOTS(1)),
  { prototypes::id::MimeTypeArray, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  std::is_base_of_v<nsISupports, nsMimeTypeArray>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<nsMimeTypeArray>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<nsMimeTypeArray>::Get(),
  nullptr,
  nullptr
};
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, nsMimeTypeArray>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<nsMimeTypeArray*>(aObject) ==
             reinterpret_cast<nsMimeTypeArray*>(aObject),
             "Multiple inheritance for nsMimeTypeArray is broken.");
  ...
  BindingJSObjectCreator<nsMimeTypeArray> creator(aCx);
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::MimeTypeArray);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::MimeTypeArray);
