/* THIS FILE IS AUTOGENERATED FROM MozStorageStatementRow.webidl BY Codegen.py - DO NOT EDIT */
...
#include "mozilla/storage/mozStorageStatementRow.h"
...
namespace MozStorageStatementRow_Binding {

// We deliberately use brace-elision to make Visual Studio produce better initalization code.
static const JSPropertySpec sAttributes_specs[] = {
  JS_STRING_SYM_PS(toStringTag, "MozStorageStatementRow", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMIfaceAndProtoJSClass sInterfaceObjectClass = {
  ...
  eInterface,
  true,
  prototypes::id::MozStorageStatementRow,
  PrototypeTraits<prototypes::id::MozStorageStatementRow>::Depth,
  sNativePropertyHooks,
  "function MozStorageStatementRow() {\n    [native code]\n}",
  JS::GetRealmFunctionPrototype
};

static const DOMIfaceAndProtoJSClass sPrototypeClass = {
  {
    "MozStorageStatementRowPrototype",
...
static_assert(std::is_base_of_v<nsISupports, mozilla::storage::StatementRow>,
...
MOZ_ALWAYS_INLINE mozilla::storage::StatementRow*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<mozilla::storage::StatementRow*>(js::GetProxyReservedSlot(obj, DOM_OBJECT_SLOT).toPrivate());
}
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (callNamedGetter) {
    ...
    if (!isSymbol) {
      mozilla::storage::StatementRow* self = UnwrapProxy(proxy);
      bool found = false;
      FastErrorResult rv;
      ...
      if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "MozStorageStatementRow named getter"))) {
        return false;
      }
...
{
  mozilla::storage::StatementRow* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::storage::StatementRow>(proxy);
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::storage::StatementRow>(self);
  }
}
...
{
  mozilla::storage::StatementRow* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::storage::StatementRow>(obj);
  if (self) {
...
static const DOMJSClass sClass = {
  PROXY_CLASS_DEF("MozStorageStatementRow",
                  JSCLASS_IS_DOMJSCLASS | JSCLASS_HAS_RESERVED_SLOTS(1)),
  { prototypes::id::MozStorageStatementRow, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  std::is_base_of_v<nsISupports, mozilla::storage::StatementRow>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::storage::StatementRow>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::storage::StatementRow>::Get(),
  nullptr,
  nullptr
};

bool
Wrap(JSContext* aCx, mozilla::storage::StatementRow* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector)
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::storage::StatementRow>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::storage::StatementRow*>(aObject) ==
             reinterpret_cast<mozilla::storage::StatementRow*>(aObject),
             "Multiple inheritance for mozilla::storage::StatementRow is broken.");
  ...
  BindingJSObjectCreator<mozilla::storage::StatementRow> creator(aCx);
...
const NativePropertyHooks sNativePropertyHooks[] = { {
  ...
  prototypes::id::MozStorageStatementRow,
  constructors::id::MozStorageStatementRow,
  nullptr,
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::MozStorageStatementRow);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::MozStorageStatementRow);
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              ...
                              nullptr,
                              "MozStorageStatementRow", aDefineOnGlobal,
                              nullptr,
                              false,
                              nullptr,
                              false);
