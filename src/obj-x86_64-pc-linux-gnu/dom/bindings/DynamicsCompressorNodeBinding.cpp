...
bool
DynamicsCompressorOptions::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<float, eDefault>(cx, temp.ref(), "'attack' member of DynamicsCompressorOptions", &mAttack)) {
      return false;
    } else if (!mozilla::IsFinite(mAttack)) {
      cx.ThrowErrorMessage<MSG_NOT_FINITE>("'attack' member of DynamicsCompressorOptions");
      return false;
    }
  } else {
    mAttack = 0.003F;
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<float, eDefault>(cx, temp.ref(), "'knee' member of DynamicsCompressorOptions", &mKnee)) {
      return false;
    } else if (!mozilla::IsFinite(mKnee)) {
      cx.ThrowErrorMessage<MSG_NOT_FINITE>("'knee' member of DynamicsCompressorOptions");
      return false;
    }
  } else {
    mKnee = 30.0F;
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<float, eDefault>(cx, temp.ref(), "'ratio' member of DynamicsCompressorOptions", &mRatio)) {
      return false;
    } else if (!mozilla::IsFinite(mRatio)) {
      cx.ThrowErrorMessage<MSG_NOT_FINITE>("'ratio' member of DynamicsCompressorOptions");
      return false;
    }
  } else {
    mRatio = 12.0F;
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<float, eDefault>(cx, temp.ref(), "'release' member of DynamicsCompressorOptions", &mRelease)) {
      return false;
    } else if (!mozilla::IsFinite(mRelease)) {
      cx.ThrowErrorMessage<MSG_NOT_FINITE>("'release' member of DynamicsCompressorOptions");
      return false;
    }
  } else {
    mRelease = 0.25F;
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<float, eDefault>(cx, temp.ref(), "'threshold' member of DynamicsCompressorOptions", &mThreshold)) {
      return false;
    } else if (!mozilla::IsFinite(mThreshold)) {
      cx.ThrowErrorMessage<MSG_NOT_FINITE>("'threshold' member of DynamicsCompressorOptions");
      return false;
    }
  } else {
    mThreshold = -24.0F;
...
bool
DynamicsCompressorOptions::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
bool
DynamicsCompressorOptions::operator==(const DynamicsCompressorOptions& aOther) const
{
  if (mAttack != aOther.mAttack) {
      return false;
  }
  if (mKnee != aOther.mKnee) {
      return false;
  }
  if (mRatio != aOther.mRatio) {
      return false;
  }
  if (mRelease != aOther.mRelease) {
      return false;
  }
  if (mThreshold != aOther.mThreshold) {
      return false;
  }
  return true;
}
...
get_threshold(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "DynamicsCompressorNode", "threshold", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::DynamicsCompressorNode*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::AudioParam>(MOZ_KnownLive(self)->Threshold()));
...
MOZ_CAN_RUN_SCRIPT static bool
get_knee(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "DynamicsCompressorNode", "knee", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::DynamicsCompressorNode*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::AudioParam>(MOZ_KnownLive(self)->Knee()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!GetOrCreateDOMReflector(cx, result, args.rval())) {
    MOZ_ASSERT(JS_IsExceptionPending(cx));
    return false;
...
MOZ_CAN_RUN_SCRIPT static bool
get_ratio(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "DynamicsCompressorNode", "ratio", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::DynamicsCompressorNode*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::AudioParam>(MOZ_KnownLive(self)->Ratio()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!GetOrCreateDOMReflector(cx, result, args.rval())) {
    MOZ_ASSERT(JS_IsExceptionPending(cx));
    return false;
...
MOZ_CAN_RUN_SCRIPT static bool
get_reduction(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "DynamicsCompressorNode", "reduction", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::DynamicsCompressorNode*>(void_self);
  float result(MOZ_KnownLive(self)->Reduction());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
get_attack(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "DynamicsCompressorNode", "attack", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::DynamicsCompressorNode*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::AudioParam>(MOZ_KnownLive(self)->Attack()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!GetOrCreateDOMReflector(cx, result, args.rval())) {
    MOZ_ASSERT(JS_IsExceptionPending(cx));
    return false;
...
MOZ_CAN_RUN_SCRIPT static bool
get_release(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "DynamicsCompressorNode", "release", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::DynamicsCompressorNode*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::AudioParam>(MOZ_KnownLive(self)->GetRelease()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!GetOrCreateDOMReflector(cx, result, args.rval())) {
    MOZ_ASSERT(JS_IsExceptionPending(cx));
    return false;
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "DynamicsCompressorNode", "passThrough", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("threshold", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &threshold_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("knee", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &knee_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("ratio", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &ratio_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("reduction", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &reduction_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("attack", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &attack_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("release", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &release_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "DynamicsCompressorNode", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "DynamicsCompressorNode constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "DynamicsCompressorNode", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "DynamicsCompressorNode constructor", 1)) {
    return false;
  }
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "DynamicsCompressorNode constructor"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::DynamicsCompressorNode>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::DynamicsCompressorNode>,
