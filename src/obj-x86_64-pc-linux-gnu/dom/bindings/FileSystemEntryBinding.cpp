...
get_isFile(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "FileSystemEntry", "isFile", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::FileSystemEntry*>(void_self);
  bool result(MOZ_KnownLive(self)->IsFile());
...
MOZ_CAN_RUN_SCRIPT static bool
get_isDirectory(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "FileSystemEntry", "isDirectory", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::FileSystemEntry*>(void_self);
  bool result(MOZ_KnownLive(self)->IsDirectory());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  args.rval().setBoolean(result);
  return true;
}
...
get_name(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "FileSystemEntry.name getter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
get_fullPath(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "FileSystemEntry", "fullPath", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  DOMString result;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->GetFullPath(result, rv))>, "Should be returning void here");
  MOZ_KnownLive(self)->GetFullPath(result, rv);
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "FileSystemEntry.fullPath getter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!xpc::NonVoidStringToJsval(cx, result, args.rval())) {
...
MOZ_CAN_RUN_SCRIPT static bool
get_filesystem(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "FileSystemEntry", "filesystem", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::FileSystemEntry*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::FileSystem>(MOZ_KnownLive(self)->Filesystem()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
getParent(JSContext* cx_, JS::Handle<JSObject*> obj, void* void_self, const JSJitMethodCallArgs& args)
{
  BindingCallContext cx(cx_, "FileSystemEntry.getParent");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "FileSystemEntry", "getParent", DOM, cx,
  ...
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->GetParent(MOZ_KnownLive(NonNullHelper(Constify(arg0))), MOZ_KnownLive(NonNullHelper(Constify(arg1)))))>, "Should be returning void here");
  MOZ_KnownLive(self)->GetParent(MOZ_KnownLive(NonNullHelper(Constify(arg0))), MOZ_KnownLive(NonNullHelper(Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("isFile", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &isFile_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("isDirectory", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &isDirectory_getterinfo, nullptr, nullptr),
  ...
  JSPropertySpec::nativeAccessors("fullPath", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &fullPath_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("filesystem", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &filesystem_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "FileSystemEntry", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::FileSystemEntry>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::FileSystemEntry>,
