...
//@line 187 "$SRCDIR/dom/chrome-webidl/ChromeUtils.webidl"
...
enum WebIDLProcType {
 ...
 "socket",
 "remoteSandboxBroker",
//@line 544 "$SRCDIR/dom/chrome-webidl/ChromeUtils.webidl"
 "forkServer",
//@line 546 "$SRCDIR/dom/chrome-webidl/ChromeUtils.webidl"
 "preallocated",
 "unknown",
};
