...
get_azimuth(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFEDistantLightElement", "azimuth", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SVGFEDistantLightElement*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::DOMSVGAnimatedNumber>(MOZ_KnownLive(self)->Azimuth()));
...
MOZ_CAN_RUN_SCRIPT static bool
get_elevation(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFEDistantLightElement", "elevation", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SVGFEDistantLightElement*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::DOMSVGAnimatedNumber>(MOZ_KnownLive(self)->Elevation()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!GetOrCreateDOMReflector(cx, result, args.rval())) {
    MOZ_ASSERT(JS_IsExceptionPending(cx));
    return false;
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("azimuth", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &azimuth_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("elevation", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &elevation_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "SVGFEDistantLightElement", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::SVGFEDistantLightElement>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::SVGFEDistantLightElement>,
