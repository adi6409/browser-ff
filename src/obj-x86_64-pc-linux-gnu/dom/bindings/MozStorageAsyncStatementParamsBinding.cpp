/* THIS FILE IS AUTOGENERATED FROM MozStorageAsyncStatementParams.webidl BY Codegen.py - DO NOT EDIT */
...
#include "mozilla/storage/mozStorageAsyncStatementParams.h"
...
namespace MozStorageAsyncStatementParams_Binding {

MOZ_CAN_RUN_SCRIPT static bool
get_length(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "MozStorageAsyncStatementParams", "length", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::storage::AsyncStatementParams*>(void_self);
...
static const JSJitInfo length_getterinfo = {
  { get_length },
  { prototypes::id::MozStorageAsyncStatementParams },
  { PrototypeTraits<prototypes::id::MozStorageAsyncStatementParams>::Depth },
  JSJitInfo::Getter,
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "MozStorageAsyncStatementParams", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMIfaceAndProtoJSClass sInterfaceObjectClass = {
  ...
  "function MozStorageAsyncStatementParams() {\n    [native code]\n}",
  JS::GetRealmFunctionPrototype
};

static const DOMIfaceAndProtoJSClass sPrototypeClass = {
  {
    "MozStorageAsyncStatementParamsPrototype",
...
static_assert(std::is_base_of_v<nsISupports, mozilla::storage::AsyncStatementParams>,
...
MOZ_ALWAYS_INLINE mozilla::storage::AsyncStatementParams*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<mozilla::storage::AsyncStatementParams*>(js::GetProxyReservedSlot(obj, DOM_OBJECT_SLOT).toPrivate());
}
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (IsArrayIndex(index)) {
    mozilla::storage::AsyncStatementParams* self = UnwrapProxy(proxy);
    bool found = false;
    FastErrorResult rv;
    ...
    if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "MozStorageAsyncStatementParams indexed getter"))) {
      return false;
    }
    MOZ_ASSERT(!JS_IsExceptionPending(cx));
  ...
  if (callNamedGetter) {
    ...
    if (!isSymbol) {
      ...
      if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "MozStorageAsyncStatementParams named getter"))) {
        return false;
      }
      MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
DOMProxyHandler::defineProperty(JSContext* cx_, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, JS::Handle<JS::PropertyDescriptor> desc, JS::ObjectOpResult& opresult, bool* done) const
{
  ...
  if (IsArrayIndex(index)) {
    ...
    *done = true;
    ...
    if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "MozStorageAsyncStatementParams indexed setter"))) {
      return false;
    }
    MOZ_ASSERT(!JS_IsExceptionPending(cx));
  ...
  if (!isSymbol) {
    ...
    if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "MozStorageAsyncStatementParams named setter"))) {
      return false;
    }
    MOZ_ASSERT(!JS_IsExceptionPending(cx));
    *done = true;
...
{
  return "MozStorageAsyncStatementParams";
}
...
{
  mozilla::storage::AsyncStatementParams* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::storage::AsyncStatementParams>(proxy);
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::storage::AsyncStatementParams>(self);
  }
}
...
{
  mozilla::storage::AsyncStatementParams* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::storage::AsyncStatementParams>(obj);
  if (self) {
...
static const DOMJSClass sClass = {
  PROXY_CLASS_DEF("MozStorageAsyncStatementParams",
                  JSCLASS_IS_DOMJSCLASS | JSCLASS_HAS_RESERVED_SLOTS(1)),
  { prototypes::id::MozStorageAsyncStatementParams, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  std::is_base_of_v<nsISupports, mozilla::storage::AsyncStatementParams>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::storage::AsyncStatementParams>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::storage::AsyncStatementParams>::Get(),
  nullptr,
  nullptr
};

bool
Wrap(JSContext* aCx, mozilla::storage::AsyncStatementParams* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector)
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::storage::AsyncStatementParams>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::storage::AsyncStatementParams*>(aObject) ==
             reinterpret_cast<mozilla::storage::AsyncStatementParams*>(aObject),
             "Multiple inheritance for mozilla::storage::AsyncStatementParams is broken.");
  ...
  BindingJSObjectCreator<mozilla::storage::AsyncStatementParams> creator(aCx);
...
const NativePropertyHooks sNativePropertyHooks[] = { {
  ...
  prototypes::id::MozStorageAsyncStatementParams,
  constructors::id::MozStorageAsyncStatementParams,
  nullptr,
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::MozStorageAsyncStatementParams);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::MozStorageAsyncStatementParams);
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              ...
                              nullptr,
                              "MozStorageAsyncStatementParams", aDefineOnGlobal,
                              nullptr,
                              false,
                              nullptr,
                              false);
