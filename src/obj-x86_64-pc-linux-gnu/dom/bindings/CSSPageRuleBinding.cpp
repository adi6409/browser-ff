...
get_style(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "CSSPageRule", "style", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::CSSPageRule*>(void_self);
...
{
  BindingCallContext cx(cx_, "CSSPageRule.style setter");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "CSSPageRule", "style", DOM, cx,
  ...
  if (!v.isObject()) {
    return cx.ThrowErrorMessage<MSG_NOT_OBJECT>("CSSPageRule.style");
  }
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "CSSPageRule", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::CSSPageRule>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::CSSPageRule>,
