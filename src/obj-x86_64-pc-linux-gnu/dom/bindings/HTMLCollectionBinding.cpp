...
get_length(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLCollection", "length", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<nsIHTMLCollection*>(void_self);
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLCollection", "item", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<nsIHTMLCollection*>(void_self);
  if (!args.requireAtLeast(cx, "HTMLCollection.item", 1)) {
    return false;
  }
  uint32_t arg0;
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLCollection", "namedItem", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<nsIHTMLCollection*>(void_self);
  if (!args.requireAtLeast(cx, "HTMLCollection.namedItem", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::Element>(MOZ_KnownLive(self)->NamedItem(NonNullHelper(Constify(arg0)))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!result) {
    args.rval().setNull();
    return true;
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "HTMLCollection", JSPROP_READONLY),
  JS_PS_END
};
...
static_assert(std::is_base_of_v<nsISupports, nsIHTMLCollection>,
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, nsIHTMLCollection>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, nsIHTMLCollection>,
