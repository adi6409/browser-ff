...
bool
EventSourceInit::InitIds(JSContext* cx, EventSourceInitAtoms* atomsCache)
{
  MOZ_ASSERT(JSID_IS_VOID(*reinterpret_cast<jsid*>(atomsCache)));

  // Initialize these in reverse order so that any failure leaves the first one
  // uninitialized.
  if (!atomsCache->withCredentials_id.init(cx, "withCredentials")) {
    return false;
  }
  return true;
}
...
bool
EventSourceInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  EventSourceInitAtoms* atomsCache = nullptr;
  if (cx) {
    atomsCache = GetAtomCache<EventSourceInitAtoms>(cx);
  ...
  if (!isNull) {
    if (!JS_GetPropertyById(cx, *object, atomsCache->withCredentials_id, temp.ptr())) {
      return false;
    }
  }
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<bool, eDefault>(cx, temp.ref(), "'withCredentials' member of EventSourceInit", &mWithCredentials)) {
      return false;
    }
  } else {
...
bool
EventSourceInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
void
EventSourceInit::TraceDictionary(JSTracer* trc)
{
}

EventSourceInit&
EventSourceInit::operator=(const EventSourceInit& aOther)
{
  DictionaryBase::operator=(aOther);
  mWithCredentials = aOther.mWithCredentials;
  return *this;
}

bool
EventSourceInit::operator==(const EventSourceInit& aOther) const
{
  if (mWithCredentials != aOther.mWithCredentials) {
      return false;
  }
  return true;
}
...
get_url(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "EventSource", "url", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::EventSource*>(void_self);
  DOMString result;
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "EventSource", "withCredentials", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  mozilla::dom::EventSource* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::EventSource>(obj);
...
_finalize(JSFreeOp* fop, JSObject* obj)
{
  ...
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::dom::EventSource>(self);
  }
}
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JSPropertySpec::nativeAccessors("withCredentials", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &withCredentials_getterinfo, nullptr, nullptr),
  ...
  JS_STRING_SYM_PS(toStringTag, "EventSource", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "EventSource constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "EventSource", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
  JS::Rooted<JSObject*> obj(cx, &args.callee());
  if (!args.isConstructing()) {
    return ThrowConstructorWithoutNew(cx, "EventSource");
  }
  ...
  if (!args.requireAtLeast(cx, "EventSource constructor", 1)) {
    return false;
  }
  ...
  binding_detail::FastEventSourceInit arg1;
  ...
  FastErrorResult rv;
  auto result(StrongOrRawPtr<mozilla::dom::EventSource>(mozilla::dom::EventSource::Constructor(global, Constify(arg0), Constify(arg1), rv)));
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "EventSource constructor"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  { prototypes::id::EventTarget, prototypes::id::EventSource, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  std::is_base_of_v<nsISupports, mozilla::dom::EventSource>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::dom::EventSource>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::dom::EventSource>::Get(),
  nullptr,
  _getWrapperCache
};
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::EventSource>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::dom::EventSource*>(aObject) ==
             reinterpret_cast<mozilla::dom::EventSource*>(aObject),
             "Multiple inheritance for mozilla::dom::EventSource is broken.");
  ...
  BindingJSObjectCreator<mozilla::dom::EventSource> creator(aCx);
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::EventSource);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::EventSource);
