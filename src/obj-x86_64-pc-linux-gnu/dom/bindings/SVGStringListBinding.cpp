...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "SVGStringList", JSPROP_READONLY),
  JS_PS_END
};
...
Wrap(JSContext* aCx, mozilla::dom::DOMSVGStringList* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector)
{
  ...
  MOZ_ASSERT(static_cast<mozilla::dom::DOMSVGStringList*>(aObject) ==
             reinterpret_cast<mozilla::dom::DOMSVGStringList*>(aObject),
             "Multiple inheritance for mozilla::dom::DOMSVGStringList is broken.");
