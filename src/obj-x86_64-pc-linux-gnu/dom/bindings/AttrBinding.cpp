...
get_localName(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "Attr", "localName", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::Attr*>(void_self);
  DOMString result;
...
static const JSJitInfo localName_getterinfo = {
  { get_localName },
  { prototypes::id::Attr },
  { PrototypeTraits<prototypes::id::Attr>::Depth },
  JSJitInfo::Getter,
...
set_value(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitSetterCallArgs args)
{
  ...
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->SetValue(NonNullHelper(Constify(arg0)), MOZ_KnownLive(subjectPrincipal), rv))>, "Should be returning void here");
  MOZ_KnownLive(self)->SetValue(NonNullHelper(Constify(arg0)), MOZ_KnownLive(subjectPrincipal), rv);
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "Attr.value setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
get_specified(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "Attr", "specified", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::Attr*>(void_self);
  bool result(MOZ_KnownLive(self)->Specified());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  args.rval().setBoolean(result);
  return true;
}

static const JSJitInfo specified_getterinfo = {
  { get_specified },
  { prototypes::id::Attr },
  { PrototypeTraits<prototypes::id::Attr>::Depth },
  JSJitInfo::Getter,
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "Attr", "ownerElement", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::Attr*>(void_self);
  FastErrorResult rv;
  auto result(StrongOrRawPtr<mozilla::dom::Element>(MOZ_KnownLive(self)->GetOwnerElement(rv)));
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "Attr.ownerElement getter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!result) {
...
{
  mozilla::dom::Attr* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::Attr>(obj);
...
_finalize(JSFreeOp* fop, JSObject* obj)
{
  ...
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::dom::Attr>(self);
  }
}
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JSPropertySpec::nativeAccessors("specified", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &specified_getterinfo, nullptr, nullptr),
  ...
  JS_STRING_SYM_PS(toStringTag, "Attr", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMJSClass sClass = {
  ...
  { prototypes::id::EventTarget, prototypes::id::Node, prototypes::id::Attr, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  std::is_base_of_v<nsISupports, mozilla::dom::Attr>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::dom::Attr>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::dom::Attr>::Get(),
  nullptr,
  _getWrapperCache
};
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::Attr>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::dom::Attr*>(aObject) ==
             reinterpret_cast<mozilla::dom::Attr*>(aObject),
             "Multiple inheritance for mozilla::dom::Attr is broken.");
  ...
  BindingJSObjectCreator<mozilla::dom::Attr> creator(aCx);
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::Attr);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::Attr);
