...
get_value(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGNumber", "value", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::DOMSVGNumber*>(void_self);
...
{
  BindingCallContext cx(cx_, "SVGNumber.value setter");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGNumber", "value", DOM, cx,
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "SVGNumber.value setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  mozilla::dom::DOMSVGNumber* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::DOMSVGNumber>(obj);
...
_finalize(JSFreeOp* fop, JSObject* obj)
{
  ...
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::dom::DOMSVGNumber>(self);
  }
}
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "SVGNumber", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::DOMSVGNumber>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::dom::DOMSVGNumber>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::dom::DOMSVGNumber>::Get(),
  nullptr,
  _getWrapperCache
};
...
bool
Wrap(JSContext* aCx, mozilla::dom::DOMSVGNumber* aObject, nsWrapperCache* aCache, JS::Handle<JSObject*> aGivenProto, JS::MutableHandle<JSObject*> aReflector)
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::DOMSVGNumber>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::dom::DOMSVGNumber*>(aObject) ==
             reinterpret_cast<mozilla::dom::DOMSVGNumber*>(aObject),
             "Multiple inheritance for mozilla::dom::DOMSVGNumber is broken.");
  ...
  BindingJSObjectCreator<mozilla::dom::DOMSVGNumber> creator(aCx);
