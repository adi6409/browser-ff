...
static const JSJitInfo length_getterinfo = {
  { get_length },
  { prototypes::id::TouchList },
  { PrototypeTraits<prototypes::id::TouchList>::Depth },
  JSJitInfo::Getter,
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "TouchList", "item", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::TouchList*>(void_self);
  if (!args.requireAtLeast(cx, "TouchList.item", 1)) {
    return false;
  }
  uint32_t arg0;
  ...
  auto result(StrongOrRawPtr<mozilla::dom::Touch>(MOZ_KnownLive(self)->Item(arg0)));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!result) {
    args.rval().setNull();
    return true;
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "TouchList", JSPROP_READONLY),
  JS_PS_END
};
...
{
  return mozilla::dom::TouchList::PrefEnabled(aCx, aObj);
}

static_assert(std::is_base_of_v<nsISupports, mozilla::dom::TouchList>,
...
MOZ_ALWAYS_INLINE mozilla::dom::TouchList*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<mozilla::dom::TouchList*>(js::GetProxyReservedSlot(obj, DOM_OBJECT_SLOT).toPrivate());
}
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (IsArrayIndex(index)) {
    mozilla::dom::TouchList* self = UnwrapProxy(proxy);
    bool found = false;
    auto result(StrongOrRawPtr<mozilla::dom::Touch>(MOZ_KnownLive(self)->IndexedGetter(index, found)));
    MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  mozilla::dom::TouchList* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::TouchList>(proxy);
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::dom::TouchList>(self);
  }
}
...
{
  mozilla::dom::TouchList* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::TouchList>(obj);
  if (self) {
...
static const DOMJSClass sClass = {
  PROXY_CLASS_DEF("TouchList",
                  JSCLASS_IS_DOMJSCLASS | JSCLASS_HAS_RESERVED_SLOTS(1)),
  { prototypes::id::TouchList, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  std::is_base_of_v<nsISupports, mozilla::dom::TouchList>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::dom::TouchList>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::dom::TouchList>::Get(),
  nullptr,
  nullptr
};
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::TouchList>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::dom::TouchList*>(aObject) ==
             reinterpret_cast<mozilla::dom::TouchList*>(aObject),
             "Multiple inheritance for mozilla::dom::TouchList is broken.");
  ...
  BindingJSObjectCreator<mozilla::dom::TouchList> creator(aCx);
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::TouchList);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::TouchList);
