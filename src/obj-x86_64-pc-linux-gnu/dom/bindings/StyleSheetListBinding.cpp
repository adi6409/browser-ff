...
static const JSJitInfo length_getterinfo = {
  { get_length },
  { prototypes::id::StyleSheetList },
  { PrototypeTraits<prototypes::id::StyleSheetList>::Depth },
  JSJitInfo::Getter,
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "StyleSheetList", "item", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::StyleSheetList*>(void_self);
  if (!args.requireAtLeast(cx, "StyleSheetList.item", 1)) {
    return false;
  }
  uint32_t arg0;
  ...
  auto result(StrongOrRawPtr<mozilla::StyleSheet>(MOZ_KnownLive(self)->Item(arg0)));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!result) {
    args.rval().setNull();
    return true;
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "StyleSheetList", JSPROP_READONLY),
  JS_PS_END
};
...
static_assert(std::is_base_of_v<nsISupports, mozilla::dom::StyleSheetList>,
...
MOZ_ALWAYS_INLINE mozilla::dom::StyleSheetList*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<mozilla::dom::StyleSheetList*>(js::GetProxyReservedSlot(obj, DOM_OBJECT_SLOT).toPrivate());
}
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (IsArrayIndex(index)) {
    mozilla::dom::StyleSheetList* self = UnwrapProxy(proxy);
    bool found = false;
    auto result(StrongOrRawPtr<mozilla::StyleSheet>(MOZ_KnownLive(self)->IndexedGetter(index, found)));
    MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  mozilla::dom::StyleSheetList* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::StyleSheetList>(proxy);
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::dom::StyleSheetList>(self);
  }
}
...
{
  mozilla::dom::StyleSheetList* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::StyleSheetList>(obj);
  if (self) {
...
static const DOMJSClass sClass = {
  PROXY_CLASS_DEF("StyleSheetList",
                  JSCLASS_IS_DOMJSCLASS | JSCLASS_HAS_RESERVED_SLOTS(1)),
  { prototypes::id::StyleSheetList, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  std::is_base_of_v<nsISupports, mozilla::dom::StyleSheetList>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::dom::StyleSheetList>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::dom::StyleSheetList>::Get(),
  nullptr,
  nullptr
};
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::StyleSheetList>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::dom::StyleSheetList*>(aObject) ==
             reinterpret_cast<mozilla::dom::StyleSheetList*>(aObject),
             "Multiple inheritance for mozilla::dom::StyleSheetList is broken.");
  ...
  BindingJSObjectCreator<mozilla::dom::StyleSheetList> creator(aCx);
...
const NativePropertyHooks sNativePropertyHooks[] = { {
  ...
  prototypes::id::StyleSheetList,
  constructors::id::StyleSheetList,
  nullptr,
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::StyleSheetList);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::StyleSheetList);
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              ...
                              nullptr,
                              "StyleSheetList", aDefineOnGlobal,
                              nullptr,
                              false,
                              nullptr,
                              false);
