...
bool
ConvolverOptions::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  if (!isNull && !temp->isUndefined()) {
    ...
    if (temp.ref().isObject()) {
      static_assert(IsRefcounted<mozilla::dom::AudioBuffer>::value, "We can only store refcounted classes.");
      {
        ...
        if (NS_FAILED(rv)) {
          cx.ThrowErrorMessage<MSG_DOES_NOT_IMPLEMENT_INTERFACE>("'buffer' member of ConvolverOptions", "AudioBuffer");
          return false;
        }
      }
      ...
      cx.ThrowErrorMessage<MSG_NOT_OBJECT>("'buffer' member of ConvolverOptions");
      return false;
    }
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<bool, eDefault>(cx, temp.ref(), "'disableNormalization' member of ConvolverOptions", &mDisableNormalization)) {
      return false;
    }
  } else {
...
bool
ConvolverOptions::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
get_buffer(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ConvolverNode", "buffer", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::ConvolverNode*>(void_self);
...
{
  BindingCallContext cx(cx_, "ConvolverNode.buffer setter");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ConvolverNode", "buffer", DOM, cx,
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "ConvolverNode.buffer setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
get_normalize(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ConvolverNode", "normalize", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::ConvolverNode*>(void_self);
  bool result(MOZ_KnownLive(self)->Normalize());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
set_normalize(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitSetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ConvolverNode", "normalize", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_SETTER) |
  ...
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->SetNormalize(arg0))>, "Should be returning void here");
  MOZ_KnownLive(self)->SetNormalize(arg0);
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ConvolverNode", "passThrough", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JSPropertySpec::nativeAccessors("normalize", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &normalize_getterinfo, GenericSetter<NormalThisPolicy>, &normalize_setterinfo),
  JS_STRING_SYM_PS(toStringTag, "ConvolverNode", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "ConvolverNode constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ConvolverNode", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "ConvolverNode constructor", 1)) {
    return false;
  }
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "ConvolverNode constructor"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::ConvolverNode>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::ConvolverNode>,
