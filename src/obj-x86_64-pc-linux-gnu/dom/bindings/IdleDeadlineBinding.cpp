...
timeRemaining(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, const JSJitMethodCallArgs& args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "IdleDeadline", "timeRemaining", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::IdleDeadline*>(void_self);
  double result(MOZ_KnownLive(self)->TimeRemaining());
...
MOZ_CAN_RUN_SCRIPT static bool
get_didTimeout(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "IdleDeadline", "didTimeout", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::IdleDeadline*>(void_self);
  bool result(MOZ_KnownLive(self)->DidTimeout());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("didTimeout", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &didTimeout_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "IdleDeadline", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::IdleDeadline>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::IdleDeadline>,
