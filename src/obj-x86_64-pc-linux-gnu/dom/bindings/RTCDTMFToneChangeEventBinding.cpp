...
bool
RTCDTMFToneChangeEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
bool
RTCDTMFToneChangeEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
bool
RTCDTMFToneChangeEventInit::operator==(const RTCDTMFToneChangeEventInit& aOther) const
{
  if (mTone != aOther.mTone) {
      return false;
  }
  return true;
}
...
get_tone(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "RTCDTMFToneChangeEvent", "tone", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::RTCDTMFToneChangeEvent*>(void_self);
  DOMString result;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->GetTone(result))>, "Should be returning void here");
  MOZ_KnownLive(self)->GetTone(result);
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "RTCDTMFToneChangeEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("tone", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &tone_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "RTCDTMFToneChangeEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "RTCDTMFToneChangeEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "RTCDTMFToneChangeEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "RTCDTMFToneChangeEvent constructor", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::RTCDTMFToneChangeEvent>(mozilla::dom::RTCDTMFToneChangeEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::RTCDTMFToneChangeEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::RTCDTMFToneChangeEvent>,
