...
get_connections(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PresentationConnectionList", "connections", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::PresentationConnectionList*>(void_self);
  ...
  nsTArray<StrongPtrForMember<mozilla::dom::PresentationConnection>> result;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->GetConnections(result))>, "Should be returning void here");
  MOZ_KnownLive(self)->GetConnections(result);
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PresentationConnectionList", "onconnectionavailable", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("connections", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &connections_getterinfo, nullptr, nullptr),
  ...
  JS_STRING_SYM_PS(toStringTag, "PresentationConnectionList", JSPROP_READONLY),
  JS_PS_END
};
...
{
  return StaticPrefs::dom_presentation_receiver_enabled();
}
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::PresentationConnectionList>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::PresentationConnectionList>,
