...
void
ImplCycleCollectionTraverse(nsCycleCollectionTraversalCallback& aCallback, OwningHTMLCollectionOrElement& aUnion, const char* aName, uint32_t aFlags)
{
  if (aUnion.IsHTMLCollection()) {
...
bool
HTMLCollectionOrElement::ToJSVal(JSContext* cx, JS::Handle<JSObject*> scopeObj, JS::MutableHandle<JS::Value> rval) const
{
  switch (mType) {
    case eUninitialized: {
      return false;
...
OwningHTMLCollectionOrElement::RawSetAsHTMLCollection()
{
...
OwningNonNull<nsIHTMLCollection>&
OwningHTMLCollectionOrElement::SetAsHTMLCollection()
{
  if (mType == eHTMLCollection) {
    return mValue.mHTMLCollection.Value();
  }
...
bool
OwningHTMLCollectionOrElement::TrySetToHTMLCollection(BindingCallContext& cx, JS::Handle<JS::Value> value, bool& tryNext, bool passedToJSImpl)
{
  tryNext = false;
...
bool
OwningHTMLCollectionOrElement::TrySetToHTMLCollection(JSContext* cx_, JS::Handle<JS::Value> value, bool& tryNext, bool passedToJSImpl)
{
...
void
OwningHTMLCollectionOrElement::DestroyHTMLCollection()
{
...
OwningHTMLCollectionOrElement::RawSetAsElement()
{
  if (mType == eElement) {
...
OwningNonNull<mozilla::dom::Element>&
OwningHTMLCollectionOrElement::SetAsElement()
{
  if (mType == eElement) {
    return mValue.mElement.Value();
  }
...
bool
OwningHTMLCollectionOrElement::TrySetToElement(BindingCallContext& cx, JS::Handle<JS::Value> value, bool& tryNext, bool passedToJSImpl)
{
  tryNext = false;
  { // scope for memberSlot
...
bool
OwningHTMLCollectionOrElement::TrySetToElement(JSContext* cx_, JS::Handle<JS::Value> value, bool& tryNext, bool passedToJSImpl)
{
  BindingCallContext cx(cx_, nullptr);
...
void
OwningHTMLCollectionOrElement::DestroyElement()
{
...
void
OwningHTMLCollectionOrElement::Uninit()
{
  switch (mType) {
    case eUninitialized: {
      break;
...
bool
OwningHTMLCollectionOrElement::ToJSVal(JSContext* cx, JS::Handle<JSObject*> scopeObj, JS::MutableHandle<JS::Value> rval) const
{
  switch (mType) {
    case eUninitialized: {
      return false;
...
void
OwningHTMLCollectionOrElement::TraceUnion(JSTracer* trc)
{
}

OwningHTMLCollectionOrElement&
OwningHTMLCollectionOrElement::operator=(const OwningHTMLCollectionOrElement& aOther)
{
  switch (aOther.mType) {
    case eUninitialized: {
      MOZ_ASSERT(mType == eUninitialized,
...
get_length(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLAllCollection", "length", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::HTMLAllCollection*>(void_self);
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLAllCollection", "namedItem", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::HTMLAllCollection*>(void_self);
  if (!args.requireAtLeast(cx, "HTMLAllCollection.namedItem", 1)) {
    return false;
  }
  ...
  Nullable<OwningHTMLCollectionOrElement> result;
...
item(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, const JSJitMethodCallArgs& args)
{
  ...
  Nullable<OwningHTMLCollectionOrElement> result;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->Item(NonNullHelper(Constify(arg0)), result))>, "Should be returning void here");
  MOZ_KnownLive(self)->Item(NonNullHelper(Constify(arg0)), result);
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (result.IsNull()) {
    args.rval().setNull();
    return true;
...
static const JSFunctionSpec sMethods_specs[] = {
  ...
  JS_FNSPEC("item", (GenericMethod<NormalThisPolicy, ThrowExceptions>), reinterpret_cast<const JSJitInfo*>(&item_methodinfo), 0, JSPROP_ENUMERATE, nullptr),
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "HTMLAllCollection", JSPROP_READONLY),
  JS_PS_END
};
...
_legacycaller(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  {
    // Our JSContext should be in the right global to do unwrapping in.
    nsresult rv = UnwrapObject<prototypes::id::HTMLAllCollection, mozilla::dom::HTMLAllCollection>(&rootSelf, self, cx);
    if (NS_FAILED(rv)) {
  ...
  Nullable<OwningHTMLCollectionOrElement> result;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->LegacyCall(args.thisv(), NonNullHelper(Constify(arg0)), result))>, "Should be returning void here");
  MOZ_KnownLive(self)->LegacyCall(args.thisv(), NonNullHelper(Constify(arg0)), result);
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (result.IsNull()) {
    args.rval().setNull();
    return true;
...
static_assert(std::is_base_of_v<nsISupports, mozilla::dom::HTMLAllCollection>,
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::HTMLAllCollection>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::HTMLAllCollection>,
