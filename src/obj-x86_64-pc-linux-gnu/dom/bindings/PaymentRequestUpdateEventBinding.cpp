...
bool
PaymentRequestUpdateEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
bool
PaymentRequestUpdateEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
bool
PaymentRequestUpdateEventInit::operator==(const PaymentRequestUpdateEventInit& aOther) const
{
  return true;
}
...
updateWith(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, const JSJitMethodCallArgs& args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PaymentRequestUpdateEvent", "updateWith", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::PaymentRequestUpdateEvent*>(void_self);
  if (!args.requireAtLeast(cx, "PaymentRequestUpdateEvent.updateWith", 1)) {
    return false;
  }
  ...
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->UpdateWith(NonNullHelper(arg0), rv))>, "Should be returning void here");
  MOZ_KnownLive(self)->UpdateWith(NonNullHelper(arg0), rv);
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "PaymentRequestUpdateEvent.updateWith"))) {
    return false;
  }
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PaymentRequestUpdateEvent", "isTrusted", DOM, cx,
...
static const JSPropertySpec sAttributes_specs[] = {
  JS_STRING_SYM_PS(toStringTag, "PaymentRequestUpdateEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "PaymentRequestUpdateEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PaymentRequestUpdateEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "PaymentRequestUpdateEvent constructor", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::PaymentRequestUpdateEvent>(mozilla::dom::PaymentRequestUpdateEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::PaymentRequestUpdateEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::PaymentRequestUpdateEvent>,
