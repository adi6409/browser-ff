...
get_connectionList(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PresentationReceiver", "connectionList", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::PresentationReceiver*>(void_self);
  FastErrorResult rv;
  auto result(StrongOrRawPtr<Promise>(MOZ_KnownLive(self)->GetConnectionList(rv)));
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "PresentationReceiver.connectionList getter"))) {
    return false;
  }
...
MOZ_CAN_RUN_SCRIPT static bool
get_connectionList_promiseWrapper(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  bool ok = get_connectionList(cx, obj, void_self, args);
  if (ok) {
    return true;
  }
...
static const JSJitInfo connectionList_getterinfo = {
  { get_connectionList_promiseWrapper },
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("connectionList", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ConvertExceptionsToPromises>, &connectionList_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "PresentationReceiver", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::PresentationReceiver>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::PresentationReceiver>,
