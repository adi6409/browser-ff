...
bool
AnimationPlaybackEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  } else if (!ValueToPrimitive<double, eDefault>(cx, temp.ref(), "'currentTime' member of AnimationPlaybackEventInit", &mCurrentTime.SetValue())) {
    return false;
  } else if (!mozilla::IsFinite(mCurrentTime.Value())) {
    cx.ThrowErrorMessage<MSG_NOT_FINITE>("'currentTime' member of AnimationPlaybackEventInit");
    return false;
  }
  ...
  } else if (!ValueToPrimitive<double, eDefault>(cx, temp.ref(), "'timelineTime' member of AnimationPlaybackEventInit", &mTimelineTime.SetValue())) {
    return false;
  } else if (!mozilla::IsFinite(mTimelineTime.Value())) {
    cx.ThrowErrorMessage<MSG_NOT_FINITE>("'timelineTime' member of AnimationPlaybackEventInit");
    return false;
  }
  mIsAnyMemberPresent = true;
  return true;
...
bool
AnimationPlaybackEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
bool
AnimationPlaybackEventInit::operator==(const AnimationPlaybackEventInit& aOther) const
{
  if (mCurrentTime != aOther.mCurrentTime) {
      return false;
  }
  if (mTimelineTime != aOther.mTimelineTime) {
      return false;
  }
  return true;
}
...
get_currentTime(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "AnimationPlaybackEvent", "currentTime", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::AnimationPlaybackEvent*>(void_self);
  Nullable<double> result(MOZ_KnownLive(self)->GetCurrentTime());
...
MOZ_CAN_RUN_SCRIPT static bool
get_timelineTime(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "AnimationPlaybackEvent", "timelineTime", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::AnimationPlaybackEvent*>(void_self);
  Nullable<double> result(MOZ_KnownLive(self)->GetTimelineTime());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (result.IsNull()) {
    args.rval().setNull();
    return true;
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "AnimationPlaybackEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JSPropertySpec::nativeAccessors("timelineTime", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &timelineTime_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "AnimationPlaybackEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "AnimationPlaybackEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "AnimationPlaybackEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "AnimationPlaybackEvent constructor", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::AnimationPlaybackEvent>(mozilla::dom::AnimationPlaybackEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::AnimationPlaybackEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::AnimationPlaybackEvent>,
