...
get_name(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "Directory", "name", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::Directory*>(void_self);
  FastErrorResult rv;
  DOMString result;
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "Directory.name getter"))) {
    return false;
  }
...
MOZ_CAN_RUN_SCRIPT static bool
get_path(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "Directory", "path", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  DOMString result;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->GetPath(result, rv))>, "Should be returning void here");
  MOZ_KnownLive(self)->GetPath(result, rv);
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "Directory.path getter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!xpc::NonVoidStringToJsval(cx, result, args.rval())) {
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "Directory", "getFilesAndDirectories", DOM, cx,
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "Directory.getFilesAndDirectories"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
getFiles(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, const JSJitMethodCallArgs& args)
{
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "Directory.getFiles"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!ToJSValue(cx, result, args.rval())) {
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JSPropertySpec::nativeAccessors("path", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &path_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "Directory", JSPROP_READONLY),
  JS_PS_END
};
...
_constructor(JSContext* cx, unsigned argc, JS::Value* vp)
{
  ...
  if (!args.requireAtLeast(cx, "Directory constructor", 1)) {
    return false;
  }
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "Directory constructor"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::Directory>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::Directory>,
