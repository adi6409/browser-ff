...
bool
SpeechRecognitionEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  if (!isNull && !temp->isUndefined()) {
    if (temp.ref().isObject()) {
      static_assert(IsRefcounted<mozilla::dom::Document>::value, "We can only store refcounted classes.");
      {
        ...
        nsresult rv = UnwrapObject<prototypes::id::Document, mozilla::dom::Document>(temp.ptr(), mEmma, cx);
        if (NS_FAILED(rv)) {
          cx.ThrowErrorMessage<MSG_DOES_NOT_IMPLEMENT_INTERFACE>("'emma' member of SpeechRecognitionEventInit", "Document");
          return false;
        }
      }
      ...
      cx.ThrowErrorMessage<MSG_NOT_OBJECT>("'emma' member of SpeechRecognitionEventInit");
      return false;
    }
  } else {
    mEmma = nullptr;
...
#pragma clang diagnostic ignored "-Wunreachable-code-return"
    ...
    if ((passedToJSImpl) && !CallerSubsumes(temp.ref())) {
      cx.ThrowErrorMessage<MSG_PERMISSION_DENIED_TO_PASS_ARG>("'interpretation' member of SpeechRecognitionEventInit");
      return false;
    }
#ifdef __clang__
#pragma clang diagnostic pop
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<uint32_t, eDefault>(cx, temp.ref(), "'resultIndex' member of SpeechRecognitionEventInit", &mResultIndex)) {
      return false;
    }
  } else {
    mResultIndex = 0U;
  ...
  if (!isNull && !temp->isUndefined()) {
    if (temp.ref().isObject()) {
      ...
      {
        // Our JSContext should be in the right global to do unwrapping in.
        nsresult rv = UnwrapObject<prototypes::id::SpeechRecognitionResultList, mozilla::dom::SpeechRecognitionResultList>(temp.ptr(), mResults, cx);
        if (NS_FAILED(rv)) {
          cx.ThrowErrorMessage<MSG_DOES_NOT_IMPLEMENT_INTERFACE>("'results' member of SpeechRecognitionEventInit", "SpeechRecognitionResultList");
          return false;
        }
      }
    } else if (temp.ref().isNullOrUndefined()) {
      ...
      cx.ThrowErrorMessage<MSG_NOT_OBJECT>("'results' member of SpeechRecognitionEventInit");
      return false;
    }
  } else {
    mResults = nullptr;
...
bool
SpeechRecognitionEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
get_resultIndex(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechRecognitionEvent", "resultIndex", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SpeechRecognitionEvent*>(void_self);
  uint32_t result(MOZ_KnownLive(self)->ResultIndex());
...
MOZ_CAN_RUN_SCRIPT static bool
get_results(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechRecognitionEvent", "results", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SpeechRecognitionEvent*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::SpeechRecognitionResultList>(MOZ_KnownLive(self)->GetResults()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!result) {
    args.rval().setNull();
    return true;
...
MOZ_CAN_RUN_SCRIPT static bool
get_interpretation(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechRecognitionEvent", "interpretation", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->GetInterpretation(cx, &result))>, "Should be returning void here");
  MOZ_KnownLive(self)->GetInterpretation(cx, &result);
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
get_emma(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechRecognitionEvent", "emma", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SpeechRecognitionEvent*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::Document>(MOZ_KnownLive(self)->GetEmma()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!result) {
    args.rval().setNull();
    return true;
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechRecognitionEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("resultIndex", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &resultIndex_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("results", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &results_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("interpretation", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &interpretation_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("emma", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &emma_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "SpeechRecognitionEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "SpeechRecognitionEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechRecognitionEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "SpeechRecognitionEvent constructor", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::SpeechRecognitionEvent>(mozilla::dom::SpeechRecognitionEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::SpeechRecognitionEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::SpeechRecognitionEvent>,
