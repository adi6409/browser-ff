...
get_clientRects(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "NotifyPaintEvent", "clientRects", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::NotifyPaintEvent*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::DOMRectList>(MOZ_KnownLive(self)->ClientRects(SystemCallerGuarantee())));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "NotifyPaintEvent", "boundingClientRect", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::NotifyPaintEvent*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::DOMRect>(MOZ_KnownLive(self)->BoundingClientRect(SystemCallerGuarantee())));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!GetOrCreateDOMReflector(cx, result, args.rval())) {
    MOZ_ASSERT(JS_IsExceptionPending(cx));
    return false;
...
MOZ_CAN_RUN_SCRIPT static bool
get_paintRequests(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "NotifyPaintEvent", "paintRequests", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::NotifyPaintEvent*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::PaintRequestList>(MOZ_KnownLive(self)->PaintRequests(SystemCallerGuarantee())));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!GetOrCreateDOMReflector(cx, result, args.rval())) {
    MOZ_ASSERT(JS_IsExceptionPending(cx));
    return false;
...
MOZ_CAN_RUN_SCRIPT static bool
get_transactionId(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "NotifyPaintEvent", "transactionId", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::NotifyPaintEvent*>(void_self);
  uint64_t result(MOZ_KnownLive(self)->TransactionId(SystemCallerGuarantee()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
get_paintTimeStamp(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "NotifyPaintEvent", "paintTimeStamp", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::NotifyPaintEvent*>(void_self);
  double result(MOZ_KnownLive(self)->PaintTimeStamp(SystemCallerGuarantee()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  args.rval().set(JS_NumberValue(double(result)));
  return true;
}
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "NotifyPaintEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  JS_STRING_SYM_PS(toStringTag, "NotifyPaintEvent", JSPROP_READONLY),
  JS_PS_END
};
...
static const JSPropertySpec sChromeAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("clientRects", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &clientRects_getterinfo, nullptr, nullptr),
  ...
  JSPropertySpec::nativeAccessors("paintRequests", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &paintRequests_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("transactionId", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &transactionId_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("paintTimeStamp", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &paintTimeStamp_getterinfo, nullptr, nullptr),
  JS_PS_END
};
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::NotifyPaintEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::NotifyPaintEvent>,
