...
namespace SpeechRecognitionResultList_Binding {

MOZ_CAN_RUN_SCRIPT static bool
get_length(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechRecognitionResultList", "length", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SpeechRecognitionResultList*>(void_self);
...
static const JSJitInfo length_getterinfo = {
  { get_length },
  { prototypes::id::SpeechRecognitionResultList },
  { PrototypeTraits<prototypes::id::SpeechRecognitionResultList>::Depth },
  JSJitInfo::Getter,
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SpeechRecognitionResultList", "item", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SpeechRecognitionResultList*>(void_self);
  if (!args.requireAtLeast(cx, "SpeechRecognitionResultList.item", 1)) {
    return false;
  }
  uint32_t arg0;
  ...
  auto result(StrongOrRawPtr<mozilla::dom::SpeechRecognitionResult>(MOZ_KnownLive(self)->Item(arg0)));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "SpeechRecognitionResultList", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMIfaceAndProtoJSClass sPrototypeClass = {
  {
    "SpeechRecognitionResultListPrototype",
...
static_assert(std::is_base_of_v<nsISupports, mozilla::dom::SpeechRecognitionResultList>,
...
MOZ_ALWAYS_INLINE mozilla::dom::SpeechRecognitionResultList*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<mozilla::dom::SpeechRecognitionResultList*>(js::GetProxyReservedSlot(obj, DOM_OBJECT_SLOT).toPrivate());
}
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (IsArrayIndex(index)) {
    mozilla::dom::SpeechRecognitionResultList* self = UnwrapProxy(proxy);
    bool found = false;
    auto result(StrongOrRawPtr<mozilla::dom::SpeechRecognitionResult>(MOZ_KnownLive(self)->IndexedGetter(index, found)));
    MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  mozilla::dom::SpeechRecognitionResultList* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::SpeechRecognitionResultList>(proxy);
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::dom::SpeechRecognitionResultList>(self);
  }
}
...
{
  mozilla::dom::SpeechRecognitionResultList* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::SpeechRecognitionResultList>(obj);
  if (self) {
...
static const DOMJSClass sClass = {
  PROXY_CLASS_DEF("SpeechRecognitionResultList",
                  JSCLASS_IS_DOMJSCLASS | JSCLASS_HAS_RESERVED_SLOTS(1)),
  { prototypes::id::SpeechRecognitionResultList, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  std::is_base_of_v<nsISupports, mozilla::dom::SpeechRecognitionResultList>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::dom::SpeechRecognitionResultList>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::dom::SpeechRecognitionResultList>::Get(),
  nullptr,
  nullptr
};
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::SpeechRecognitionResultList>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::dom::SpeechRecognitionResultList*>(aObject) ==
             reinterpret_cast<mozilla::dom::SpeechRecognitionResultList*>(aObject),
             "Multiple inheritance for mozilla::dom::SpeechRecognitionResultList is broken.");
  ...
  BindingJSObjectCreator<mozilla::dom::SpeechRecognitionResultList> creator(aCx);
...
const NativePropertyHooks sNativePropertyHooks[] = { {
  ...
  prototypes::id::SpeechRecognitionResultList,
  constructors::id::SpeechRecognitionResultList,
  nullptr,
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::SpeechRecognitionResultList);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::SpeechRecognitionResultList);
  dom::CreateInterfaceObjects(aCx, aGlobal, parentProto,
                              ...
                              nullptr,
                              "SpeechRecognitionResultList", aDefineOnGlobal,
                              nullptr,
                              false,
                              nullptr,
                              false);
