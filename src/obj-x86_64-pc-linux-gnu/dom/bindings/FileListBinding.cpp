...
namespace FileList_Binding {

MOZ_CAN_RUN_SCRIPT static bool
item(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, const JSJitMethodCallArgs& args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "FileList", "item", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::FileList*>(void_self);
  if (!args.requireAtLeast(cx, "FileList.item", 1)) {
    return false;
  }
  uint32_t arg0;
  ...
  auto result(StrongOrRawPtr<mozilla::dom::File>(MOZ_KnownLive(self)->Item(arg0)));
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "FileList", JSPROP_READONLY),
  JS_PS_END
};
...
static_assert(std::is_base_of_v<nsISupports, mozilla::dom::FileList>,
...
MOZ_ALWAYS_INLINE mozilla::dom::FileList*
UnwrapProxy(JSObject* obj)
{
  ...
  return static_cast<mozilla::dom::FileList*>(js::GetProxyReservedSlot(obj, DOM_OBJECT_SLOT).toPrivate());
}
...
DOMProxyHandler::getOwnPropDescriptor(JSContext* cx, JS::Handle<JSObject*> proxy, JS::Handle<jsid> id, bool ignoreNamedProps, JS::MutableHandle<JS::PropertyDescriptor> desc) const
{
  ...
  if (IsArrayIndex(index)) {
    mozilla::dom::FileList* self = UnwrapProxy(proxy);
    bool found = false;
    auto result(StrongOrRawPtr<mozilla::dom::File>(MOZ_KnownLive(self)->IndexedGetter(index, found)));
    MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  mozilla::dom::FileList* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::FileList>(proxy);
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::dom::FileList>(self);
  }
}
...
{
  mozilla::dom::FileList* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::FileList>(obj);
  if (self) {
...
static const DOMJSClass sClass = {
  PROXY_CLASS_DEF("FileList",
                  JSCLASS_IS_DOMJSCLASS | JSCLASS_HAS_RESERVED_SLOTS(1)),
  { prototypes::id::FileList, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count, prototypes::id::_ID_Count },
  std::is_base_of_v<nsISupports, mozilla::dom::FileList>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::dom::FileList>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::dom::FileList>::Get(),
  nullptr,
  nullptr
};
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::FileList>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::dom::FileList*>(aObject) ==
             reinterpret_cast<mozilla::dom::FileList*>(aObject),
             "Multiple inheritance for mozilla::dom::FileList is broken.");
  ...
  BindingJSObjectCreator<mozilla::dom::FileList> creator(aCx);
...
CreateInterfaceObjects(JSContext* aCx, JS::Handle<JSObject*> aGlobal, ProtoAndIfaceCache& aProtoAndIfaceCache, bool aDefineOnGlobal)
{
  ...
  JS::Heap<JSObject*>* protoCache = &aProtoAndIfaceCache.EntrySlotOrCreate(prototypes::id::FileList);
  JS::Heap<JSObject*>* interfaceCache = &aProtoAndIfaceCache.EntrySlotOrCreate(constructors::id::FileList);
