...
bool
ProgressEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<bool, eDefault>(cx, temp.ref(), "'lengthComputable' member of ProgressEventInit", &mLengthComputable)) {
      return false;
    }
  } else {
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<uint64_t, eDefault>(cx, temp.ref(), "'loaded' member of ProgressEventInit", &mLoaded)) {
      return false;
    }
  } else {
    mLoaded = 0ULL;
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<uint64_t, eDefault>(cx, temp.ref(), "'total' member of ProgressEventInit", &mTotal)) {
      return false;
    }
  } else {
    mTotal = 0ULL;
...
bool
ProgressEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
bool
ProgressEventInit::operator==(const ProgressEventInit& aOther) const
{
  if (mLengthComputable != aOther.mLengthComputable) {
      return false;
  }
  if (mLoaded != aOther.mLoaded) {
      return false;
  }
  if (mTotal != aOther.mTotal) {
      return false;
  }
  return true;
}
...
get_lengthComputable(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ProgressEvent", "lengthComputable", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::ProgressEvent*>(void_self);
  bool result(MOZ_KnownLive(self)->LengthComputable());
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ProgressEvent", "loaded", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::ProgressEvent*>(void_self);
  uint64_t result(MOZ_KnownLive(self)->Loaded());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
get_total(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ProgressEvent", "total", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::ProgressEvent*>(void_self);
  uint64_t result(MOZ_KnownLive(self)->Total());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  args.rval().set(JS_NumberValue(double(result)));
  return true;
}
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ProgressEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("lengthComputable", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &lengthComputable_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("loaded", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &loaded_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("total", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &total_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "ProgressEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "ProgressEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "ProgressEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "ProgressEvent constructor", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::ProgressEvent>(mozilla::dom::ProgressEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::ProgressEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::ProgressEvent>,
