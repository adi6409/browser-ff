...
bool
PopupBlockedEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  if (!isNull && !temp->isUndefined()) {
    ...
    mPopupWindowFeatures.AssignLiteral(u"");
  }
  ...
  if (!isNull && !temp->isUndefined()) {
    ...
    mPopupWindowName.AssignLiteral(u"");
  }
  mIsAnyMemberPresent = true;
  ...
  if (!isNull && !temp->isUndefined()) {
    if (temp.ref().isObject()) {
      ...
      if (NS_FAILED(UnwrapArg<nsIURI>(cx, source, getter_AddRefs(holder)))) {
        cx.ThrowErrorMessage<MSG_DOES_NOT_IMPLEMENT_INTERFACE>("'popupWindowURI' member of PopupBlockedEventInit", "URI");
        return false;
      }
      MOZ_ASSERT(holder);
      ...
      cx.ThrowErrorMessage<MSG_NOT_OBJECT>("'popupWindowURI' member of PopupBlockedEventInit");
      return false;
    }
  } else {
    mPopupWindowURI = nullptr;
  ...
  if (!isNull && !temp->isUndefined()) {
    if (temp.ref().isObject()) {
      static_assert(IsRefcounted<nsGlobalWindowInner>::value, "We can only store refcounted classes.");
      {
        ...
        nsresult rv = UnwrapObject<prototypes::id::Window, nsGlobalWindowInner>(temp.ptr(), mRequestingWindow, cx);
        if (NS_FAILED(rv)) {
          cx.ThrowErrorMessage<MSG_DOES_NOT_IMPLEMENT_INTERFACE>("'requestingWindow' member of PopupBlockedEventInit", "Window");
          return false;
        }
      }
    } else if (temp.ref().isNullOrUndefined()) {
      ...
      cx.ThrowErrorMessage<MSG_NOT_OBJECT>("'requestingWindow' member of PopupBlockedEventInit");
      return false;
    }
  } else {
    mRequestingWindow = nullptr;
...
bool
PopupBlockedEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
get_requestingWindow(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PopupBlockedEvent", "requestingWindow", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::PopupBlockedEvent*>(void_self);
  auto result(StrongOrRawPtr<nsGlobalWindowInner>(MOZ_KnownLive(self)->GetRequestingWindow()));
...
MOZ_CAN_RUN_SCRIPT static bool
get_popupWindowURI(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PopupBlockedEvent", "popupWindowURI", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::PopupBlockedEvent*>(void_self);
  auto result(StrongOrRawPtr<nsIURI>(MOZ_KnownLive(self)->GetPopupWindowURI()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!result) {
    args.rval().setNull();
    return true;
...
MOZ_CAN_RUN_SCRIPT static bool
get_popupWindowName(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PopupBlockedEvent", "popupWindowName", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->GetPopupWindowName(result))>, "Should be returning void here");
  MOZ_KnownLive(self)->GetPopupWindowName(result);
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
get_popupWindowFeatures(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PopupBlockedEvent", "popupWindowFeatures", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  DOMString result;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->GetPopupWindowFeatures(result))>, "Should be returning void here");
  MOZ_KnownLive(self)->GetPopupWindowFeatures(result);
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!xpc::StringToJsval(cx, result, args.rval())) {
    return false;
  }
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PopupBlockedEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("requestingWindow", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &requestingWindow_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("popupWindowURI", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &popupWindowURI_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("popupWindowName", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &popupWindowName_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("popupWindowFeatures", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &popupWindowFeatures_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "PopupBlockedEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "PopupBlockedEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "PopupBlockedEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "PopupBlockedEvent constructor", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::PopupBlockedEvent>(mozilla::dom::PopupBlockedEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::PopupBlockedEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::PopupBlockedEvent>,
