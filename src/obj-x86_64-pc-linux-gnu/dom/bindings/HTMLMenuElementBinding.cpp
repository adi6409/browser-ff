...
get_type(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuElement", "type", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::HTMLMenuElement*>(void_self);
  DOMString result;
...
set_type(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitSetterCallArgs args)
{
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "HTMLMenuElement.type setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
set_label(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitSetterCallArgs args)
{
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "HTMLMenuElement.label setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuElement", "compact", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
set_compact(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitSetterCallArgs args)
{
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "HTMLMenuElement.compact setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
sendShowEvent(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, const JSJitMethodCallArgs& args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuElement", "sendShowEvent", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::HTMLMenuElement*>(void_self);
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->SendShowEvent())>, "Should be returning void here");
  MOZ_KnownLive(self)->SendShowEvent();
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
MOZ_CAN_RUN_SCRIPT static bool
createBuilder(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, const JSJitMethodCallArgs& args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuElement", "createBuilder", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::HTMLMenuElement*>(void_self);
  auto result(StrongOrRawPtr<nsIMenuBuilder>(MOZ_KnownLive(self)->CreateBuilder()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!result) {
    args.rval().setNull();
    return true;
...
MOZ_CAN_RUN_SCRIPT static bool
build(JSContext* cx_, JS::Handle<JSObject*> obj, void* void_self, const JSJitMethodCallArgs& args)
{
  BindingCallContext cx(cx_, "HTMLMenuElement.build");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuElement", "build", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_METHOD) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::HTMLMenuElement*>(void_self);
  if (!args.requireAtLeast(cx, "HTMLMenuElement.build", 1)) {
    return false;
  }
  nsIMenuBuilder* arg0;
  ...
  if (args[0].isObject()) {
    ...
    if (NS_FAILED(UnwrapArg<nsIMenuBuilder>(cx, source, getter_AddRefs(arg0_holder)))) {
      cx.ThrowErrorMessage<MSG_DOES_NOT_IMPLEMENT_INTERFACE>("Argument 1", "MenuBuilder");
      return false;
    }
  ...
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->Build(MOZ_KnownLive(NonNullHelper(arg0))))>, "Should be returning void here");
  MOZ_KnownLive(self)->Build(MOZ_KnownLive(NonNullHelper(arg0)));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  args.rval().setUndefined();
  return true;
}
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "HTMLMenuElement", JSPROP_READONLY),
  JS_PS_END
};
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuElement", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::HTMLMenuElement>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::HTMLMenuElement>,
