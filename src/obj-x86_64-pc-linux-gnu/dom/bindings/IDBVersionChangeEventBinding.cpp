...
bool
IDBVersionChangeEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  if (!(!isNull && !temp->isUndefined()) || temp.ref().isNullOrUndefined()) {
    mNewVersion.SetNull();
  } else if (!ValueToPrimitive<uint64_t, eDefault>(cx, temp.ref(), "'newVersion' member of IDBVersionChangeEventInit", &mNewVersion.SetValue())) {
    return false;
  }
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<uint64_t, eDefault>(cx, temp.ref(), "'oldVersion' member of IDBVersionChangeEventInit", &mOldVersion)) {
      return false;
    }
  } else {
    mOldVersion = 0ULL;
...
bool
IDBVersionChangeEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
bool
IDBVersionChangeEventInit::operator==(const IDBVersionChangeEventInit& aOther) const
{
  if (mNewVersion != aOther.mNewVersion) {
      return false;
  }
  if (mOldVersion != aOther.mOldVersion) {
      return false;
  }
  return true;
}
...
get_oldVersion(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "IDBVersionChangeEvent", "oldVersion", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::IDBVersionChangeEvent*>(void_self);
  uint64_t result(MOZ_KnownLive(self)->OldVersion());
...
MOZ_CAN_RUN_SCRIPT static bool
get_newVersion(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "IDBVersionChangeEvent", "newVersion", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::IDBVersionChangeEvent*>(void_self);
  Nullable<uint64_t> result(MOZ_KnownLive(self)->GetNewVersion());
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (result.IsNull()) {
    args.rval().setNull();
    return true;
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "IDBVersionChangeEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("oldVersion", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &oldVersion_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("newVersion", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &newVersion_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "IDBVersionChangeEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "IDBVersionChangeEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "IDBVersionChangeEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "IDBVersionChangeEvent constructor", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::IDBVersionChangeEvent>(mozilla::dom::IDBVersionChangeEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::IDBVersionChangeEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::IDBVersionChangeEvent>,
