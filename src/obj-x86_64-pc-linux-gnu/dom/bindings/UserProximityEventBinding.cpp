...
bool
UserProximityEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  if (!isNull && !temp->isUndefined()) {
    if (!ValueToPrimitive<bool, eDefault>(cx, temp.ref(), "'near' member of UserProximityEventInit", &mNear)) {
      return false;
    }
  } else {
    mNear = false;
...
bool
UserProximityEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
bool
UserProximityEventInit::operator==(const UserProximityEventInit& aOther) const
{
  if (mNear != aOther.mNear) {
      return false;
  }
  return true;
}
...
get_near(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "UserProximityEvent", "near", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::UserProximityEvent*>(void_self);
  bool result(MOZ_KnownLive(self)->Near());
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "UserProximityEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("near", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &near_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "UserProximityEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "UserProximityEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "UserProximityEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "UserProximityEvent constructor", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::UserProximityEvent>(mozilla::dom::UserProximityEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::UserProximityEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::UserProximityEvent>,
