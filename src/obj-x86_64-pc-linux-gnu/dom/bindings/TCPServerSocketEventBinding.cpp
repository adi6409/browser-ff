...
bool
TCPServerSocketEventInit::Init(BindingCallContext& cx, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
  ...
  if (!isNull && !temp->isUndefined()) {
    if (temp.ref().isObject()) {
      static_assert(IsRefcounted<mozilla::dom::TCPSocket>::value, "We can only store refcounted classes.");
      {
        ...
        nsresult rv = UnwrapObject<prototypes::id::TCPSocket, mozilla::dom::TCPSocket>(temp.ptr(), mSocket, cx);
        if (NS_FAILED(rv)) {
          cx.ThrowErrorMessage<MSG_DOES_NOT_IMPLEMENT_INTERFACE>("'socket' member of TCPServerSocketEventInit", "TCPSocket");
          return false;
        }
      }
      ...
      cx.ThrowErrorMessage<MSG_NOT_OBJECT>("'socket' member of TCPServerSocketEventInit");
      return false;
    }
  } else {
    mSocket = nullptr;
...
bool
TCPServerSocketEventInit::Init(JSContext* cx_, JS::Handle<JS::Value> val, const char* sourceDescription, bool passedToJSImpl)
{
...
get_socket(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "TCPServerSocketEvent", "socket", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::TCPServerSocketEvent*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::TCPSocket>(MOZ_KnownLive(self)->Socket()));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "TCPServerSocketEvent", "isTrusted", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("socket", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &socket_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "TCPServerSocketEvent", JSPROP_READONLY),
  JS_PS_END
};
...
{
  BindingCallContext cx(cx_, "TCPServerSocketEvent constructor");
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "TCPServerSocketEvent", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  if (!args.requireAtLeast(cx, "TCPServerSocketEvent constructor", 1)) {
    return false;
  }
  ...
  auto result(StrongOrRawPtr<mozilla::dom::TCPServerSocketEvent>(mozilla::dom::TCPServerSocketEvent::Constructor(global, NonNullHelper(Constify(arg0)), Constify(arg1))));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::TCPServerSocketEvent>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::TCPServerSocketEvent>,
