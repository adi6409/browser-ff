...
get_in1(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFECompositeElement", "in1", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SVGFECompositeElement*>(void_self);
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFECompositeElement", "in2", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFECompositeElement", "operator", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
MOZ_CAN_RUN_SCRIPT static bool
get_k1(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFECompositeElement", "k1", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SVGFECompositeElement*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::DOMSVGAnimatedNumber>(MOZ_KnownLive(self)->K1()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!GetOrCreateDOMReflector(cx, result, args.rval())) {
    MOZ_ASSERT(JS_IsExceptionPending(cx));
    return false;
...
MOZ_CAN_RUN_SCRIPT static bool
get_k2(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFECompositeElement", "k2", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SVGFECompositeElement*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::DOMSVGAnimatedNumber>(MOZ_KnownLive(self)->K2()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!GetOrCreateDOMReflector(cx, result, args.rval())) {
    MOZ_ASSERT(JS_IsExceptionPending(cx));
    return false;
...
MOZ_CAN_RUN_SCRIPT static bool
get_k3(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFECompositeElement", "k3", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SVGFECompositeElement*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::DOMSVGAnimatedNumber>(MOZ_KnownLive(self)->K3()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!GetOrCreateDOMReflector(cx, result, args.rval())) {
    MOZ_ASSERT(JS_IsExceptionPending(cx));
    return false;
...
MOZ_CAN_RUN_SCRIPT static bool
get_k4(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFECompositeElement", "k4", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::SVGFECompositeElement*>(void_self);
  auto result(StrongOrRawPtr<mozilla::dom::DOMSVGAnimatedNumber>(MOZ_KnownLive(self)->K4()));
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!GetOrCreateDOMReflector(cx, result, args.rval())) {
    MOZ_ASSERT(JS_IsExceptionPending(cx));
    return false;
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFECompositeElement", "x", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFECompositeElement", "y", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFECompositeElement", "width", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFECompositeElement", "height", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "SVGFECompositeElement", "result", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JSPropertySpec::nativeAccessors("k1", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &k1_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("k2", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &k2_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("k3", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &k3_getterinfo, nullptr, nullptr),
  JSPropertySpec::nativeAccessors("k4", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &k4_getterinfo, nullptr, nullptr),
  ...
  JS_STRING_SYM_PS(toStringTag, "SVGFECompositeElement", JSPROP_READONLY),
  JS_PS_END
};
...
static const ConstantSpec sConstants_specs[] = {
  ...
  { "SVG_FECOMPOSITE_OPERATOR_LIGHTER", JS::Int32Value(7) },
  { 0, JS::UndefinedValue() }
};
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::SVGFECompositeElement>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::SVGFECompositeElement>,
