...
namespace CommandEvent_Binding {

static_assert(IsRefcounted<NativeType>::value == IsRefcounted<Event_Binding::NativeType>::value,
              "Can't inherit from an interface with a different ownership model.");

MOZ_CAN_RUN_SCRIPT static bool
get_command(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "CommandEvent", "command", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::CommandEvent*>(void_self);
  DOMString result;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->GetCommand(result))>, "Should be returning void here");
  MOZ_KnownLive(self)->GetCommand(result);
...
static const JSJitInfo command_getterinfo = {
  { get_command },
...
{
  mozilla::dom::CommandEvent* self = UnwrapPossiblyNotInitializedDOMObject<mozilla::dom::CommandEvent>(obj);
...
_finalize(JSFreeOp* fop, JSObject* obj)
{
  ...
  if (self) {
    ...
    AddForDeferredFinalization<mozilla::dom::CommandEvent>(self);
  }
}
...
static const JSPropertySpec sAttributes_specs[] = {
  JSPropertySpec::nativeAccessors("command", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &command_getterinfo, nullptr, nullptr),
  JS_STRING_SYM_PS(toStringTag, "CommandEvent", JSPROP_READONLY),
  JS_PS_END
};
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::CommandEvent>,
  sNativePropertyHooks,
  FindAssociatedGlobalForNative<mozilla::dom::CommandEvent>::Get,
  GetProtoObjectHandle,
  GetCCParticipant<mozilla::dom::CommandEvent>::Get(),
  nullptr,
  _getWrapperCache
};
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::CommandEvent>,
                "Shouldn't have wrappercached things that are not refcounted.");
  MOZ_ASSERT(static_cast<mozilla::dom::CommandEvent*>(aObject) ==
             reinterpret_cast<mozilla::dom::CommandEvent*>(aObject),
             "Multiple inheritance for mozilla::dom::CommandEvent is broken.");
