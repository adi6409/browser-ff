...
#pragma clang diagnostic pop
  ...
  if (!isNull && !temp->isUndefined()) {
    if (temp.ref().isObject()) {
      ...
      if (!iter.valueIsIterable()) {
        cx.ThrowErrorMessage<MSG_NOT_SEQUENCE>("'ports' member of MessageEventInit");
        return false;
      }
  ...
  if (!(!isNull && !temp->isUndefined()) || temp.ref().isNullOrUndefined()) {
  ...
  } else {
    {
      ...
      if (!done) {
        cx.ThrowErrorMessage<MSG_NOT_IN_UNION>("'source' member of MessageEventInit", "WindowProxy, MessagePort, ServiceWorker");
        return false;
      }
    }
  }
...
initMessageEvent(JSContext* cx_, JS::Handle<JSObject*> obj, void* void_self, const JSJitMethodCallArgs& args)
{
  ...
  if (!(args.hasDefined(6)) || args[6].isNullOrUndefined()) {
    ...
    arg6_holder.emplace(arg6.SetValue());
    {
      ...
      if (!done) {
        cx.ThrowErrorMessage<MSG_NOT_IN_UNION>("Argument 7", "WindowProxy, MessagePort, ServiceWorker");
        return false;
      }
    }
  }
  ...
  if (args.hasDefined(7)) {
    if (args[7].isObject()) {
      ...
      if (!iter.valueIsIterable()) {
        cx.ThrowErrorMessage<MSG_NOT_SEQUENCE>("Argument 8");
        return false;
      }
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JS_STRING_SYM_PS(toStringTag, "MessageEvent", JSPROP_READONLY),
  JS_PS_END
};
