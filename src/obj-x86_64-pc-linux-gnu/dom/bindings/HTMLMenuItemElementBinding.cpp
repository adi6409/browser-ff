...
get_type(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuItemElement", "type", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));

  auto* self = static_cast<mozilla::dom::HTMLMenuItemElement*>(void_self);
  DOMString result;
...
set_type(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitSetterCallArgs args)
{
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "HTMLMenuItemElement.type setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuItemElement", "label", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
set_label(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitSetterCallArgs args)
{
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "HTMLMenuItemElement.label setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuItemElement", "icon", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
MOZ_CAN_RUN_SCRIPT static bool
set_icon(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitSetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuItemElement", "icon", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_SETTER) |
  ...
  FastErrorResult rv;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->SetIcon(NonNullHelper(Constify(arg0)), rv))>, "Should be returning void here");
  MOZ_KnownLive(self)->SetIcon(NonNullHelper(Constify(arg0)), rv);
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "HTMLMenuItemElement.icon setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuItemElement", "disabled", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
set_disabled(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitSetterCallArgs args)
{
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "HTMLMenuItemElement.disabled setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuItemElement", "checked", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
MOZ_CAN_RUN_SCRIPT static bool
get_radiogroup(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitGetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuItemElement", "radiogroup", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
  ...
  DOMString result;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->GetRadiogroup(result))>, "Should be returning void here");
  MOZ_KnownLive(self)->GetRadiogroup(result);
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
  if (!xpc::NonVoidStringToJsval(cx, result, args.rval())) {
    return false;
  }
...
MOZ_CAN_RUN_SCRIPT static bool
set_radiogroup(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitSetterCallArgs args)
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuItemElement", "radiogroup", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_SETTER) |
  ...
  FastErrorResult rv;
  // NOTE: This assert does NOT call the function.
  static_assert(std::is_void_v<decltype(MOZ_KnownLive(self)->SetRadiogroup(NonNullHelper(Constify(arg0)), rv))>, "Should be returning void here");
  MOZ_KnownLive(self)->SetRadiogroup(NonNullHelper(Constify(arg0)), rv);
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "HTMLMenuItemElement.radiogroup setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuItemElement", "defaultChecked", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::STRING_TEMPLATE_GETTER) |
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
set_defaultChecked(JSContext* cx, JS::Handle<JSObject*> obj, void* void_self, JSJitSetterCallArgs args)
{
  ...
  if (MOZ_UNLIKELY(rv.MaybeSetPendingException(cx, "HTMLMenuItemElement.defaultChecked setter"))) {
    return false;
  }
  MOZ_ASSERT(!JS_IsExceptionPending(cx));
...
static const JSPropertySpec sAttributes_specs[] = {
  ...
  JSPropertySpec::nativeAccessors("icon", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &icon_getterinfo, GenericSetter<NormalThisPolicy>, &icon_setterinfo),
  ...
  JSPropertySpec::nativeAccessors("radiogroup", JSPROP_ENUMERATE, GenericGetter<NormalThisPolicy, ThrowExceptions>, &radiogroup_getterinfo, GenericSetter<NormalThisPolicy>, &radiogroup_setterinfo),
  ...
  JS_STRING_SYM_PS(toStringTag, "HTMLMenuItemElement", JSPROP_READONLY),
  JS_PS_END
};
...
{
  AUTO_PROFILER_LABEL_DYNAMIC_FAST(
    "HTMLMenuItemElement", "constructor", DOM, cx,
    uint32_t(js::ProfilingStackFrame::Flags::RELEVANT_FOR_JS));
...
{
  return StaticPrefs::dom_menuitem_enabled();
}
...
static const DOMJSClass sClass = {
  ...
  std::is_base_of_v<nsISupports, mozilla::dom::HTMLMenuItemElement>,
  sNativePropertyHooks,
...
{
  static_assert(!std::is_base_of_v<NonRefcountedDOMObject, mozilla::dom::HTMLMenuItemElement>,
