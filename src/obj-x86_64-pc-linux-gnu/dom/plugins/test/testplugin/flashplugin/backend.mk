...
UNIFIED_CPPSRCS := Unified_cpp_flashplugin0.cpp
...
LIBRARY_NAME := npswftest
FORCE_SHARED_LIB := 1
IMPORT_LIBRARY := libnpswftest.so
SHARED_LIBRARY := libnpswftest.so
DSO_SONAME := libnpswftest.so
libnpswftest.so_OBJS := Unified_cpp_flashplugin0.o
libnpswftest.so: Unified_cpp_flashplugin0.o
