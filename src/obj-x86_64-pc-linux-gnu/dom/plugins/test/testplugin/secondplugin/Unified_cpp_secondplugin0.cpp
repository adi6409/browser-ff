...
#undef INITGUID
#endif
#include "/worker/build/dom/plugins/test/testplugin/secondplugin/nptest_name.cpp"
#ifdef PL_ARENA_CONST_ALIGN_MASK
#error "/worker/build/dom/plugins/test/testplugin/secondplugin/nptest_name.cpp uses PL_ARENA_CONST_ALIGN_MASK, so it cannot be built in unified mode."
#undef PL_ARENA_CONST_ALIGN_MASK
#endif
#ifdef INITGUID
#error "/worker/build/dom/plugins/test/testplugin/secondplugin/nptest_name.cpp defines INITGUID, so it cannot be built in unified mode."
#undef INITGUID
#endif