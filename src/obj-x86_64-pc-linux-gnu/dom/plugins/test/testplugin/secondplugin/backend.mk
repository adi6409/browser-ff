...
UNIFIED_CPPSRCS := Unified_cpp_secondplugin0.cpp
...
FORCE_SHARED_LIB := 1
IMPORT_LIBRARY := libnpsecondtest.so
SHARED_LIBRARY := libnpsecondtest.so
DSO_SONAME := libnpsecondtest.so
libnpsecondtest.so_OBJS := Unified_cpp_secondplugin0.o
libnpsecondtest.so: Unified_cpp_secondplugin0.o
