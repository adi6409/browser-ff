...
GetErrorNameInternal(nsresult rv)
{
  ...
  case nsresult::NS_ERROR_DOM_INVALID_STATE_XHR_MUST_NOT_BE_LOADING_OR_DONE_RESPONSE_TYPE: return "NS_ERROR_DOM_INVALID_STATE_XHR_MUST_NOT_BE_LOADING_OR_DONE_RESPONSE_TYPE";
  case nsresult::NS_ERROR_DOM_INVALID_STATE_XHR_MUST_NOT_BE_LOADING_OR_DONE_OVERRIDE_MIME_TYPE: return "NS_ERROR_DOM_INVALID_STATE_XHR_MUST_NOT_BE_LOADING_OR_DONE_OVERRIDE_MIME_TYPE";
  ...
  case nsresult::NS_ERROR_DOM_INVALID_STATE_DOCUMENT_EXEC_COMMAND: return "NS_ERROR_DOM_INVALID_STATE_DOCUMENT_EXEC_COMMAND";
  case nsresult::NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_ENABLED: return "NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_ENABLED";
  case nsresult::NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_INDETERM: return "NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_INDETERM";
  case nsresult::NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_STATE: return "NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_STATE";
  case nsresult::NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_SUPPORTED: return "NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_SUPPORTED";
  case nsresult::NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_VALUE: return "NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_VALUE";
  ...
  case nsresult::NS_ERROR_CSP_NAVIGATE_TO_VIOLATION: return "NS_ERROR_CSP_NAVIGATE_TO_VIOLATION";
