...
#define NS_ERROR_MODULE_WIN32 44
...
const nsresult
  ...
  NS_ERROR_DOM_INVALID_STATE_XHR_MUST_NOT_BE_LOADING_OR_DONE_RESPONSE_TYPE = nsresult::NS_ERROR_DOM_INVALID_STATE_XHR_MUST_NOT_BE_LOADING_OR_DONE_RESPONSE_TYPE,
  NS_ERROR_DOM_INVALID_STATE_XHR_MUST_NOT_BE_LOADING_OR_DONE_OVERRIDE_MIME_TYPE = nsresult::NS_ERROR_DOM_INVALID_STATE_XHR_MUST_NOT_BE_LOADING_OR_DONE_OVERRIDE_MIME_TYPE,
  ...
  NS_ERROR_DOM_INVALID_STATE_DOCUMENT_EXEC_COMMAND = nsresult::NS_ERROR_DOM_INVALID_STATE_DOCUMENT_EXEC_COMMAND,
  NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_ENABLED = nsresult::NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_ENABLED,
  NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_INDETERM = nsresult::NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_INDETERM,
  NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_STATE = nsresult::NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_STATE,
  NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_SUPPORTED = nsresult::NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_SUPPORTED,
  NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_VALUE = nsresult::NS_ERROR_DOM_INVALID_STATE_DOCUMENT_QUERY_COMMAND_VALUE,
