...
DEFINES += -DNDEBUG=1 -DTRIMMED=1 -DNS_NO_XPCOM '-DMAR_CHANNEL_ID=""' '-DMOZ_APP_VERSION="87.0"'
...
updater_OBJS := /worker/build/obj-x86_64-pc-linux-gnu/toolkit/mozapps/update/updater/updater.list
