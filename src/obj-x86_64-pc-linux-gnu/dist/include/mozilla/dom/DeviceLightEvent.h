...
{
public:
  NS_INLINE_DECL_REFCOUNTING_INHERITED(DeviceLightEvent, Event)
...
public:
  DeviceLightEvent* AsDeviceLightEvent() override;
  ...
  static already_AddRefed<DeviceLightEvent> Constructor(const GlobalObject& aGlobal, const nsAString& aType, const DeviceLightEventInit& aEventInitDict);
