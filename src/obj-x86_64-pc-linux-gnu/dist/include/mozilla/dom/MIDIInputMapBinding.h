...
#ifndef mozilla_dom_MIDIInputMapBinding_h
#define mozilla_dom_MIDIInputMapBinding_h
...
namespace MIDIInputMap_Binding {
  ...
  typedef mozilla::dom::MIDIInputMap NativeType;
...
#endif // mozilla_dom_MIDIInputMapBinding_h
