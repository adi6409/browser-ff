...
public:
  TrackEvent* AsTrackEvent() override;
  ...
  static already_AddRefed<TrackEvent> Constructor(const GlobalObject& aGlobal, const nsAString& aType, const TrackEventInit& aEventInitDict);
