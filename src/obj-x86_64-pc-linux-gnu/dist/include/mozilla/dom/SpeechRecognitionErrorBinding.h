...
enum class SpeechRecognitionErrorCode : uint8_t {
  No_speech,
  Aborted,
  Audio_capture,
  Network,
...
static_assert(static_cast<size_t>(SpeechRecognitionErrorCode::EndGuard_) == Count,
              "Mismatch between enum value and enum count");

inline auto GetString(SpeechRecognitionErrorCode stringId) {
...
namespace SpeechRecognitionError_Binding {
  ...
  inline JS::Handle<JSObject*> GetProtoObjectHandle(JSContext* aCx)
  {
    /* Get the interface prototype object for this class.  This will create the
       object as needed. */
    return GetPerInterfaceObjectHandle(aCx, prototypes::id::SpeechRecognitionError,
  ...
  inline JS::Handle<JSObject*> GetConstructorObjectHandle(JSContext* aCx, bool aDefineOnGlobal = true)
  {
    ...
    return GetPerInterfaceObjectHandle(aCx, constructors::id::SpeechRecognitionError,
                                       &CreateInterfaceObjects,
                                       aDefineOnGlobal);
  }
