...
public:
  OfflineAudioCompletionEvent* AsOfflineAudioCompletionEvent() override;
  ...
  static already_AddRefed<OfflineAudioCompletionEvent> Constructor(const GlobalObject& aGlobal, const nsAString& aType, const OfflineAudioCompletionEventInit& aEventInitDict);
