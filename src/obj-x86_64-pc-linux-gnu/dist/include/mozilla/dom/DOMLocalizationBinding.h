...
#ifndef mozilla_dom_DOMLocalizationBinding_h
#define mozilla_dom_DOMLocalizationBinding_h
...
namespace DOMLocalization_Binding {
  ...
  typedef mozilla::dom::DOMLocalization NativeType;
...
#endif // mozilla_dom_DOMLocalizationBinding_h
