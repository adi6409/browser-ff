...
public:
  ...
  static already_AddRefed<PositionStateEvent> Constructor(mozilla::dom::EventTarget* aOwner, const nsAString& aType, const PositionStateEventInit& aEventInitDict);

  static already_AddRefed<PositionStateEvent> Constructor(const GlobalObject& aGlobal, const nsAString& aType, const PositionStateEventInit& aEventInitDict);
