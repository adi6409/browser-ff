...
{
public:
  NS_INLINE_DECL_REFCOUNTING_INHERITED(HashChangeEvent, Event)
...
public:
  HashChangeEvent* AsHashChangeEvent() override;
  ...
  static already_AddRefed<HashChangeEvent> Constructor(const GlobalObject& aGlobal, const nsAString& aType, const HashChangeEventInit& aEventInitDict);
