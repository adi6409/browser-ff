...
static_assert(static_cast<size_t>(IDBTransactionMode::EndGuard_) == Count,
              "Mismatch between enum value and enum count");

inline auto GetString(IDBTransactionMode stringId) {
...
namespace IDBTransaction_Binding {
  ...
  inline JS::Handle<JSObject*> GetProtoObjectHandle(JSContext* aCx)
  {
    /* Get the interface prototype object for this class.  This will create the
       object as needed. */
    return GetPerInterfaceObjectHandle(aCx, prototypes::id::IDBTransaction,
  ...
  inline JS::Handle<JSObject*> GetConstructorObjectHandle(JSContext* aCx, bool aDefineOnGlobal = true)
  {
    ...
    return GetPerInterfaceObjectHandle(aCx, constructors::id::IDBTransaction,
                                       &CreateInterfaceObjects,
                                       aDefineOnGlobal);
  }
