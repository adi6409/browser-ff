...
protected:
  ...
  bool mCollapsed;
  RefPtr<DOMRectReadOnly> mBoundingClientRect;
...
public:
  CaretStateChangedEvent* AsCaretStateChangedEvent() override;
  ...
  static already_AddRefed<CaretStateChangedEvent> Constructor(const GlobalObject& aGlobal, const nsAString& aType, const CaretStateChangedEventInit& aEventInit);
  ...
  bool CaretVisuallyVisible() const;

  bool SelectionVisible() const;

  bool SelectionEditable() const;

  void GetSelectedTextContent(nsString& aRetVal) const;
};
