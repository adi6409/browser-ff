...
public:
  BlobEvent* AsBlobEvent() override;
  ...
  static already_AddRefed<BlobEvent> Constructor(const GlobalObject& aGlobal, const nsAString& aType, const BlobEventInit& aEventInitDict);
