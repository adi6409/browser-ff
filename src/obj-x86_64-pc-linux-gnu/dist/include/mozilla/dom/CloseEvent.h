...
{
public:
  NS_INLINE_DECL_REFCOUNTING_INHERITED(CloseEvent, Event)
...
public:
  CloseEvent* AsCloseEvent() override;
  ...
  static already_AddRefed<CloseEvent> Constructor(const GlobalObject& aGlobal, const nsAString& aType, const CloseEventInit& aEventInitDict);
