...
#ifndef mozilla_dom_PaymentAddressBinding_h
#define mozilla_dom_PaymentAddressBinding_h
...
namespace PaymentAddress_Binding {
  ...
  typedef mozilla::dom::PaymentAddress NativeType;
  ...
  inline JS::Handle<JSObject*> GetProtoObjectHandle(JSContext* aCx)
  {
    /* Get the interface prototype object for this class.  This will create the
       object as needed. */
    return GetPerInterfaceObjectHandle(aCx, prototypes::id::PaymentAddress,
  ...
  inline JS::Handle<JSObject*> GetConstructorObjectHandle(JSContext* aCx, bool aDefineOnGlobal = true)
  {
    ...
    return GetPerInterfaceObjectHandle(aCx, constructors::id::PaymentAddress,
                                       &CreateInterfaceObjects,
                                       aDefineOnGlobal);
  }
...
#endif // mozilla_dom_PaymentAddressBinding_h
