...
{
public:
  NS_INLINE_DECL_REFCOUNTING_INHERITED(AnimationPlaybackEvent, Event)
...
public:
  AnimationPlaybackEvent* AsAnimationPlaybackEvent() override;
  ...
  static already_AddRefed<AnimationPlaybackEvent> Constructor(const GlobalObject& aGlobal, const nsAString& aType, const AnimationPlaybackEventInit& aEventInitDict);
