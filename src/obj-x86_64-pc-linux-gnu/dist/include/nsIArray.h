...
class nsIArray : public nsISupports {
 public:
  ...
  using ScriptableInterfaceType = nsIArray;
  ...
  NS_IMETHOD ScriptedEnumerate(const nsIID & aElemIID, uint8_t _argc, nsISimpleEnumerator **_retval) = 0;

  /* [noscript] nsISimpleEnumerator enumerateImpl (in nsIDRef aElemIID); */
  NS_IMETHOD EnumerateImpl(const nsID & aElemIID, nsISimpleEnumerator **_retval) = 0;
...
#define NS_DECL_NSIARRAY \
  ...
  NS_IMETHOD ScriptedEnumerate(const nsIID & aElemIID, uint8_t _argc, nsISimpleEnumerator **_retval) override; \
  NS_IMETHOD EnumerateImpl(const nsID & aElemIID, nsISimpleEnumerator **_retval) override; \
...
#define NS_DECL_NON_VIRTUAL_NSIARRAY \
  ...
  nsresult ScriptedEnumerate(const nsIID & aElemIID, uint8_t _argc, nsISimpleEnumerator **_retval); \
  nsresult EnumerateImpl(const nsID & aElemIID, nsISimpleEnumerator **_retval); \
...
#define NS_FORWARD_NSIARRAY(_to) \
  ...
  NS_IMETHOD ScriptedEnumerate(const nsIID & aElemIID, uint8_t _argc, nsISimpleEnumerator **_retval) override { return _to ScriptedEnumerate(aElemIID, _argc, _retval); } \
  NS_IMETHOD EnumerateImpl(const nsID & aElemIID, nsISimpleEnumerator **_retval) override { return _to EnumerateImpl(aElemIID, _retval); } \
...
#define NS_FORWARD_SAFE_NSIARRAY(_to) \
  ...
  NS_IMETHOD ScriptedEnumerate(const nsIID & aElemIID, uint8_t _argc, nsISimpleEnumerator **_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ScriptedEnumerate(aElemIID, _argc, _retval); } \
  NS_IMETHOD EnumerateImpl(const nsID & aElemIID, nsISimpleEnumerator **_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->EnumerateImpl(aElemIID, _retval); } \
