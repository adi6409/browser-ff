...
class NS_NO_VTABLE nsISupportsPriority : public nsISupports {
 public:
  ...
  using ScriptableInterfaceType = nsISupportsPriority;
  ...
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD SetPriority(int32_t aPriority) = 0;

  /* void adjustPriority (in long delta); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD AdjustPriority(int32_t delta) = 0;
