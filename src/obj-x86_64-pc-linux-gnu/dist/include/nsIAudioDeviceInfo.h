...
class NS_NO_VTABLE nsIAudioDeviceInfo : public nsISupports {
 public:
  ...
  using ScriptableInterfaceType = nsIAudioDeviceInfo;

  /* readonly attribute AString name; */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetName(nsAString& aName) = 0;

  /* readonly attribute AString groupId; */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetGroupId(nsAString& aGroupId) = 0;

  /* readonly attribute AString vendor; */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetVendor(nsAString& aVendor) = 0;
  ...
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetPreferred(uint16_t *aPreferred) = 0;
  ...
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetSupportedFormat(uint16_t *aSupportedFormat) = 0;

  /* readonly attribute unsigned short defaultFormat; */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetDefaultFormat(uint16_t *aDefaultFormat) = 0;

  /* readonly attribute unsigned long maxChannels; */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetMaxChannels(uint32_t *aMaxChannels) = 0;

  /* readonly attribute unsigned long defaultRate; */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetDefaultRate(uint32_t *aDefaultRate) = 0;

  /* readonly attribute unsigned long maxRate; */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetMaxRate(uint32_t *aMaxRate) = 0;

  /* readonly attribute unsigned long minRate; */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetMinRate(uint32_t *aMinRate) = 0;

  /* readonly attribute unsigned long maxLatency; */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetMaxLatency(uint32_t *aMaxLatency) = 0;

  /* readonly attribute unsigned long minLatency; */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetMinLatency(uint32_t *aMinLatency) = 0;
