...
class NS_NO_VTABLE nsIGIOService : public nsISupports {
 public:
  ...
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetMimeTypeFromExtension(const nsACString& extension, nsACString& _retval) = 0;

  /* nsIHandlerApp getAppForURIScheme (in AUTF8String aURIScheme); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetAppForURIScheme(const nsACString& aURIScheme, nsIHandlerApp **_retval) = 0;

  /* nsIMutableArray getAppsForURIScheme (in AUTF8String aURIScheme); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetAppsForURIScheme(const nsACString& aURIScheme, nsIMutableArray **_retval) = 0;

  /* nsIHandlerApp getAppForMimeType (in AUTF8String mimeType); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetAppForMimeType(const nsACString& mimeType, nsIHandlerApp **_retval) = 0;

  /* nsIGIOMimeApp createAppFromCommand (in AUTF8String cmd, in AUTF8String appName); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD CreateAppFromCommand(const nsACString& cmd, const nsACString& appName, nsIGIOMimeApp **_retval) = 0;

  /* nsIGIOMimeApp findAppFromCommand (in AUTF8String cmd); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD FindAppFromCommand(const nsACString& cmd, nsIGIOMimeApp **_retval) = 0;

  /* AUTF8String getDescriptionForMimeType (in AUTF8String mimeType); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetDescriptionForMimeType(const nsACString& mimeType, nsACString& _retval) = 0;

  /* void showURI (in nsIURI uri); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD ShowURI(nsIURI *uri) = 0;
  ...
  NS_IMETHOD ShouldUseFlatpakPortal(bool *_retval) = 0;
...
#define NS_DECL_NSIGIOSERVICE \
  ...
  NS_IMETHOD ShouldUseFlatpakPortal(bool *_retval) override; 
...
#define NS_DECL_NON_VIRTUAL_NSIGIOSERVICE \
  ...
  nsresult ShouldUseFlatpakPortal(bool *_retval); 
...
#define NS_FORWARD_NSIGIOSERVICE(_to) \
  ...
  NS_IMETHOD ShouldUseFlatpakPortal(bool *_retval) override { return _to ShouldUseFlatpakPortal(_retval); } 
...
#define NS_FORWARD_SAFE_NSIGIOSERVICE(_to) \
  ...
  NS_IMETHOD ShouldUseFlatpakPortal(bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ShouldUseFlatpakPortal(_retval); } 
