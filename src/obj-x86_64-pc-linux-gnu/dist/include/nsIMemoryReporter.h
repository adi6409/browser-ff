...
class NS_NO_VTABLE nsIHandleReportCallback : public nsISupports {
 public:
  ...
  using ScriptableInterfaceType = nsIHandleReportCallback;
...
class NS_NO_VTABLE nsIMemoryReporter : public nsISupports {
 public:
  ...
  /* Used by ToJSValue to check which scriptable interface is implemented. */
  using ScriptableInterfaceType = nsIMemoryReporter;
...
class NS_NO_VTABLE nsIFinishReportingCallback : public nsISupports {
 public:
  ...
  /* Used by ToJSValue to check which scriptable interface is implemented. */
  using ScriptableInterfaceType = nsIFinishReportingCallback;
...
class NS_NO_VTABLE nsIHeapAllocatedCallback : public nsISupports {
 public:
  ...
  /* Used by ToJSValue to check which scriptable interface is implemented. */
  using ScriptableInterfaceType = nsIHeapAllocatedCallback;
...
class NS_NO_VTABLE nsIMemoryReporterManager : public nsISupports {
 public:
  ...
  /* Used by ToJSValue to check which scriptable interface is implemented. */
  using ScriptableInterfaceType = nsIMemoryReporterManager;

  /* [must_use] void init (); */
  [[nodiscard]] NS_IMETHOD Init(void) = 0;
  ...
  [[nodiscard]] NS_IMETHOD GetVsize(int64_t *aVsize) = 0;

  /* [must_use] readonly attribute int64_t vsizeMaxContiguous; */
  [[nodiscard]] NS_IMETHOD GetVsizeMaxContiguous(int64_t *aVsizeMaxContiguous) = 0;

  /* [must_use] readonly attribute int64_t resident; */
  [[nodiscard]] NS_IMETHOD GetResident(int64_t *aResident) = 0;

  /* [must_use] readonly attribute int64_t residentFast; */
  [[nodiscard]] NS_IMETHOD GetResidentFast(int64_t *aResidentFast) = 0;

  /* [must_use] readonly attribute int64_t residentPeak; */
  [[nodiscard]] NS_IMETHOD GetResidentPeak(int64_t *aResidentPeak) = 0;

  /* [must_use] readonly attribute int64_t residentUnique; */
  [[nodiscard]] NS_IMETHOD GetResidentUnique(int64_t *aResidentUnique) = 0;

  /* [must_use] readonly attribute int64_t heapAllocated; */
  [[nodiscard]] NS_IMETHOD GetHeapAllocated(int64_t *aHeapAllocated) = 0;

  /* [must_use] readonly attribute int64_t heapOverheadFraction; */
  [[nodiscard]] NS_IMETHOD GetHeapOverheadFraction(int64_t *aHeapOverheadFraction) = 0;

  /* [must_use] readonly attribute int64_t JSMainRuntimeGCHeap; */
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeGCHeap(int64_t *aJSMainRuntimeGCHeap) = 0;

  /* [must_use] readonly attribute int64_t JSMainRuntimeTemporaryPeak; */
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeTemporaryPeak(int64_t *aJSMainRuntimeTemporaryPeak) = 0;

  /* [must_use] readonly attribute int64_t JSMainRuntimeCompartmentsSystem; */
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeCompartmentsSystem(int64_t *aJSMainRuntimeCompartmentsSystem) = 0;

  /* [must_use] readonly attribute int64_t JSMainRuntimeCompartmentsUser; */
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeCompartmentsUser(int64_t *aJSMainRuntimeCompartmentsUser) = 0;

  /* [must_use] readonly attribute int64_t JSMainRuntimeRealmsSystem; */
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeRealmsSystem(int64_t *aJSMainRuntimeRealmsSystem) = 0;

  /* [must_use] readonly attribute int64_t JSMainRuntimeRealmsUser; */
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeRealmsUser(int64_t *aJSMainRuntimeRealmsUser) = 0;

  /* [must_use] readonly attribute int64_t imagesContentUsedUncompressed; */
  [[nodiscard]] NS_IMETHOD GetImagesContentUsedUncompressed(int64_t *aImagesContentUsedUncompressed) = 0;

  /* [must_use] readonly attribute int64_t storageSQLite; */
  [[nodiscard]] NS_IMETHOD GetStorageSQLite(int64_t *aStorageSQLite) = 0;

  /* [must_use] readonly attribute int64_t lowMemoryEventsVirtual; */
  [[nodiscard]] NS_IMETHOD GetLowMemoryEventsVirtual(int64_t *aLowMemoryEventsVirtual) = 0;

  /* [must_use] readonly attribute int64_t lowMemoryEventsCommitSpace; */
  [[nodiscard]] NS_IMETHOD GetLowMemoryEventsCommitSpace(int64_t *aLowMemoryEventsCommitSpace) = 0;

  /* [must_use] readonly attribute int64_t lowMemoryEventsPhysical; */
  [[nodiscard]] NS_IMETHOD GetLowMemoryEventsPhysical(int64_t *aLowMemoryEventsPhysical) = 0;

  /* [must_use] readonly attribute int64_t ghostWindows; */
  [[nodiscard]] NS_IMETHOD GetGhostWindows(int64_t *aGhostWindows) = 0;

  /* [must_use] readonly attribute int64_t pageFaultsHard; */
  [[nodiscard]] NS_IMETHOD GetPageFaultsHard(int64_t *aPageFaultsHard) = 0;
  ...
  [[nodiscard]] NS_IMETHOD MinimizeMemoryUsage(nsIRunnable *callback) = 0;
  ...
  [[nodiscard]] NS_IMETHOD SizeOfTab(mozIDOMWindowProxy *window, int64_t *jsObjectsSize, int64_t *jsStringsSize, int64_t *jsOtherSize, int64_t *domSize, int64_t *styleSize, int64_t *otherSize, int64_t *totalSize, double *jsMilliseconds, double *nonJSMilliseconds) = 0;
...
#define NS_DECL_NSIMEMORYREPORTERMANAGER \
  [[nodiscard]] NS_IMETHOD Init(void) override; \
  ...
  [[nodiscard]] NS_IMETHOD GetVsize(int64_t *aVsize) override; \
  [[nodiscard]] NS_IMETHOD GetVsizeMaxContiguous(int64_t *aVsizeMaxContiguous) override; \
  [[nodiscard]] NS_IMETHOD GetResident(int64_t *aResident) override; \
  [[nodiscard]] NS_IMETHOD GetResidentFast(int64_t *aResidentFast) override; \
  [[nodiscard]] NS_IMETHOD GetResidentPeak(int64_t *aResidentPeak) override; \
  [[nodiscard]] NS_IMETHOD GetResidentUnique(int64_t *aResidentUnique) override; \
  [[nodiscard]] NS_IMETHOD GetHeapAllocated(int64_t *aHeapAllocated) override; \
  [[nodiscard]] NS_IMETHOD GetHeapOverheadFraction(int64_t *aHeapOverheadFraction) override; \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeGCHeap(int64_t *aJSMainRuntimeGCHeap) override; \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeTemporaryPeak(int64_t *aJSMainRuntimeTemporaryPeak) override; \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeCompartmentsSystem(int64_t *aJSMainRuntimeCompartmentsSystem) override; \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeCompartmentsUser(int64_t *aJSMainRuntimeCompartmentsUser) override; \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeRealmsSystem(int64_t *aJSMainRuntimeRealmsSystem) override; \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeRealmsUser(int64_t *aJSMainRuntimeRealmsUser) override; \
  [[nodiscard]] NS_IMETHOD GetImagesContentUsedUncompressed(int64_t *aImagesContentUsedUncompressed) override; \
  [[nodiscard]] NS_IMETHOD GetStorageSQLite(int64_t *aStorageSQLite) override; \
  [[nodiscard]] NS_IMETHOD GetLowMemoryEventsVirtual(int64_t *aLowMemoryEventsVirtual) override; \
  [[nodiscard]] NS_IMETHOD GetLowMemoryEventsCommitSpace(int64_t *aLowMemoryEventsCommitSpace) override; \
  [[nodiscard]] NS_IMETHOD GetLowMemoryEventsPhysical(int64_t *aLowMemoryEventsPhysical) override; \
  [[nodiscard]] NS_IMETHOD GetGhostWindows(int64_t *aGhostWindows) override; \
  [[nodiscard]] NS_IMETHOD GetPageFaultsHard(int64_t *aPageFaultsHard) override; \
  ...
  [[nodiscard]] NS_IMETHOD MinimizeMemoryUsage(nsIRunnable *callback) override; \
  [[nodiscard]] NS_IMETHOD SizeOfTab(mozIDOMWindowProxy *window, int64_t *jsObjectsSize, int64_t *jsStringsSize, int64_t *jsOtherSize, int64_t *domSize, int64_t *styleSize, int64_t *otherSize, int64_t *totalSize, double *jsMilliseconds, double *nonJSMilliseconds) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIMEMORYREPORTERMANAGER \
  [[nodiscard]] nsresult Init(void); \
  ...
  [[nodiscard]] nsresult GetVsize(int64_t *aVsize); \
  [[nodiscard]] nsresult GetVsizeMaxContiguous(int64_t *aVsizeMaxContiguous); \
  [[nodiscard]] nsresult GetResident(int64_t *aResident); \
  [[nodiscard]] nsresult GetResidentFast(int64_t *aResidentFast); \
  [[nodiscard]] nsresult GetResidentPeak(int64_t *aResidentPeak); \
  [[nodiscard]] nsresult GetResidentUnique(int64_t *aResidentUnique); \
  [[nodiscard]] nsresult GetHeapAllocated(int64_t *aHeapAllocated); \
  [[nodiscard]] nsresult GetHeapOverheadFraction(int64_t *aHeapOverheadFraction); \
  [[nodiscard]] nsresult GetJSMainRuntimeGCHeap(int64_t *aJSMainRuntimeGCHeap); \
  [[nodiscard]] nsresult GetJSMainRuntimeTemporaryPeak(int64_t *aJSMainRuntimeTemporaryPeak); \
  [[nodiscard]] nsresult GetJSMainRuntimeCompartmentsSystem(int64_t *aJSMainRuntimeCompartmentsSystem); \
  [[nodiscard]] nsresult GetJSMainRuntimeCompartmentsUser(int64_t *aJSMainRuntimeCompartmentsUser); \
  [[nodiscard]] nsresult GetJSMainRuntimeRealmsSystem(int64_t *aJSMainRuntimeRealmsSystem); \
  [[nodiscard]] nsresult GetJSMainRuntimeRealmsUser(int64_t *aJSMainRuntimeRealmsUser); \
  [[nodiscard]] nsresult GetImagesContentUsedUncompressed(int64_t *aImagesContentUsedUncompressed); \
  [[nodiscard]] nsresult GetStorageSQLite(int64_t *aStorageSQLite); \
  [[nodiscard]] nsresult GetLowMemoryEventsVirtual(int64_t *aLowMemoryEventsVirtual); \
  [[nodiscard]] nsresult GetLowMemoryEventsCommitSpace(int64_t *aLowMemoryEventsCommitSpace); \
  [[nodiscard]] nsresult GetLowMemoryEventsPhysical(int64_t *aLowMemoryEventsPhysical); \
  [[nodiscard]] nsresult GetGhostWindows(int64_t *aGhostWindows); \
  [[nodiscard]] nsresult GetPageFaultsHard(int64_t *aPageFaultsHard); \
  using nsIMemoryReporterManager::GetHasMozMallocUsableSize; \
  ...
  [[nodiscard]] nsresult MinimizeMemoryUsage(nsIRunnable *callback); \
  [[nodiscard]] nsresult SizeOfTab(mozIDOMWindowProxy *window, int64_t *jsObjectsSize, int64_t *jsStringsSize, int64_t *jsOtherSize, int64_t *domSize, int64_t *styleSize, int64_t *otherSize, int64_t *totalSize, double *jsMilliseconds, double *nonJSMilliseconds); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIMEMORYREPORTERMANAGER(_to) \
  [[nodiscard]] NS_IMETHOD Init(void) override { return _to Init(); } \
  ...
  [[nodiscard]] NS_IMETHOD GetVsize(int64_t *aVsize) override { return _to GetVsize(aVsize); } \
  [[nodiscard]] NS_IMETHOD GetVsizeMaxContiguous(int64_t *aVsizeMaxContiguous) override { return _to GetVsizeMaxContiguous(aVsizeMaxContiguous); } \
  [[nodiscard]] NS_IMETHOD GetResident(int64_t *aResident) override { return _to GetResident(aResident); } \
  [[nodiscard]] NS_IMETHOD GetResidentFast(int64_t *aResidentFast) override { return _to GetResidentFast(aResidentFast); } \
  [[nodiscard]] NS_IMETHOD GetResidentPeak(int64_t *aResidentPeak) override { return _to GetResidentPeak(aResidentPeak); } \
  [[nodiscard]] NS_IMETHOD GetResidentUnique(int64_t *aResidentUnique) override { return _to GetResidentUnique(aResidentUnique); } \
  [[nodiscard]] NS_IMETHOD GetHeapAllocated(int64_t *aHeapAllocated) override { return _to GetHeapAllocated(aHeapAllocated); } \
  [[nodiscard]] NS_IMETHOD GetHeapOverheadFraction(int64_t *aHeapOverheadFraction) override { return _to GetHeapOverheadFraction(aHeapOverheadFraction); } \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeGCHeap(int64_t *aJSMainRuntimeGCHeap) override { return _to GetJSMainRuntimeGCHeap(aJSMainRuntimeGCHeap); } \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeTemporaryPeak(int64_t *aJSMainRuntimeTemporaryPeak) override { return _to GetJSMainRuntimeTemporaryPeak(aJSMainRuntimeTemporaryPeak); } \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeCompartmentsSystem(int64_t *aJSMainRuntimeCompartmentsSystem) override { return _to GetJSMainRuntimeCompartmentsSystem(aJSMainRuntimeCompartmentsSystem); } \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeCompartmentsUser(int64_t *aJSMainRuntimeCompartmentsUser) override { return _to GetJSMainRuntimeCompartmentsUser(aJSMainRuntimeCompartmentsUser); } \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeRealmsSystem(int64_t *aJSMainRuntimeRealmsSystem) override { return _to GetJSMainRuntimeRealmsSystem(aJSMainRuntimeRealmsSystem); } \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeRealmsUser(int64_t *aJSMainRuntimeRealmsUser) override { return _to GetJSMainRuntimeRealmsUser(aJSMainRuntimeRealmsUser); } \
  [[nodiscard]] NS_IMETHOD GetImagesContentUsedUncompressed(int64_t *aImagesContentUsedUncompressed) override { return _to GetImagesContentUsedUncompressed(aImagesContentUsedUncompressed); } \
  [[nodiscard]] NS_IMETHOD GetStorageSQLite(int64_t *aStorageSQLite) override { return _to GetStorageSQLite(aStorageSQLite); } \
  [[nodiscard]] NS_IMETHOD GetLowMemoryEventsVirtual(int64_t *aLowMemoryEventsVirtual) override { return _to GetLowMemoryEventsVirtual(aLowMemoryEventsVirtual); } \
  [[nodiscard]] NS_IMETHOD GetLowMemoryEventsCommitSpace(int64_t *aLowMemoryEventsCommitSpace) override { return _to GetLowMemoryEventsCommitSpace(aLowMemoryEventsCommitSpace); } \
  [[nodiscard]] NS_IMETHOD GetLowMemoryEventsPhysical(int64_t *aLowMemoryEventsPhysical) override { return _to GetLowMemoryEventsPhysical(aLowMemoryEventsPhysical); } \
  [[nodiscard]] NS_IMETHOD GetGhostWindows(int64_t *aGhostWindows) override { return _to GetGhostWindows(aGhostWindows); } \
  [[nodiscard]] NS_IMETHOD GetPageFaultsHard(int64_t *aPageFaultsHard) override { return _to GetPageFaultsHard(aPageFaultsHard); } \
  using nsIMemoryReporterManager::GetHasMozMallocUsableSize; \
  ...
  [[nodiscard]] NS_IMETHOD MinimizeMemoryUsage(nsIRunnable *callback) override { return _to MinimizeMemoryUsage(callback); } \
  [[nodiscard]] NS_IMETHOD SizeOfTab(mozIDOMWindowProxy *window, int64_t *jsObjectsSize, int64_t *jsStringsSize, int64_t *jsOtherSize, int64_t *domSize, int64_t *styleSize, int64_t *otherSize, int64_t *totalSize, double *jsMilliseconds, double *nonJSMilliseconds) override { return _to SizeOfTab(window, jsObjectsSize, jsStringsSize, jsOtherSize, domSize, styleSize, otherSize, totalSize, jsMilliseconds, nonJSMilliseconds); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIMEMORYREPORTERMANAGER(_to) \
  [[nodiscard]] NS_IMETHOD Init(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(); } \
  ...
  [[nodiscard]] NS_IMETHOD GetVsize(int64_t *aVsize) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetVsize(aVsize); } \
  [[nodiscard]] NS_IMETHOD GetVsizeMaxContiguous(int64_t *aVsizeMaxContiguous) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetVsizeMaxContiguous(aVsizeMaxContiguous); } \
  [[nodiscard]] NS_IMETHOD GetResident(int64_t *aResident) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetResident(aResident); } \
  [[nodiscard]] NS_IMETHOD GetResidentFast(int64_t *aResidentFast) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetResidentFast(aResidentFast); } \
  [[nodiscard]] NS_IMETHOD GetResidentPeak(int64_t *aResidentPeak) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetResidentPeak(aResidentPeak); } \
  [[nodiscard]] NS_IMETHOD GetResidentUnique(int64_t *aResidentUnique) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetResidentUnique(aResidentUnique); } \
  [[nodiscard]] NS_IMETHOD GetHeapAllocated(int64_t *aHeapAllocated) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHeapAllocated(aHeapAllocated); } \
  [[nodiscard]] NS_IMETHOD GetHeapOverheadFraction(int64_t *aHeapOverheadFraction) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHeapOverheadFraction(aHeapOverheadFraction); } \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeGCHeap(int64_t *aJSMainRuntimeGCHeap) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJSMainRuntimeGCHeap(aJSMainRuntimeGCHeap); } \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeTemporaryPeak(int64_t *aJSMainRuntimeTemporaryPeak) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJSMainRuntimeTemporaryPeak(aJSMainRuntimeTemporaryPeak); } \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeCompartmentsSystem(int64_t *aJSMainRuntimeCompartmentsSystem) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJSMainRuntimeCompartmentsSystem(aJSMainRuntimeCompartmentsSystem); } \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeCompartmentsUser(int64_t *aJSMainRuntimeCompartmentsUser) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJSMainRuntimeCompartmentsUser(aJSMainRuntimeCompartmentsUser); } \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeRealmsSystem(int64_t *aJSMainRuntimeRealmsSystem) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJSMainRuntimeRealmsSystem(aJSMainRuntimeRealmsSystem); } \
  [[nodiscard]] NS_IMETHOD GetJSMainRuntimeRealmsUser(int64_t *aJSMainRuntimeRealmsUser) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJSMainRuntimeRealmsUser(aJSMainRuntimeRealmsUser); } \
  [[nodiscard]] NS_IMETHOD GetImagesContentUsedUncompressed(int64_t *aImagesContentUsedUncompressed) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetImagesContentUsedUncompressed(aImagesContentUsedUncompressed); } \
  [[nodiscard]] NS_IMETHOD GetStorageSQLite(int64_t *aStorageSQLite) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStorageSQLite(aStorageSQLite); } \
  [[nodiscard]] NS_IMETHOD GetLowMemoryEventsVirtual(int64_t *aLowMemoryEventsVirtual) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLowMemoryEventsVirtual(aLowMemoryEventsVirtual); } \
  [[nodiscard]] NS_IMETHOD GetLowMemoryEventsCommitSpace(int64_t *aLowMemoryEventsCommitSpace) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLowMemoryEventsCommitSpace(aLowMemoryEventsCommitSpace); } \
  [[nodiscard]] NS_IMETHOD GetLowMemoryEventsPhysical(int64_t *aLowMemoryEventsPhysical) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLowMemoryEventsPhysical(aLowMemoryEventsPhysical); } \
  [[nodiscard]] NS_IMETHOD GetGhostWindows(int64_t *aGhostWindows) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetGhostWindows(aGhostWindows); } \
  [[nodiscard]] NS_IMETHOD GetPageFaultsHard(int64_t *aPageFaultsHard) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPageFaultsHard(aPageFaultsHard); } \
  ...
  [[nodiscard]] NS_IMETHOD MinimizeMemoryUsage(nsIRunnable *callback) override { return !_to ? NS_ERROR_NULL_POINTER : _to->MinimizeMemoryUsage(callback); } \
  [[nodiscard]] NS_IMETHOD SizeOfTab(mozIDOMWindowProxy *window, int64_t *jsObjectsSize, int64_t *jsStringsSize, int64_t *jsOtherSize, int64_t *domSize, int64_t *styleSize, int64_t *otherSize, int64_t *totalSize, double *jsMilliseconds, double *nonJSMilliseconds) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SizeOfTab(window, jsObjectsSize, jsStringsSize, jsOtherSize, domSize, styleSize, otherSize, totalSize, jsMilliseconds, nonJSMilliseconds); } 
