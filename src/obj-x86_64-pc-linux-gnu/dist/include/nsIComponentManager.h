...
class NS_NO_VTABLE nsIComponentManager : public nsISupports {
 public:
  ...
  using ScriptableInterfaceType = nsIComponentManager;

  /* void getClassObject (in nsCIDRef aClass, in nsIIDRef aIID, [iid_is (aIID), retval] out nsQIResult result); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetClassObject(const nsCID & aClass, const nsIID & aIID, void * * result) = 0;

  /* void getClassObjectByContractID (in string aContractID, in nsIIDRef aIID, [iid_is (aIID), retval] out nsQIResult result); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetClassObjectByContractID(const char * aContractID, const nsIID & aIID, void * * result) = 0;
  ...
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD CreateInstance(const nsCID & aClass, nsISupports *aDelegate, const nsIID & aIID, void * * result) = 0;
  ...
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD CreateInstanceByContractID(const char * aContractID, nsISupports *aDelegate, const nsIID & aIID, void * * result) = 0;

  /* void addBootstrappedManifestLocation (in nsIFile aLocation); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD AddBootstrappedManifestLocation(nsIFile *aLocation) = 0;

  /* void removeBootstrappedManifestLocation (in nsIFile aLocation); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD RemoveBootstrappedManifestLocation(nsIFile *aLocation) = 0;

  /* nsIArray getManifestLocations (); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetManifestLocations(nsIArray **_retval) = 0;

  /* nsIUTF8StringEnumerator getComponentJSMs (); */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetComponentJSMs(nsIUTF8StringEnumerator **_retval) = 0;
...
#define NS_DECL_NSICOMPONENTMANAGER \
  ...
  NS_IMETHOD GetComponentJSMs(nsIUTF8StringEnumerator **_retval) override; 
...
#define NS_DECL_NON_VIRTUAL_NSICOMPONENTMANAGER \
  ...
  nsresult GetComponentJSMs(nsIUTF8StringEnumerator **_retval); 
...
#define NS_FORWARD_NSICOMPONENTMANAGER(_to) \
  ...
  NS_IMETHOD GetComponentJSMs(nsIUTF8StringEnumerator **_retval) override { return _to GetComponentJSMs(_retval); } 
...
#define NS_FORWARD_SAFE_NSICOMPONENTMANAGER(_to) \
  ...
  NS_IMETHOD GetComponentJSMs(nsIUTF8StringEnumerator **_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetComponentJSMs(_retval); } 
