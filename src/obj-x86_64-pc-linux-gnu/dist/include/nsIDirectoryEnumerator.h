...
class NS_NO_VTABLE nsIDirectoryEnumerator : public nsISimpleEnumerator {
 public:

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDIRECTORYENUMERATOR_IID)

  /* Used by ToJSValue to check which scriptable interface is implemented. */
  using ScriptableInterfaceType = nsIDirectoryEnumerator;

  /* readonly attribute nsIFile nextFile; */
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetNextFile(nsIFile **aNextFile) = 0;
