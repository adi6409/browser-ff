...
class NS_NO_VTABLE nsIThreadPool : public nsIEventTarget {
 public:
  ...
  NS_IMETHOD ShutdownWithTimeout(int32_t aTimeoutMs) = 0;
  ...
  NS_IMETHOD GetIdleThreadTimeoutRegressive(bool *aIdleThreadTimeoutRegressive) = 0;
  NS_IMETHOD SetIdleThreadTimeoutRegressive(bool aIdleThreadTimeoutRegressive) = 0;
...
#define NS_DECL_NSITHREADPOOL \
  ...
  NS_IMETHOD ShutdownWithTimeout(int32_t aTimeoutMs) override; \
  ...
  NS_IMETHOD GetIdleThreadTimeoutRegressive(bool *aIdleThreadTimeoutRegressive) override; \
  NS_IMETHOD SetIdleThreadTimeoutRegressive(bool aIdleThreadTimeoutRegressive) override; \
...
#define NS_DECL_NON_VIRTUAL_NSITHREADPOOL \
  ...
  nsresult ShutdownWithTimeout(int32_t aTimeoutMs); \
  ...
  nsresult GetIdleThreadTimeoutRegressive(bool *aIdleThreadTimeoutRegressive); \
  nsresult SetIdleThreadTimeoutRegressive(bool aIdleThreadTimeoutRegressive); \
...
#define NS_FORWARD_NSITHREADPOOL(_to) \
  ...
  NS_IMETHOD ShutdownWithTimeout(int32_t aTimeoutMs) override { return _to ShutdownWithTimeout(aTimeoutMs); } \
  ...
  NS_IMETHOD GetIdleThreadTimeoutRegressive(bool *aIdleThreadTimeoutRegressive) override { return _to GetIdleThreadTimeoutRegressive(aIdleThreadTimeoutRegressive); } \
  NS_IMETHOD SetIdleThreadTimeoutRegressive(bool aIdleThreadTimeoutRegressive) override { return _to SetIdleThreadTimeoutRegressive(aIdleThreadTimeoutRegressive); } \
...
#define NS_FORWARD_SAFE_NSITHREADPOOL(_to) \
  ...
  NS_IMETHOD ShutdownWithTimeout(int32_t aTimeoutMs) override { return !_to ? NS_ERROR_NULL_POINTER : _to->ShutdownWithTimeout(aTimeoutMs); } \
  ...
  NS_IMETHOD GetIdleThreadTimeoutRegressive(bool *aIdleThreadTimeoutRegressive) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIdleThreadTimeoutRegressive(aIdleThreadTimeoutRegressive); } \
  NS_IMETHOD SetIdleThreadTimeoutRegressive(bool aIdleThreadTimeoutRegressive) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIdleThreadTimeoutRegressive(aIdleThreadTimeoutRegressive); } \
