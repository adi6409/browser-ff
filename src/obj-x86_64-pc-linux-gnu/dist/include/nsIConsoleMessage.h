...
class NS_NO_VTABLE nsIConsoleMessage : public nsISupports {
 public:
  ...
  using ScriptableInterfaceType = nsIConsoleMessage;
  ...
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetLogLevel(uint32_t *aLogLevel) = 0;
  ...
  JS_HAZ_CAN_RUN_SCRIPT NS_IMETHOD GetMessageMoz(nsAString& aMessage) = 0;
...
#define NS_DECL_NSICONSOLEMESSAGE \
  ...
  NS_IMETHOD GetMessageMoz(nsAString& aMessage) override; \
...
#define NS_DECL_NON_VIRTUAL_NSICONSOLEMESSAGE \
  ...
  nsresult GetMessageMoz(nsAString& aMessage); \
...
#define NS_FORWARD_NSICONSOLEMESSAGE(_to) \
  ...
  NS_IMETHOD GetMessageMoz(nsAString& aMessage) override { return _to GetMessageMoz(aMessage); } \
...
#define NS_FORWARD_SAFE_NSICONSOLEMESSAGE(_to) \
  ...
  NS_IMETHOD GetMessageMoz(nsAString& aMessage) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMessageMoz(aMessage); } \
