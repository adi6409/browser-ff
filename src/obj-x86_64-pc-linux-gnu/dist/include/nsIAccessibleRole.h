...
class NS_NO_VTABLE nsIAccessibleRole : public nsISupports {
 public:
  ...
  enum {
    ...
    ROLE_SUMMARY = 168U,
    ROLE_LANDMARK = 169U,
    ROLE_NAVIGATION = 170U,
    ROLE_FOOTNOTE = 171U,
    ROLE_ARTICLE = 172U,
    ROLE_REGION = 173U,
    ROLE_EDITCOMBOBOX = 174U,
    ROLE_BLOCKQUOTE = 175U,
    ROLE_CONTENT_DELETION = 176U,
    ROLE_CONTENT_INSERTION = 177U,
    ROLE_FORM_LANDMARK = 178U,
    ROLE_MARK = 179U,
    ROLE_SUGGESTION = 180U,
    ROLE_COMMENT = 181U,
    ROLE_CODE = 182U,
    ROLE_TIME_EDITOR = 183U,
    ROLE_LISTITEM_MARKER = 184U,
    ROLE_METER = 185U
  };
