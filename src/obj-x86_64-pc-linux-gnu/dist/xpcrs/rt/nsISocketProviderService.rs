...
// method for nsISocketProviderService.
unsafe impl XpCom for nsISocketProviderService {
    const IID: nsIID = nsID(0x8f8a23d0, 0x5472, 0x11d3,
...
// This trait is implemented on all types which can be coerced to from nsISocketProviderService.
// It is used in the implementation of `fn coerce<T>`. We hide it from the
// documentation, because it clutters it up a lot.
#[doc(hidden)]
pub trait nsISocketProviderServiceCoerce {
    /// Cheaply cast a value of this type from a `nsISocketProviderService`.
...
impl nsISocketProviderService {
    /// Cast this `nsISocketProviderService` to one of its base interfaces.
    #[inline]
...
// allocated version of this struct is at the beginning of every nsISocketProviderService
...
pub struct nsISocketProviderServiceVTable {
    ...
    pub GetSocketProvider: unsafe extern "system" fn (this: *const nsISocketProviderService, socketType: *const libc::c_char, _retval: *mut*const nsISocketProvider) -> ::nserror::nsresult,
}
...
impl nsISocketProviderService {
    ...
    /// `nsISocketProvider getSocketProvider (in string socketType);`
    #[inline]
    pub unsafe fn GetSocketProvider(&self, socketType: *const libc::c_char, _retval: *mut*const nsISocketProvider) -> ::nserror::nsresult {
        ((*self.vtable).GetSocketProvider)(self, socketType, _retval)
    }
