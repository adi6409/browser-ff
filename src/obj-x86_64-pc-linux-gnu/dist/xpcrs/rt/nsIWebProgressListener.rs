...
pub struct nsIWebProgressListenerVTable {
    ...
    pub OnStatusChange: unsafe extern "system" fn (this: *const nsIWebProgressListener, aWebProgress: *const nsIWebProgress, aRequest: *const nsIRequest, aStatus: ::nserror::nsresult, aMessage: *const i16) -> ::nserror::nsresult,
...
impl nsIWebProgressListener {
    ...
    pub const STATE_LOADED_LEVEL_1_TRACKING_CONTENT: i64 = 8192;


    pub const STATE_LOADED_LEVEL_2_TRACKING_CONTENT: i64 = 1048576;


    pub const STATE_BLOCKED_FINGERPRINTING_CONTENT: i64 = 64;


    pub const STATE_LOADED_FINGERPRINTING_CONTENT: i64 = 1024;


    pub const STATE_BLOCKED_CRYPTOMINING_CONTENT: i64 = 2048;


    pub const STATE_LOADED_CRYPTOMINING_CONTENT: i64 = 2097152;


    pub const STATE_BLOCKED_UNSAFE_CONTENT: i64 = 16384;


    pub const STATE_COOKIES_LOADED: i64 = 32768;


    pub const STATE_COOKIES_LOADED_TRACKER: i64 = 262144;


    pub const STATE_COOKIES_LOADED_SOCIALTRACKER: i64 = 524288;


    pub const STATE_COOKIES_BLOCKED_BY_PERMISSION: i64 = 268435456;


    pub const STATE_COOKIES_BLOCKED_TRACKER: i64 = 536870912;


    pub const STATE_COOKIES_BLOCKED_SOCIALTRACKER: i64 = 16777216;


    pub const STATE_COOKIES_BLOCKED_ALL: i64 = 1073741824;


    pub const STATE_COOKIES_PARTITIONED_FOREIGN: i64 = 2147483648;


    pub const STATE_COOKIES_BLOCKED_FOREIGN: i64 = 128;


    pub const STATE_BLOCKED_SOCIALTRACKING_CONTENT: i64 = 65536;


    pub const STATE_LOADED_SOCIALTRACKING_CONTENT: i64 = 131072;


    pub const STATE_UNBLOCKED_TRACKING_CONTENT: i64 = 16;
    ...
    pub const STATE_HTTPS_ONLY_MODE_UPGRADED: i64 = 4194304;


    pub const STATE_HTTPS_ONLY_MODE_UPGRADE_FAILED: i64 = 8388608;
    ...
    pub const LOCATION_CHANGE_RELOAD: i64 = 4;
    ...
    /// `void onStatusChange (in nsIWebProgress aWebProgress, in nsIRequest aRequest, in nsresult aStatus, in wstring aMessage);`
    #[inline]
    pub unsafe fn OnStatusChange(&self, aWebProgress: *const nsIWebProgress, aRequest: *const nsIRequest, aStatus: ::nserror::nsresult, aMessage: *const i16) -> ::nserror::nsresult {
