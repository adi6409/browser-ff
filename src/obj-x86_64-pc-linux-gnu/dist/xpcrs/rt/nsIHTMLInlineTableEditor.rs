...
pub struct nsIHTMLInlineTableEditorVTable {
    ...
    pub GetInlineTableEditingEnabled: unsafe extern "system" fn (this: *const nsIHTMLInlineTableEditor, aInlineTableEditingEnabled: *mut bool) -> ::nserror::nsresult,

    /* [can_run_script] attribute boolean inlineTableEditingEnabled; */
    pub SetInlineTableEditingEnabled: unsafe extern "system" fn (this: *const nsIHTMLInlineTableEditor, aInlineTableEditingEnabled: bool) -> ::nserror::nsresult,

    /* [can_run_script] void refreshInlineTableEditingUI (); */
    pub RefreshInlineTableEditingUI: unsafe extern "system" fn (this: *const nsIHTMLInlineTableEditor) -> ::nserror::nsresult,
}
...
impl nsIHTMLInlineTableEditor {
    ...
    /// `[can_run_script] attribute boolean inlineTableEditingEnabled;`
    #[inline]
    pub unsafe fn GetInlineTableEditingEnabled(&self, aInlineTableEditingEnabled: *mut bool) -> ::nserror::nsresult {
    ...
    /// `[can_run_script] attribute boolean inlineTableEditingEnabled;`
    #[inline]
    pub unsafe fn SetInlineTableEditingEnabled(&self, aInlineTableEditingEnabled: bool) -> ::nserror::nsresult {
    ...
    /// `[can_run_script] void refreshInlineTableEditingUI ();`
    #[inline]
    pub unsafe fn RefreshInlineTableEditingUI(&self, ) -> ::nserror::nsresult {
