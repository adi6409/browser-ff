...
pub struct nsIMultiplexInputStreamVTable {
    ...
    pub GetCount: unsafe extern "system" fn (this: *const nsIMultiplexInputStream, aCount: *mut u32) -> ::nserror::nsresult,

    /* void appendStream (in nsIInputStream stream); */
    pub AppendStream: unsafe extern "system" fn (this: *const nsIMultiplexInputStream, stream: *const nsIInputStream) -> ::nserror::nsresult,

    /* nsIInputStream getStream (in unsigned long index); */
    pub GetStream: unsafe extern "system" fn (this: *const nsIMultiplexInputStream, index: u32, _retval: *mut *const nsIInputStream) -> ::nserror::nsresult,
}
...
impl nsIMultiplexInputStream {
    ...
    /// `readonly attribute unsigned long count;`
    #[inline]
    pub unsafe fn GetCount(&self, aCount: *mut u32) -> ::nserror::nsresult {
    ...
    /// `void appendStream (in nsIInputStream stream);`
    #[inline]
    pub unsafe fn AppendStream(&self, stream: *const nsIInputStream) -> ::nserror::nsresult {
    ...
    /// `nsIInputStream getStream (in unsigned long index);`
    #[inline]
    pub unsafe fn GetStream(&self, index: u32, _retval: *mut *const nsIInputStream) -> ::nserror::nsresult {
