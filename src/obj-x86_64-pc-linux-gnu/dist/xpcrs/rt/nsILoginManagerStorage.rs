...
// method for nsILoginManagerStorage.
unsafe impl XpCom for nsILoginManagerStorage {
    const IID: nsIID = nsID(0x5df81a93, 0x25e6, 0x4b45,
...
// This trait is implemented on all types which can be coerced to from nsILoginManagerStorage.
// It is used in the implementation of `fn coerce<T>`. We hide it from the
// documentation, because it clutters it up a lot.
#[doc(hidden)]
pub trait nsILoginManagerStorageCoerce {
    /// Cheaply cast a value of this type from a `nsILoginManagerStorage`.
...
impl nsILoginManagerStorage {
    /// Cast this `nsILoginManagerStorage` to one of its base interfaces.
    #[inline]
...
// allocated version of this struct is at the beginning of every nsILoginManagerStorage
...
pub struct nsILoginManagerStorageVTable {
    ...
    pub AddLogin: *const ::libc::c_void,

    /* void removeLogin (in nsILoginInfo aLogin); */
    pub RemoveLogin: unsafe extern "system" fn (this: *const nsILoginManagerStorage, aLogin: *const nsILoginInfo) -> ::nserror::nsresult,

    /* void modifyLogin (in nsILoginInfo oldLogin, in nsISupports newLoginData); */
    pub ModifyLogin: unsafe extern "system" fn (this: *const nsILoginManagerStorage, oldLogin: *const nsILoginInfo, newLoginData: *const nsISupports) -> ::nserror::nsresult,

    /* void recordPasswordUse (in nsILoginInfo aLogin); */
    pub RecordPasswordUse: unsafe extern "system" fn (this: *const nsILoginManagerStorage, aLogin: *const nsILoginInfo) -> ::nserror::nsresult,

    /* void removeAllUserFacingLogins (); */
    pub RemoveAllUserFacingLogins: unsafe extern "system" fn (this: *const nsILoginManagerStorage) -> ::nserror::nsresult,

    /* void removeAllLogins (); */
    pub RemoveAllLogins: unsafe extern "system" fn (this: *const nsILoginManagerStorage) -> ::nserror::nsresult,

    /* Array<nsILoginInfo> getAllLogins (); */
    pub GetAllLogins: unsafe extern "system" fn (this: *const nsILoginManagerStorage, _retval: *mut thin_vec::ThinVec<RefPtr<nsILoginInfo>>) -> ::nserror::nsresult,
    ...
    pub SearchLogins: unsafe extern "system" fn (this: *const nsILoginManagerStorage, matchData: *const nsIPropertyBag, _retval: *mut thin_vec::ThinVec<RefPtr<nsILoginInfo>>) -> ::nserror::nsresult,

    /* Array<nsILoginInfo> findLogins (in AString aOrigin, in AString aActionOrigin, in AString aHttpRealm); */
    pub FindLogins: unsafe extern "system" fn (this: *const nsILoginManagerStorage, aOrigin: *const ::nsstring::nsAString, aActionOrigin: *const ::nsstring::nsAString, aHttpRealm: *const ::nsstring::nsAString, _retval: *mut thin_vec::ThinVec<RefPtr<nsILoginInfo>>) -> ::nserror::nsresult,

    /* unsigned long countLogins (in AString aOrigin, in AString aActionOrigin, in AString aHttpRealm); */
    pub CountLogins: unsafe extern "system" fn (this: *const nsILoginManagerStorage, aOrigin: *const ::nsstring::nsAString, aActionOrigin: *const ::nsstring::nsAString, aHttpRealm: *const ::nsstring::nsAString, _retval: *mut u32) -> ::nserror::nsresult,
    ...
    pub GetUiBusy: unsafe extern "system" fn (this: *const nsILoginManagerStorage, aUiBusy: *mut bool) -> ::nserror::nsresult,

    /* readonly attribute boolean isLoggedIn; */
    pub GetIsLoggedIn: unsafe extern "system" fn (this: *const nsILoginManagerStorage, aIsLoggedIn: *mut bool) -> ::nserror::nsresult,
}
...
impl nsILoginManagerStorage {
    ...
    /// `void recordPasswordUse (in nsILoginInfo aLogin);`
    #[inline]
    pub unsafe fn RecordPasswordUse(&self, aLogin: *const nsILoginInfo) -> ::nserror::nsresult {
        ((*self.vtable).RecordPasswordUse)(self, aLogin)
    }
