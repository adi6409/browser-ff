...
// method for mozIStorageAsyncStatement.
unsafe impl XpCom for mozIStorageAsyncStatement {
    const IID: nsIID = nsID(0x52e49370, 0x3b2e, 0x4a27,
...
// This trait is implemented on all types which can be coerced to from mozIStorageAsyncStatement.
// It is used in the implementation of `fn coerce<T>`. We hide it from the
// documentation, because it clutters it up a lot.
#[doc(hidden)]
pub trait mozIStorageAsyncStatementCoerce {
    /// Cheaply cast a value of this type from a `mozIStorageAsyncStatement`.
...
// allocated version of this struct is at the beginning of every mozIStorageAsyncStatement
