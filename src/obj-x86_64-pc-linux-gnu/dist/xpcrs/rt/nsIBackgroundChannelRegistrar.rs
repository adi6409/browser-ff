...
pub struct nsIBackgroundChannelRegistrarVTable {
    ...
    /// Unable to generate binding because `native type mozilla::net::HttpChannelParent unsupported`
    ...
    /// Unable to generate binding because `native type mozilla::net::HttpBackgroundChannelParent unsupported`
