...
pub struct nsIUrlClassifierBlockedChannel {
    vtable: *const nsIUrlClassifierBlockedChannelVTable,
...
pub struct nsIUrlClassifierBlockedChannelVTable {
    ...
    pub GetReason: unsafe extern "system" fn (this: *const nsIUrlClassifierBlockedChannel, aReason: *mut uint8_t) -> ::nserror::nsresult,
    ...
    pub GetTabId: unsafe extern "system" fn (this: *const nsIUrlClassifierBlockedChannel, aTabId: *mut uint64_t) -> ::nserror::nsresult,

    /* readonly attribute uint64_t channelId; */
    pub GetChannelId: unsafe extern "system" fn (this: *const nsIUrlClassifierBlockedChannel, aChannelId: *mut uint64_t) -> ::nserror::nsresult,
    ...
    /* void unblock (); */
    pub Unblock: unsafe extern "system" fn (this: *const nsIUrlClassifierBlockedChannel) -> ::nserror::nsresult,
...
impl nsIUrlClassifierBlockedChannel {
    ...
    pub const TRACKING_PROTECTION: i64 = 0;


    pub const SOCIAL_TRACKING_PROTECTION: i64 = 1;


    pub const FINGERPRINTING_PROTECTION: i64 = 2;


    pub const CRYPTOMINING_PROTECTION: i64 = 3;


    /// `readonly attribute uint8_t reason;`
    #[inline]
    pub unsafe fn GetReason(&self, aReason: *mut uint8_t) -> ::nserror::nsresult {
    ...
    /// `void unblock ();`
    #[inline]
    pub unsafe fn Unblock(&self, ) -> ::nserror::nsresult {
        ((*self.vtable).Unblock)(self, )
    }
...
pub struct nsIChannelClassifierService {
    vtable: *const nsIChannelClassifierServiceVTable,
