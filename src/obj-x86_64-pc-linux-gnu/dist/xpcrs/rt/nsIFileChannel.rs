...
// method for nsIFileChannel.
unsafe impl XpCom for nsIFileChannel {
    const IID: nsIID = nsID(0x06169120, 0x136d, 0x45a5,
...
// This trait is implemented on all types which can be coerced to from nsIFileChannel.
// It is used in the implementation of `fn coerce<T>`. We hide it from the
// documentation, because it clutters it up a lot.
#[doc(hidden)]
pub trait nsIFileChannelCoerce {
    /// Cheaply cast a value of this type from a `nsIFileChannel`.
...
impl nsIFileChannel {
    /// Cast this `nsIFileChannel` to one of its base interfaces.
    #[inline]
...
// allocated version of this struct is at the beginning of every nsIFileChannel
...
pub struct nsIFileChannelVTable {
    ...
    pub GetFile: unsafe extern "system" fn (this: *const nsIFileChannel, aFile: *mut*const nsIFile) -> ::nserror::nsresult,
}
