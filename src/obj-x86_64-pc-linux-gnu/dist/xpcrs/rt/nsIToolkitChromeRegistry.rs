...
pub struct nsIToolkitChromeRegistryVTable {
    ...
    pub GetLocalesForPackage: unsafe extern "system" fn (this: *const nsIToolkitChromeRegistry, aPackage: *const ::nsstring::nsACString, _retval: *mut*const nsIUTF8StringEnumerator) -> ::nserror::nsresult,
}
...
impl nsIToolkitChromeRegistry {
    ...
    /// `nsIUTF8StringEnumerator getLocalesForPackage (in AUTF8String aPackage);`
    #[inline]
    pub unsafe fn GetLocalesForPackage(&self, aPackage: *const ::nsstring::nsACString, _retval: *mut*const nsIUTF8StringEnumerator) -> ::nserror::nsresult {
