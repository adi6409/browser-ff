...
// method for nsIDOMGeoPositionCallback.
unsafe impl XpCom for nsIDOMGeoPositionCallback {
    const IID: nsIID = nsID(0x527e8b53, 0x6f29, 0x4b6a,
...
// This trait is implemented on all types which can be coerced to from nsIDOMGeoPositionCallback.
// It is used in the implementation of `fn coerce<T>`. We hide it from the
// documentation, because it clutters it up a lot.
#[doc(hidden)]
pub trait nsIDOMGeoPositionCallbackCoerce {
    /// Cheaply cast a value of this type from a `nsIDOMGeoPositionCallback`.
...
impl nsIDOMGeoPositionCallback {
    /// Cast this `nsIDOMGeoPositionCallback` to one of its base interfaces.
    #[inline]
...
// allocated version of this struct is at the beginning of every nsIDOMGeoPositionCallback
...
pub struct nsIDOMGeoPositionCallbackVTable {
    ...
    pub HandleEvent: unsafe extern "system" fn (this: *const nsIDOMGeoPositionCallback, position: *const nsIDOMGeoPosition) -> ::nserror::nsresult,
}
...
impl nsIDOMGeoPositionCallback {
    ...
    /// `void handleEvent (in nsIDOMGeoPosition position);`
    #[inline]
    pub unsafe fn HandleEvent(&self, position: *const nsIDOMGeoPosition) -> ::nserror::nsresult {
        ((*self.vtable).HandleEvent)(self, position)
    }
