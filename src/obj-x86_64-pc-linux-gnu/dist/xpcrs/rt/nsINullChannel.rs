...
// method for nsINullChannel.
unsafe impl XpCom for nsINullChannel {
    const IID: nsIID = nsID(0x4610b901, 0xdf41, 0x4bb4,
...
// This trait is implemented on all types which can be coerced to from nsINullChannel.
// It is used in the implementation of `fn coerce<T>`. We hide it from the
// documentation, because it clutters it up a lot.
#[doc(hidden)]
pub trait nsINullChannelCoerce {
    /// Cheaply cast a value of this type from a `nsINullChannel`.
...
// allocated version of this struct is at the beginning of every nsINullChannel
