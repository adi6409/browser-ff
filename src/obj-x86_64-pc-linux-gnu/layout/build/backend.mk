...
COMPUTED_CFLAGS += -I/worker/build/obj-x86_64-pc-linux-gnu/dist/system_wrappers -include /worker/build/config/gcc_hidden.h -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fstack-protector-strong -fstack-clash-protection -DNDEBUG=1 -DTRIMMED=1 -DOS_POSIX=1 -DOS_LINUX=1 -DMOZ_HAS_MOZGLUE -DMOZILLA_INTERNAL_API -DIMPL_LIBXUL -DSTATIC_EXPORTABLE_JS_API -I/worker/build/layout/build -I/worker/build/obj-x86_64-pc-linux-gnu/layout/build -I/worker/build/obj-x86_64-pc-linux-gnu/ipc/ipdl/_ipdlheaders -I/worker/build/ipc/chromium/src -I/worker/build/ipc/glue -I/worker/build/layout/base -I/worker/build/layout/forms -I/worker/build/layout/generic -I/worker/build/layout/inspector -I/worker/build/layout/mathml -I/worker/build/layout/painting -I/worker/build/layout/style -I/worker/build/layout/tables -I/worker/build/layout/xul -I/worker/build/caps -I/worker/build/docshell/base -I/worker/build/dom/audiochannel -I/worker/build/dom/base -I/worker/build/dom/bindings -I/worker/build/dom/canvas -I/worker/build/dom/filesystem -I/worker/build/dom/geolocation -I/worker/build/dom/html -I/worker/build/dom/jsurl -I/worker/build/dom/media -I/worker/build/dom/offline -I/worker/build/dom/storage -I/worker/build/dom/xslt/base -I/worker/build/dom/xslt/xml -I/worker/build/dom/xslt/xpath -I/worker/build/dom/xslt/xslt -I/worker/build/dom/xul -I/worker/build/editor/composer -I/worker/build/js/xpconnect/loader -I/worker/build/js/xpconnect/src -I/worker/build/netwerk/base -I/worker/build/netwerk/cookie -I/worker/build/view -I/worker/build/obj-x86_64-pc-linux-gnu/dist/include -I/worker/build/obj-x86_64-pc-linux-gnu/dist/include/nspr -I/worker/build/obj-x86_64-pc-linux-gnu/dist/include/nss -fPIC -include /worker/build/obj-x86_64-pc-linux-gnu/mozilla-config.h -DMOZILLA_CLIENT -Qunused-arguments -fno-strict-aliasing -ffunction-sections -fdata-sections -fno-math-errno -pthread -pipe -g -O2 -fomit-frame-pointer -funwind-tables -Qunused-arguments -Wall -Wbitfield-enum-conversion -Wempty-body -Wignored-qualifiers -Wpointer-arith -Wshadow-field-in-constructor-modified -Wsign-compare -Wtype-limits -Wunreachable-code -Wunreachable-code-return -Wclass-varargs -Wfloat-overflow-conversion -Wfloat-zero-conversion -Wloop-analysis -Wno-range-loop-analysis -Wstring-conversion -Wtautological-overlap-compare -Wtautological-unsigned-enum-zero-compare -Wtautological-unsigned-zero-compare -Wno-error=tautological-type-limit-compare -Wno-error=deprecated-declarations -Wno-error=array-bounds -Wno-error=backend-plugin -Wno-error=return-std-move -Wno-error=atomic-alignment -Wno-error=deprecated-copy -Wformat -Wformat-security -Wno-gnu-zero-variadic-macro-arguments -Werror=implicit-function-declaration -Wno-psabi -fexperimental-new-pass-manager
COMPUTED_CXXFLAGS += -I/worker/build/obj-x86_64-pc-linux-gnu/dist/stl_wrappers -I/worker/build/obj-x86_64-pc-linux-gnu/dist/system_wrappers -include /worker/build/config/gcc_hidden.h -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -fstack-protector-strong -fstack-clash-protection -DNDEBUG=1 -DTRIMMED=1 -DOS_POSIX=1 -DOS_LINUX=1 -DMOZ_HAS_MOZGLUE -DMOZILLA_INTERNAL_API -DIMPL_LIBXUL -DSTATIC_EXPORTABLE_JS_API -I/worker/build/layout/build -I/worker/build/obj-x86_64-pc-linux-gnu/layout/build -I/worker/build/obj-x86_64-pc-linux-gnu/ipc/ipdl/_ipdlheaders -I/worker/build/ipc/chromium/src -I/worker/build/ipc/glue -I/worker/build/layout/base -I/worker/build/layout/forms -I/worker/build/layout/generic -I/worker/build/layout/inspector -I/worker/build/layout/mathml -I/worker/build/layout/painting -I/worker/build/layout/style -I/worker/build/layout/tables -I/worker/build/layout/xul -I/worker/build/caps -I/worker/build/docshell/base -I/worker/build/dom/audiochannel -I/worker/build/dom/base -I/worker/build/dom/bindings -I/worker/build/dom/canvas -I/worker/build/dom/filesystem -I/worker/build/dom/geolocation -I/worker/build/dom/html -I/worker/build/dom/jsurl -I/worker/build/dom/media -I/worker/build/dom/offline -I/worker/build/dom/storage -I/worker/build/dom/xslt/base -I/worker/build/dom/xslt/xml -I/worker/build/dom/xslt/xpath -I/worker/build/dom/xslt/xslt -I/worker/build/dom/xul -I/worker/build/editor/composer -I/worker/build/js/xpconnect/loader -I/worker/build/js/xpconnect/src -I/worker/build/netwerk/base -I/worker/build/netwerk/cookie -I/worker/build/view -I/worker/build/obj-x86_64-pc-linux-gnu/dist/include -I/worker/build/obj-x86_64-pc-linux-gnu/dist/include/nspr -I/worker/build/obj-x86_64-pc-linux-gnu/dist/include/nss -fPIC -DMOZILLA_CLIENT -include /worker/build/obj-x86_64-pc-linux-gnu/mozilla-config.h -Qunused-arguments -Qunused-arguments -Wall -Wbitfield-enum-conversion -Wempty-body -Wignored-qualifiers -Woverloaded-virtual -Wpointer-arith -Wshadow-field-in-constructor-modified -Wsign-compare -Wtype-limits -Wunreachable-code -Wunreachable-code-return -Wwrite-strings -Wno-invalid-offsetof -Wclass-varargs -Wempty-init-stmt -Wfloat-overflow-conversion -Wfloat-zero-conversion -Wloop-analysis -Wno-range-loop-analysis -Wc++2a-compat -Wcomma -Wimplicit-fallthrough -Wunused-function -Wunused-variable -Wstring-conversion -Wtautological-overlap-compare -Wtautological-unsigned-enum-zero-compare -Wtautological-unsigned-zero-compare -Wno-error=tautological-type-limit-compare -Wno-inline-new-delete -Wno-error=deprecated-declarations -Wno-error=array-bounds -Wno-error=backend-plugin -Wno-error=return-std-move -Wno-error=atomic-alignment -Wno-error=deprecated-copy -Wformat -Wformat-security -Wno-gnu-zero-variadic-macro-arguments -Wno-psabi -Wno-unknown-warning-option -fno-sized-deallocation -fno-aligned-new -fno-exceptions -fno-strict-aliasing -fno-rtti -ffunction-sections -fdata-sections -fno-exceptions -fno-math-errno -pthread -pipe -g -O2 -fomit-frame-pointer -funwind-tables -Wno-error=shadow -fexperimental-new-pass-manager
