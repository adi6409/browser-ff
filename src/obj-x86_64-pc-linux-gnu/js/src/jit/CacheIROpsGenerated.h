...
_(GuardIsObjectOrNull, 1, false, 1)\
...
_(GuardGroup, 1 + 1, true, 1)\
_(GuardTypeDescr, 1 + 1, false, 1)\
...
_(GuardMagicValue, 1 + 1, true, 1)\
_(GuardFrameHasNoArgumentsObject, 0, true, 1)\
...
_(GuardHasGetterSetter, 1 + 1, true, 4)\
_(GuardInt32IsNonNegative, 1, true, 1)\
_(GuardIndexGreaterThanArrayLength, 1 + 1, false, 1)\
...
_(GuardNoAllocationMetadataBuilder, 0, false, 1)\
...
_(LoadFrameCalleeResult, 0, true, 1)\
_(LoadFrameNumActualArgsResult, 0, true, 1)\
_(LoadFrameArgumentResult, 1, true, 1)\
...
_(LoadInt32TruthyResult, 1, false, 2)\
_(LoadDoubleTruthyResult, 1, false, 2)\
_(LoadStringTruthyResult, 1, false, 2)\
_(LoadObjectTruthyResult, 1, false, 4)\
_(LoadBigIntTruthyResult, 1, false, 2)\
_(LoadValueTruthyResult, 1, true, 4)\
_(LoadValueResult, 1, false, 1)\
_(LoadNewObjectFromTemplateResult, 1 + 4 + 4, false, 4)\
...
void guardTypeDescr(ObjOperandId obj, JSObject* descr) {\
  writeOp(CacheOp::GuardTypeDescr);\
  writeOperandId(obj);\
  writeObjectField(descr);\
  assertLengthMatches();\
}\
...
void loadTypedArrayElementResult(ObjOperandId obj, IntPtrOperandId index, Scalar::Type elementType, bool handleOOB, bool allowDoubleForUint32) {\
  writeOp(CacheOp::LoadTypedArrayElementResult);\
  writeOperandId(obj);\
  writeOperandId(index);\
  writeScalarTypeImm(elementType);\
  writeBoolImm(handleOOB);\
  writeBoolImm(allowDoubleForUint32);\
  assertLengthMatches();\
}\
void loadDataViewValueResult(ObjOperandId obj, IntPtrOperandId offset, BooleanOperandId littleEndian, Scalar::Type elementType, bool allowDoubleForUint32) {\
...
\
[[nodiscard]] bool emitGuardIsObjectOrNull(ValOperandId inputId);\
[[nodiscard]] bool emitGuardIsObjectOrNull(CacheIRReader& reader) {\
  ValOperandId inputId = reader.valOperandId();\
...
\
[[nodiscard]] bool emitGuardMagicValue(ValOperandId valId, JSWhyMagic magic);\
[[nodiscard]] bool emitGuardMagicValue(CacheIRReader& reader) {\
...
\
[[nodiscard]] bool emitGuardHasGetterSetter(ObjOperandId objId, uint32_t shapeOffset);\
...
\
[[nodiscard]] bool emitGuardIndexGreaterThanArrayLength(ObjOperandId objId, Int32OperandId indexId);\
[[nodiscard]] bool emitGuardIndexGreaterThanArrayLength(CacheIRReader& reader) {\
  ObjOperandId objId = reader.objOperandId();\
  Int32OperandId indexId = reader.int32OperandId();\
...
\
[[nodiscard]] bool emitGuardNoAllocationMetadataBuilder();\
...
\
[[nodiscard]] bool emitLoadTypedArrayElementResult(ObjOperandId objId, IntPtrOperandId indexId, Scalar::Type elementType, bool handleOOB, bool allowDoubleForUint32);\
[[nodiscard]] bool emitLoadTypedArrayElementResult(CacheIRReader& reader) {\
  ObjOperandId objId = reader.objOperandId();\
  IntPtrOperandId indexId = reader.intPtrOperandId();\
  Scalar::Type elementType = reader.scalarType();\
  bool handleOOB = reader.readBool();\
  bool allowDoubleForUint32 = reader.readBool();\
  return emitLoadTypedArrayElementResult(objId, indexId, elementType, handleOOB, allowDoubleForUint32);\
}\
\
[[nodiscard]] bool emitLoadDataViewValueResult(ObjOperandId objId, IntPtrOperandId offsetId, BooleanOperandId littleEndianId, Scalar::Type elementType, bool allowDoubleForUint32);\
[[nodiscard]] bool emitLoadDataViewValueResult(CacheIRReader& reader) {\
  ...
  Scalar::Type elementType = reader.scalarType();\
  bool allowDoubleForUint32 = reader.readBool();\
  return emitLoadDataViewValueResult(objId, offsetId, littleEndianId, elementType, allowDoubleForUint32);\
}\
\
...
\
[[nodiscard]] bool emitInt32URightShiftResult(Int32OperandId lhsId, Int32OperandId rhsId, bool allowDouble);\
...
\
[[nodiscard]] bool emitLoadNewObjectFromTemplateResult(uint32_t templateObjectOffset, uint32_t disambiguationIdHi, uint32_t disambiguationIdLo);\
[[nodiscard]] bool emitLoadNewObjectFromTemplateResult(CacheIRReader& reader) {\
  uint32_t templateObjectOffset = reader.stubOffset();\
...
\
[[nodiscard]] bool emitGuardGroup(ObjOperandId objId, uint32_t groupOffset);\
[[nodiscard]] bool emitGuardGroup(CacheIRReader& reader) {\
  ObjOperandId objId = reader.objOperandId();\
  uint32_t groupOffset = reader.stubOffset();\
  return emitGuardGroup(objId, groupOffset);\
}\
\
[[nodiscard]] bool emitGuardTypeDescr(ObjOperandId objId, uint32_t descrOffset);\
[[nodiscard]] bool emitGuardTypeDescr(CacheIRReader& reader) {\
  ObjOperandId objId = reader.objOperandId();\
  uint32_t descrOffset = reader.stubOffset();\
  return emitGuardTypeDescr(objId, descrOffset);\
}\
\
...
\
[[nodiscard]] bool emitGuardFrameHasNoArgumentsObject();\
[[nodiscard]] bool emitGuardFrameHasNoArgumentsObject(CacheIRReader& reader) {\
...
\
[[nodiscard]] bool emitLoadFrameCalleeResult();\
[[nodiscard]] bool emitLoadFrameCalleeResult(CacheIRReader& reader) {\
  return emitLoadFrameCalleeResult();\
}\
\
[[nodiscard]] bool emitLoadFrameNumActualArgsResult();\
[[nodiscard]] bool emitLoadFrameNumActualArgsResult(CacheIRReader& reader) {\
  return emitLoadFrameNumActualArgsResult();\
}\
\
[[nodiscard]] bool emitLoadFrameArgumentResult(Int32OperandId indexId);\
[[nodiscard]] bool emitLoadFrameArgumentResult(CacheIRReader& reader) {\
  Int32OperandId indexId = reader.int32OperandId();\
...
\
void spewGuardTypeDescr(CacheIRReader& reader) {\
  spewOp(CacheOp::GuardTypeDescr);\
  spewOperandId("objId", reader.objOperandId());\
  spewArgSeparator();\
  spewField("descrOffset", reader.stubOffset());\
  spewOpEnd();\
}\
\
...
void spewLoadTypedArrayElementResult(CacheIRReader& reader) {\
  ...
  spewBoolImm("handleOOB", reader.readBool());\
  spewArgSeparator();\
  spewBoolImm("allowDoubleForUint32", reader.readBool());\
  spewOpEnd();\
}\
\
...
\
void cloneGuardIsObjectOrNull(CacheIRReader& reader, CacheIRWriter& writer) {{\
  writer.writeOp(CacheOp::GuardIsObjectOrNull);\
  ValOperandId inputId = reader.valOperandId();\
  writer.writeOperandId(inputId);\
  writer.assertLengthMatches();\
}}\
...
\
void cloneGuardGroup(CacheIRReader& reader, CacheIRWriter& writer) {{\
  writer.writeOp(CacheOp::GuardGroup);\
  ObjOperandId objId = reader.objOperandId();\
  writer.writeOperandId(objId);\
  uint32_t groupOffset = reader.stubOffset();\
  ObjectGroup* group = getGroupField(groupOffset);\
  writer.writeGroupField(group);\
  writer.assertLengthMatches();\
}}\
\
void cloneGuardTypeDescr(CacheIRReader& reader, CacheIRWriter& writer) {{\
  writer.writeOp(CacheOp::GuardTypeDescr);\
  ObjOperandId objId = reader.objOperandId();\
  writer.writeOperandId(objId);\
  uint32_t descrOffset = reader.stubOffset();\
  JSObject* descr = getObjectField(descrOffset);\
  writer.writeObjectField(descr);\
  writer.assertLengthMatches();\
}}\
\
...
\
void cloneGuardMagicValue(CacheIRReader& reader, CacheIRWriter& writer) {{\
  writer.writeOp(CacheOp::GuardMagicValue);\
  ValOperandId valId = reader.valOperandId();\
  writer.writeOperandId(valId);\
  JSWhyMagic magic = reader.whyMagic();\
  writer.writeJSWhyMagicImm(magic);\
  writer.assertLengthMatches();\
}}\
\
void cloneGuardFrameHasNoArgumentsObject(CacheIRReader& reader, CacheIRWriter& writer) {{\
  writer.writeOp(CacheOp::GuardFrameHasNoArgumentsObject);\
  writer.assertLengthMatches();\
}}\
\
...
\
void cloneGuardIndexGreaterThanArrayLength(CacheIRReader& reader, CacheIRWriter& writer) {{\
  writer.writeOp(CacheOp::GuardIndexGreaterThanArrayLength);\
  ObjOperandId objId = reader.objOperandId();\
  writer.writeOperandId(objId);\
  Int32OperandId indexId = reader.int32OperandId();\
  writer.writeOperandId(indexId);\
...
void cloneLoadTypedArrayElementResult(CacheIRReader& reader, CacheIRWriter& writer) {{\
  ...
  writer.writeBoolImm(handleOOB);\
  bool allowDoubleForUint32 = reader.readBool();\
  writer.writeBoolImm(allowDoubleForUint32);\
  writer.assertLengthMatches();\
}}\
\
...
\
void cloneLoadFrameCalleeResult(CacheIRReader& reader, CacheIRWriter& writer) {{\
  writer.writeOp(CacheOp::LoadFrameCalleeResult);\
  writer.assertLengthMatches();\
}}\
\
void cloneLoadFrameNumActualArgsResult(CacheIRReader& reader, CacheIRWriter& writer) {{\
  writer.writeOp(CacheOp::LoadFrameNumActualArgsResult);\
  writer.assertLengthMatches();\
}}\
\
void cloneLoadFrameArgumentResult(CacheIRReader& reader, CacheIRWriter& writer) {{\
  writer.writeOp(CacheOp::LoadFrameArgumentResult);\
  Int32OperandId indexId = reader.int32OperandId();\
  writer.writeOperandId(indexId);\
  writer.assertLengthMatches();\
}}\
...
void cloneInt32URightShiftResult(CacheIRReader& reader, CacheIRWriter& writer) {{\
  ...
  writer.writeOperandId(rhsId);\
  bool allowDouble = reader.readBool();\
  writer.writeBoolImm(allowDouble);\
  writer.assertLengthMatches();\
}}\
\
...
\
void cloneLoadNewObjectFromTemplateResult(CacheIRReader& reader, CacheIRWriter& writer) {{\
  writer.writeOp(CacheOp::LoadNewObjectFromTemplateResult);\
  uint32_t templateObjectOffset = reader.stubOffset();\
  JSObject* templateObject = getObjectField(templateObjectOffset);\
  writer.writeObjectField(templateObject);\
  uint32_t disambiguationIdHi = reader.uint32Immediate();\
  writer.writeUInt32Imm(disambiguationIdHi);\
  uint32_t disambiguationIdLo = reader.uint32Immediate();\
  writer.writeUInt32Imm(disambiguationIdLo);\
  writer.assertLengthMatches();\
}}\
\
