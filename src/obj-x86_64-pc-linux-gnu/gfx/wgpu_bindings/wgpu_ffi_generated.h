...
struct WGPUBindGroupLayoutEntry {
  ...
  bool multisampled;
  const enum WGPUTextureFormat *storage_texture_format;
};
...
WGPU_INLINE
void wgpu_compute_pass_finish(struct WGPUComputePass *aPass,
...
WGPU_INLINE
void wgpu_render_pass_finish(struct WGPURenderPass *aPass,
                             struct WGPUByteBuf *aOutput)
WGPU_FUNC;
...
WGPU_INLINE
void wgpu_command_encoder_copy_texture_to_buffer(WGPUTextureCopyView aSrc,
                                                 WGPUBufferCopyView aDst,
                                                 struct WGPUExtent3d aSize,
                                                 struct WGPUByteBuf *aBb)
WGPU_FUNC;

WGPU_INLINE
void wgpu_command_encoder_copy_buffer_to_texture(WGPUBufferCopyView aSrc,
                                                 WGPUTextureCopyView aDst,
                                                 struct WGPUExtent3d aSize,
                                                 struct WGPUByteBuf *aBb)
WGPU_FUNC;

WGPU_INLINE
void wgpu_command_encoder_copy_texture_to_texture(WGPUTextureCopyView aSrc,
                                                  WGPUTextureCopyView aDst,
                                                  struct WGPUExtent3d aSize,
                                                  struct WGPUByteBuf *aBb)
WGPU_FUNC;
...
WGPU_INLINE
void wgpu_server_fill_default_limits(struct WGPULimits *aLimits)
WGPU_FUNC;
